...
//  </ExternalFlowSite>
            ...
            siteElement.SetAttribute("order", "");
            siteElement.SetAttribute("signType", "");
            ...
            //<Signer account='' />
            signerElement.SetAttribute("account", "");
            //<Signers>
            //  <Signer account='' />
            //</Signers>
            ...
            //XmlElement altersElement = xmlDoc.CreateElement("Alters");
            //XmlElement alterElement = xmlDoc.CreateElement("Alter");
            //alterElement.SetAttribute("account", "");
            //altersElement.AppendChild(alterElement);
            ...
            //<Site order='1' signType='0' >
            //  <Signers>
            //      <Signer account='Mary' />
            //  </Signers>
            //</Site>
            XmlNode siteNode2 = siteElement.CloneNode(true);
            siteNode2.Attributes["order"].Value = "0";
            siteNode2.Attributes["signType"].Value = "0";
            siteNode2.SelectSingleNode("/Signers/Signer").Attributes["account"].Value = signer;
            //<Flow>
            //  <Site order='0' signType='0' >
            //      <Signers>
            //          <Signer account='Tony' />
            ...
            //  </Site>
            //<Flow>
            flowElement.AppendChild(siteNode2);
