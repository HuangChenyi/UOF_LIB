...
<script type="text/javascript">
    ...
    function DialogAuditOutcome() {//審核
        ...
        var Type = "Series";
        var mode = "Audit";
        var auditGUID = $('#<%= hidAuditGUID.ClientID %>').val();
...
<asp:CustomValidator ID="cvMessage" runat="server" Display="Dynamic" ForeColor="Red" meta:resourcekey="cvMessageResource1"></asp:CustomValidator>
    ...
    <input id="hidProjGUID" runat="server" type="hidden" value="Test-Project" />
    <input id="hidGUID" runat="server" type="hidden" />
    <input id="hidMode" runat="server" type="hidden" />
    <input id="hidProjStatus" type="hidden" runat="server" value="" />
    <input id="hidSeriesStatus" runat="server" type="hidden" />
    <input id="hidParentSeriesGUID" runat="server" type="hidden" />
    <input id="hidParentSeriesStatus" runat="server" type="hidden" />
    <input id="hidDirectorRMID" runat="server" type="hidden" />
    <input id="hidAuditGUID" runat="server" type="hidden" />
