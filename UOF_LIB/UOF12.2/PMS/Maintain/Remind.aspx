   ...
   <table class="PopTable">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:TextBox ID="txtRemindDesc" runat="server" Columns="30" Rows="5" TextMode="MultiLine" MaxLength="200" meta:resourcekey="txtRemindDescResource1"></asp:TextBox>
                </td>
        </tr>
    </table>
    <input id="hidProjGUID" runat="server" type="hidden" />
    <input id="hidTaskGUID" runat="server" type="hidden" />
    <input id="hidSeriesGUID" runat="server" type="hidden" />
</asp:Content>
