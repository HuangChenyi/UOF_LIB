...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        ...
        function DialogAuditTrack() {
            var projGUID = $('#<% = hidProjGUID.ClientID %>').val();
            var strGUID = $('#<% = hidGUID.ClientID %>').val();
            var strType = "Task";
