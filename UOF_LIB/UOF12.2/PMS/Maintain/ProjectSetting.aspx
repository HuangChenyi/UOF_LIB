...
function DialogCreatePre() {
    var Mode = $('#<%= hidMode.ClientID %>').val();
    var ProjGUID = $('#<%= hidProjGUID.ClientID %>').val();
    var CopyUser = $('#<%= hidCopyUser.ClientID %>').val();
    var FileGroupId = $('#<%= hidFileGroupId.ClientID %>').val();
...
function DialogAuditTrack() {
        ...
        <tr>
            ...
            <td abbr="hidAuditorGUID">
                <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                    <ContentTemplate>
                        <input id="hidAuditorGUID" type="hidden" runat="server" />
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel runat="server">
                    <ContentTemplate>
                        <input id="hidPMGUID" type="hidden" runat="server" />
    ...
    <input id="hidOrgProjGUID" runat="server" type="hidden" />
    <input id="hidMode" runat="server" type="hidden" />
    <input id="hidCopyUser" runat="server" type="hidden" />
    <input id="hidFileGroupId" runat="server" type="hidden" />
    <input id="hidStatus" runat="server" type="hidden" />
