...
<asp:Panel ID="panTree" runat="server" meta:resourcekey="panTreeResource1">
    <table align="center" border="0" cellpadding="5" cellspacing="3" height="100%" width="100%">
        <tr>
            <td valign="top">
                <telerik:RadTreeView ID="uTreeProj" runat="server" OnNodeClick="uTreeProj_NodeClick" OnNodeCheck="uTreeProj_NodeCheck"></telerik:RadTreeView>
            </td>
        </tr>
    </table>
</asp:Panel>
...
<input id="hideProjCount" type="hidden" runat="server" value="0" />