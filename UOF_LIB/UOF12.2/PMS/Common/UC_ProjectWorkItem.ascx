...
<input id="hidProjGUID" type="hidden" runat="server" value="" />
<input id="hidProjStatus" type="hidden" runat="server" value="" />
<input id="hidGUID" type="hidden" runat="server" value="" />
<input id="hidListSeriesGUID" type="hidden" runat="server" value="" />
<input id="hidListTaskGUID" type="hidden" runat="server" value="" />
