...
<input id="hidEnable" type="hidden" runat="server" value="True" />
<input id="hidReadOnly" type="hidden" runat="server" value="False" />
<input id="hidProjGUID" runat="server" type="hidden" value="" />
<input id="hidPmRmId" runat="server" type="hidden" value="" />
<input id="hidAuditorGUID" runat="server" type="hidden" value="" />
<input id="hidProjStatus" runat="server" type="hidden" value="" />
<input id="hidProjView" runat="server" type="hidden" value="" />
<input id="hidAuditTrack" runat="server" type="hidden" value="" />
<input id="hidAuditGUID" runat="server" type="hidden" value="" />
