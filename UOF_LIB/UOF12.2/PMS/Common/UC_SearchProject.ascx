...
<input id="hidShowSelectColumn" type="hidden" runat="server" value="true" />
<input id="hidShowTimeColumn" type="hidden" runat="server" value="true"  />
<input id="hidShowOperationColumn" type="hidden" runat="server" value="true"  />
<input id="hidSearchProjectName" type="hidden" runat="server" />
<input id="hidSearchProjectStatus" type="hidden" runat="server" />
