...
<table id="table1" class="PopTable" width="100%" cellspacing="1">
    ...
    <tr>
        ...
        <td>
            ...
            <input id="hidTaskGUID" type="hidden" runat="server" />
            </td>
    ...
    <tr>
        ...
        <td style="height: 21px">
            <asp:LinkButton ID="lbtRelationTask" runat="server" OnClientClick="return DialogRelationTask();" CausesValidation="False" meta:resourcekey="lbtRelationTaskResource1"></asp:LinkButton><input id="hidRelationTaskGUID" runat="server" type="hidden" /><input id="hidRelationTaskStatus" runat="server" type="hidden" /><input id="hidRelationTaskProjGUID" runat="server" type="hidden" />
        </td>
    </tr>
        <tr>
            <td>
...
<input id="hidAuditorGUID" runat="server" type="hidden" />
<input id="hidScheduleGUID" runat="server" type="hidden" />
<input id="hidReadOnly" runat="server" type="hidden" value="false" />
<input id="hidDrirectorRMID" runat="server" type="hidden" />
<input id="hidTaskStatus" runat="server" type="hidden" />
