...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        ...
        <input id="hidBindType" type="hidden" runat="server" />
        <input id="hidProjStatus" type="hidden" runat="server" value="Proceeding" />
        <input id="hidsendingStartDate" type="hidden" runat="server" />
        <input id="hidsendingEndDate" type="hidden" runat="server" />
    </ContentTemplate>
</asp:UpdatePanel>
<table>
    <tr>
...
<input id="hideUpdate" type="hidden" value="Fasle" runat="server" /> 