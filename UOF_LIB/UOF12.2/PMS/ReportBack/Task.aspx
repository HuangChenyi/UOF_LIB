...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        function DialogAuditTrack() {
            ...
            var taskGUID = $('#<%= hidTaskGUID.ClientID %>').val();
            var type = "Task";
    ...
    <input id="hidTaskGUID" runat="server" type="hidden" value="" />
    <input id="hidProjGUID" runat="server" type="hidden" value="" />
    <input id="hidScheduleGUID" runat="server" type="hidden" value="" />
    <input id="hidAllowOK" type="hidden" runat="server" value="true" />
    <input id="hidAllowDelete" type="hidden" runat="server" value="false" />
    <input id="hidReadReportTrack" type="hidden" runat="server" value="true" />
    <input id="hidReadAuditTrack" type="hidden" runat="server" value="true" />
