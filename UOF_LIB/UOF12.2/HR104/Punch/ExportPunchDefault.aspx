...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <asp:DropDownList ID="ddlStatus" runat="server" meta:resourcekey="ddlStatusResource1">
                                            ...
                                            <asp:ListItem Text="處理中" Value="Executing" meta:resourcekey="ListItemResource2"></asp:ListItem>
    ...
    <asp:Label ID="lblDelRecordConfirm" runat="server" Text="確定要刪除所有匯出記錄嗎?" Visible="False" meta:resourcekey="lblDelRecordConfirmResource1"></asp:Label>
