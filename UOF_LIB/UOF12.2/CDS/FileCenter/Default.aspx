<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DefaultMasterPage.master" AutoEventWireup="true" CodeFile="Default.aspx.cs" Inherits="CDS_FileCenter_Default" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <uc1:UC_FileCenter runat="server" ID="UC_FileCenter" ModuleName="CDS" 
        AllowedMultipleFileSelection="false"
        SubFolder="FileCenter" OnClientUploaded="onClientUploaded"  />
