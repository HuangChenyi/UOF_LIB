...
public partial class CDS_FileCenter_Default : Ede.Uof.Utility.Page.BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
        UC_FileCenter.AllowedMultipleFileSelection = false;

        if (!IsPostBack)
        {
            UC_FileCenter.ModuleName= Ede.Uof.Utility.FileCenter.V3.Module.CDS;
           //顯示元件目前狀態
