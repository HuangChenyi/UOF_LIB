...
public partial class CDS_WebPage_Dialog : Ede.Uof.Utility.Page.BasePage
{
    protected void Page_Load(object sender, EventArgs e)
    {
     ...
     //   ((Master_DialogMasterPage)this.Master).Button1OnClick += new Master_DialogMasterPage.ButtonOnClickHandler(Demo_WebPage_Dialog_Button1OnClick);
    ...
    void Demo_WebPage_Dialog_Button1OnClick()
    {
        //設定回傳值並關閉視窗
        Dialog.SetReturnValue2(txtReturnValue.Text);
        Dialog.Close(this);
