    ...
    <table class="PopTable" >
        ...
        <tr >
            <td colspan="2" class="PopTableRightTD" >
                ...
                <Fast:Grid ID="Grid1" DataKeyNames="ACCOUNT" OnRowDataBound="Grid1_RowDataBound" runat="server" AutoGenerateCheckBoxColumn="true" AllowSorting="True" AutoGenerateColumns="False" CustomDropDownListPage="False" DataKeyOnClientWithCheckBox="False" DefaultSortDirection="Ascending" EmptyDataText="No data found" EnhancePager="True" KeepSelectedRows="False" PageSize="15" SelectedRowColor="" UnSelectedRowColor="" meta:resourcekey="Grid1Resource1" >
<EnhancePagerSettings FirstImageUrl="" FirstAltImageUrl="" PreviousImageUrl="" NextImageUrl="" LastImageUrl="" LastAltImage="" PageNumberCssClass="" PageNumberCurrentCssClass="" PageInfoCssClass="" PageRedirectCssClass="" NextIAltImageUrl="" PreviousAltImageUrl="" ShowHeaderPager="True"></EnhancePagerSettings>
                 
<ExportExcelSettings AllowExportToExcel="False"></ExportExcelSettings>
                    <Columns>
                        <asp:TemplateField HeaderText="姓名" ItemStyle-Width="100px" ItemStyle-HorizontalAlign="Left" meta:resourcekey="TemplateFieldResource1">
                
                            <ItemTemplate>
                                <asp:LinkButton ID="lbtnName" Visible="false" runat="server" Text='<%# Bind("NAME") %>' meta:resourcekey="lbtnNameResource1"></asp:LinkButton>
                                  <asp:TextBox ID="LinkButton1" runat="server" Text='<%# Bind("NAME") %>' ></asp:TextBox>
                         ...
                         <asp:BoundField HeaderText="帳號" DataField="ACCOUNT" ItemStyle-HorizontalAlign="Left" meta:resourcekey="BoundFieldResource1" >
