        ...
        <table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0" class="tbbg01">
            ...
            <object id="UMHControl1" style="left: 0px; top: 0px" height="0" width="0" classid="clsid:C4B873F4-099F-4DD7-88D2-2EF97EFE03E8">
                ...
                <param name="_StockProps" value="0">
                    ...
                    <input id="hidePW" type="hidden" value="0" runat="server" />
                    <input id="hideCas" type="hidden" value="0" runat="server" />
                    <input id="hideSerialNo" type="hidden" value="" runat="server" />
                    <input id="hideErrorCode" type="hidden" value="" runat="server" />
                    <center>
