    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        ...
        <script type="text/javascript">
            ...
            Sys.Application.add_load(function () {
                ...
                if (pd) {
                    Choice.Config.resultUserSet.fromString($("#<%=Request["hiddenId"]%>", pd).val());
                }
            ...
            function ConfirmSelect() {
                ...
                if (Choice.Config.resultUserSet.count() > 0 || confirm("<%=lbNoSelectedItemWarning.Text%>")) {
                    ...
                    $("#<%=Request["hiddenId"]%>", pd).val(Choice.Config.resultUserSet.toSring());
                    ...
                    <div id="divTreeContainer">
                        <div id="divCommonUse" class="divContainer">
                            <div class="divTreeBody">
                                <telerik:RadTreeView ID="treeCommonUse" runat="server" Height="100%" Width="100%" ShowLineImages="False" OnClientNodeClicked="treeCommonUse_NodeClicked" meta:resourcekey="treeCommonUseResource2"></telerik:RadTreeView>
                            </div>
                        </div>
                        <div id="divClass" class="divContainer">
                            <div class="divTreeBody">
                                <telerik:RadTreeView ID="treeClass" runat="server" Height="100%" Width="100%" ShowLineImages="False" OnClientNodeClicked="treeClass_NodeClicked" meta:resourcekey="treeClassResource2"></telerik:RadTreeView>
                            </div>
                        </div>

                        <div id="divIndustry" class="divContainer">
                            <div class="divTreeBody">
                                <telerik:RadTreeView ID="treeIndustry" runat="server" Height="100%" Width="100%" ShowLineImages="False" OnClientNodeClicked="treeIndustry_NodeClicked" meta:resourcekey="treeIndustryResource2"></telerik:RadTreeView>
                            </div>
                        </div>
                        <div id="divArea" class="divContainer">
                            ...
                            <div class="divTreeBody">
                                <telerik:RadTreeView ID="treeArea" runat="server" Height="100%" Width="100%" ShowLineImages="False" OnClientNodeClicked="treeArea_NodeClicked" meta:resourcekey="treeAreaResource2"></telerik:RadTreeView>
                            </div>
                        </div>
                        <div id="divCustomer" class="divContainer">
                            ...
                            <div class="divTreeBody">
                                <telerik:RadTreeView ID="treeCustomer" runat="server" Height="100%" Width="100%" ShowLineImages="False" OnClientNodeClicked="treeCustomer_NodeClicked" meta:resourcekey="treeCustomerResource2"></telerik:RadTreeView>
                            </div>
                        </div>
                    </div>
                </telerik:RadPane>
