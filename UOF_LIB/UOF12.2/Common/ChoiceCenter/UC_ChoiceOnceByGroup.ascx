<%@ Control Language="C#" AutoEventWireup="true" Inherits="Ede.Uof.Common.ChoiceCenter.UC_ChoiceOnceByGroup" Codebehind="UC_ChoiceOnceByGroup.ascx.cs" %>
...
<telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
    ...
    <script src="../../Common/javascript/ChoiceCenterV2.js"></script>
    <script type="text/javascript">
        ...
        Sys.Application.add_load(function () {
            ...
            function searchUser()
            {
                var groupID = $("#<%=ddlGroup.ClientID %> option:selected").val();
                var userType;
                ...
                Choice.submitSearchUser({ "action": "SearchUserByID", "userType": userType, "keyword": $("#txbKeyWordUser").val(), "id": groupID, "userGuid": userGuid });
            }

            $('#txbKeyWordDept').keypress(function (event) {
                if (event.keyCode == 10 || event.keyCode == 13) {
                    event.preventDefault();
                    setTimeout(searchDept, 500);
                }
            }).keyup(
                function (event) {
                    setTimeout(searchDept, 500);
            ...
            function searchDept() {
                var groupID = $("#<%=ddlGroup.ClientID %> option:selected").val();
                var keyword = $("#txbKeyWordDept").val();
                if (typeof (groupID) == 'undefined')
                    groupID = '';
                Choice.searchDepartmentByGroupID({ "action": "SearchDepartmentByGroupID", "keyword": keyword, "id": groupID });
            }
            ...
            <telerik:RadPane ID="PanRight" runat="server" Scrolling="None" MinWidth="650" Index="0" meta:resourcekey="PanRightResource1">
                ...
                <div id="divTreeContainer">
                    <div id="divDepartment" class="divContainer">
                        <div style="height: 25px">
                            <table border="0" cellpadding="2" cellspacing="0">
                                <tr>
                                    <td>
                                        <div id="div1" runat="server" visible="False" style="float: left; margin: 2px;">
                                            <asp:Label ID="Label4" runat="server" Text="選擇部門" meta:resourcekey="Label1Resource1"></asp:Label>
                                            <asp:DropDownList ID="ddlGroup" runat="server" OnSelectedIndexChanged="ddlGroup_SelectedIndexChanged" AutoPostBack="True" meta:resourcekey="ddlGroupResource1">
                                            </asp:DropDownList>
                                        </div>
                                    </td>
                                    <td>
                                        <div style="float: left; margin: 2px;white-space:nowrap;text-overflow:ellipsis;">
                                            <asp:Label ID="Label1" runat="server" Text="部門" meta:resourcekey="Label1Resource2"></asp:Label>
                    ...
                    <div id="divGroup" class="divContainer">
                        ...
                        <div class="divTreeBody">
                            <telerik:RadTreeView ID="treeGroup" runat="server" Height="100%" Width="100%" ShowLineImages="False" OnClientNodeClicked="treeGroup_NodeClicked" meta:resourcekey="treeGroupResource1"></telerik:RadTreeView>
                        </div>
                    </div>
                    <div id="divUser" class="divContainer">
                        ...
                        <div class="divTreeBody">
                            <telerik:RadTreeView ID="treeUser" runat="server" Height="100%" Width="100%" ShowLineImages="False" meta:resourcekey="treeUserResource2"></telerik:RadTreeView>
                        </div>
                    </div>
                    <div id="divJobTitle" class="divContainer">
                        <div class="divTreeBody">
                            <telerik:RadTreeView ID="treeJobTitle" runat="server" Height="100%" Width="100%" ShowLineImages="False" meta:resourcekey="treeJobTitleResource1"></telerik:RadTreeView>
                        </div>
                    </div>
                    <div id="divJobFunction" class="divContainer">
                        <div class="divTreeBody">
                            <telerik:RadTreeView ID="treeJobFunction" runat="server" Height="100%" Width="100%" ShowLineImages="False" meta:resourcekey="treeJobFunctionResource1"></telerik:RadTreeView>
                        </div>
                    </div>
                </div>
            </telerik:RadPane>
