                ...
                <telerik:RadPane ID="PanRight" runat="server" Scrolling="None" MinWidth="640" Index="1" meta:resourcekey="PanRightResource1">
                    ...
                    <div id="divTreeContainer">
                        ...
                        <div id="divEmployee" class="divContainer">
                            <div class="divTreeBody">
                                <telerik:RadTreeView ID="treeEmployee" runat="server" Height="100%" Width="100%" ShowLineImages="False" OnClientNodeClicked="treeEmployee_NodeClicked" meta:resourcekey="treeEmployeeResource1"></telerik:RadTreeView>
                            </div>
                        </div>
                        ...
                        <div id="divDeptTitle" class="divContainer">
                            <div class="divTreeBody">
                                <telerik:RadTreeView ID="treeDeptTitle" runat="server" Height="100%" Width="100%" ShowLineImages="False" OnClientNodeClicked="treeDeptTitle_NodeClicked" meta:resourcekey="treeDeptTitleResource1"></telerik:RadTreeView>
                            </div>
                        </div>
                        <div id="divDeptFunc" class="divContainer">
                            <div class="divTreeBody">
                                <telerik:RadTreeView ID="treeDeptFunc" runat="server" Height="100%" Width="100%" ShowLineImages="False" OnClientNodeClicked="treeDeptFunc_NodeClicked" meta:resourcekey="treeDeptFuncResource1"></telerik:RadTreeView>
                            </div>
                        </div>
                        <div id="divUserDpt" class="divContainer">
                            <div class="divTreeBody">
                                <telerik:RadTreeView ID="treeUserDept" runat="server" Height="100%" Width="100%" ShowLineImages="False" OnClientNodeClicked="treeUserDept_NodeClicked" meta:resourcekey="treeUserDeptResource1"></telerik:RadTreeView>
                            </div>
                        </div>
        ...
        <script type="text/javascript">
            ...
            Sys.Application.add_load(function () {
                ...
                if (pd) {
                    ...
                    var getlimitXML = $("#<%=Request["limitXMLId"]%>", pd).val();
                ...
                $('#txbKeyWordUser').keypress(function (event) {
                    if (event.keyCode == 10 || event.keyCode == 13) {
                        ...
                        $(this).doTimeout("findEmpName",
                            500, Choice.searchUser('<%=UserGuid%>'));
                    }
                }).keyup(
                    function (event) {
                        $(this).doTimeout("findEmpName",
                            500, Choice.searchLimitUser('<%=UserGuid%>', $('#<%=hidGetUserSet.ClientID%>').val(), true));
                });
                ...
                if (type == 1) {
                    ...
                    Choice.submitSearchUser({ "action": "GetDepartmentUser", "id": node.get_value() }, true);
                }
                else if (type == 11) {
                    $("#divEmployee").show();
                    $("#divUser").hide();
            ...
            function onSearchUserFindClicking(sender, args) {
                ...
                Choice.searchLimitUser('<%=UserGuid%>', $('#<%=hidGetUserSet.ClientID%>').val(), true);
            }
