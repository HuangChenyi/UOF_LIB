                    ...
                    <telerik:RadPageView runat="server" ID="RadPageView1" >                
                        <table class="settingTable">
                                ...
                                <td>
                                    <div class="rightTdDiv">
                                        <asp:RadioButtonList ID="rbtnMode" runat="server" RepeatDirection="Horizontal" RepeatLayout="Flow">
                                            <asp:ListItem Value="Lineart" Enabled="False">黑白</asp:ListItem>
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="rightTdDiv">
		                                <span id="selectedBrightnessValue" class="sliderValue">0</span>
		                                <telerik:RadSlider ID="sliBrightness" runat="server" MinimumValue="-100" MaximumValue="100" Skin="Metro"
			                                Value="0" OnClientValueChanged="brightnessValueChanged" Width="170" style="margin-top: 17px">
		                                </telerik:RadSlider>
                                    </div>                               
                                </td>                            
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="rightTdDiv">
		                                <span id="selectedContrastValue" class="sliderValue">0</span>
		                                <telerik:RadSlider ID="sliContrast" runat="server" MinimumValue="-100" MaximumValue="100" Skin="Metro"
			                                Value="0" OnClientValueChanged="contrastValueChanged" Width="170" style="margin-top: 17px">
		                                </telerik:RadSlider>
                                    </div>                               
                                </td>                            
                            </tr>
        ...
        <script type="text/javascript">
            ...
            Sys.Application.add_load(function () {
                ...
                $('#<%=rbtnFileType.ClientID%> input').on('change', function() {
                    $("#<%=txbName.ClientID%>").attr("disabled", $(this).val() === "JPEG");
                });
    ...
    <telerik:RadScriptBlock runat="server" ID="plustek">
        <script type="text/javascript">
            ...
            function GetOcrFile(filename) {
                ...
                var str = PlustekScannerSdk.GetOcrRecognizedDataCommand + "?filename=" + ocrName + "&recognize-type=fulltext";
