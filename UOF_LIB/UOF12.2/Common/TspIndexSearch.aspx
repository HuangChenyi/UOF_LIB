<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DefaultMasterPage.master" AutoEventWireup="true" CodeBehind="TspIndexSearch.aspx.cs" Inherits="Ede.Uof.Web.Common.TspIndexSearch" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        Sys.Application.add_load(function () {
            if('<%=Request["searchtype"] %>' =="dms-advance")
                $("#moduletr").hide();
    ...
    <Items>
        <telerik:RadMenuItem runat="server" Value="AdvanceOption" Text = "條件選項 <span style='font-size:XX-Small;'>▼</span>" StaysOpenOnClick="True"  meta:resourcekey="RadMenuItemResource3"   >
            ...
            <ContentTemplate>
                      <table border="1" cellpadding="0" cellspacing="0" class="PopTable" style="table-layout: fixed; height: 100px; width: 680px;">
                            <tr id="moduletr">
          ...
          <asp:CheckBox ID="chkPRIVATEMSG" ValidationGroup="Module" Text="私人訊息" runat="server" meta:resourcekey="chkPRIVATEMSGResource1" />
                            ...
                            <tr>
                                <td class="PopTableLeftTD" style="width:15%;"><asp:Label ID="Label15" runat="server" Text="時間範圍" meta:resourcekey="Label15Resource1"></asp:Label></td>
                                <td class="PopTableRightTD">
                                    ...
                                    <telerik:RadDatePicker ID="WebDateChooserBegin1" runat="server" Culture="zh-TW"  >
                                    ...
                                    <telerik:RadDatePicker ID="WebDateChooserEnd1" runat="server" Culture="zh-TW" >
                                                                    <Calendar Culture="zh-TW" EnableWeekends="True" FastNavigationNextText="&amp;lt;&amp;lt;" UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False">
                                                                    </Calendar>
                                                                    <DateInput DateFormat="yyyy/M/d" DisplayDateFormat="yyyy/M/d" LabelWidth="64px" Width="">
                                                                        <EmptyMessageStyle Resize="None" />
                            ...
                            <tr>
                                <td class="PopTableLeftTD"  style="width:15%;"><asp:Label ID="Label14" runat="server" Text="搜尋模式" meta:resourcekey="Label4Resource1"></asp:Label></td>
                                <td class="PopTableRightTD">
                                     <table>
                                          <tr>                                              
                                                <td align="left" >
    ...
    <Items>
        <telerik:RadMenuItem runat="server" Value="DMSAdvance"  Text="進階 <span style='font-size:XX-Small;'>▼</span>" StaysOpenOnClick="True" meta:resourcekey="RadMenuItemResource2"  >
            ...
            <ContentTemplate>
                      <table border="1" cellpadding="0" cellspacing="0" class="PopTable" style="table-layout: fixed; height: 100px; width: 800px;">
                            <tr>
                                ...
                                <td class="PopTableRightTD" >
                                    <asp:CheckBox ID="chkSearchAllClass" runat="server" Checked="True" Font-Bold="True"
                                           ...
                                           <telerik:RadToolBarButton runat="server" IsSeparator="True" meta:resourcekey="RadToolBarButtonResource7" >
                                            ...
                                            <ItemTemplate>
                                                <table id="tbindextime"><tr><td align="right" ><asp:Label ID="lblIndexTime" runat="server" Text=""></asp:Label></td></tr></table>
                                            </ItemTemplate>
                                            </telerik:RadToolBarButton>     
                                        </Items>
                                    </telerik:RadToolBar>
    ...
    <Fast:Grid ID="gridDetail" runat="server" AllowSorting="True" AutoGenerateCheckBoxColumn="False"
            ...
            <AlternatingRowStyle BackColor="White" />
                ...
                <tr>
                    ...
                    <td >
                            ...
                            <table><tr>
                                <td>
                            <asp:HyperLink runat="server" ID="hlLink"  meta:resourcekey="hlLinkResource1" CssClass="TitleStyle" ><asp:Label runat="server" Text='<%# Eval("title") %>' ID="Label11" CssClass="TitleStyle" meta:resourcekey="Label11Resource2"  ></asp:Label>
</asp:HyperLink>
                          
                            <asp:LinkButton ID="LinkButton1" runat="server" Text='<%# Eval("title") %>' CssClass="TitleStyle" meta:resourcekey="LinkButton1Resource1" ></asp:LinkButton>
                                    </td>
                                <td>
                        ...
                        <asp:Panel ID="Panel2" runat="server" meta:resourcekey="Panel2Resource1">
                            <asp:Label runat="server"   ID="Label6"  Text="路徑：" meta:resourcekey="Label6Resource1" ></asp:Label><asp:HyperLink ID="linkDMSPath" runat="server" Text='<%# Eval("DocPath") %>' meta:resourcekey="linkDMSPathResource1"></asp:HyperLink> <br />
                            <asp:Label runat="server"   ID="Label7"  Text="文件編號：" meta:resourcekey="Label7Resource1" ></asp:Label><asp:Label runat="server"   ID="lblSerial" Text='<%# Eval("Searial") %>' meta:resourcekey="lblSerialResource1"></asp:Label>&nbsp;&nbsp; <asp:Label runat="server"   ID="Label8"  Text="作者：" meta:resourcekey="Label8Resource1" ></asp:Label><asp:Label runat="server"   ID="lblAuthor" Text='<%# Eval("author") %>' meta:resourcekey="lblAuthorResource1"></asp:Label> &nbsp;&nbsp; <asp:Label runat="server"   ID="Label9"  Text="版本：" meta:resourcekey="Label9Resource1" ></asp:Label> <asp:Label runat="server"   ID="lblVersion" Text='<%# Eval("Version") %>' meta:resourcekey="lblVersionResource1" ></asp:Label>&nbsp;&nbsp;
                        ...
                        <asp:Panel ID="PanelBulletin" runat="server" >
                            <asp:Label runat="server"   ID="Label57"  Text="發佈者：" meta:resourcekey="Label57Resource1"></asp:Label><asp:Label runat="server"   ID="Label18" Text='<%# Eval("author") %>' ></asp:Label>&nbsp;&nbsp; <asp:Label runat="server"   ID="Label19"  Text="張貼部門："  meta:resourcekey="Label19Resource1"></asp:Label><asp:Label runat="server"   ID="Label20" Text='<%# Eval("UsergroupName") %>' ></asp:Label>  
                        </asp:Panel>
                        <asp:Panel ID="PanelBriefcase" runat="server" >
                            <asp:Label runat="server"   ID="Label21"  Text="檔案大小：" meta:resourcekey="Label21Resource1" ></asp:Label><asp:Label runat="server"   ID="lblFileLength" Text='<%# Eval("Filelength") %>' ></asp:Label>&nbsp;&nbsp; <asp:Label runat="server"   ID="Label24"  Text="檔案來源：" meta:resourcekey="Label24Resource1"></asp:Label><asp:Label runat="server"   ID="lblSource" Text='<%# Eval("Useraccount") %>' ></asp:Label>  
                        </asp:Panel>
                        <asp:Panel ID="PanelMessage" runat="server" >
                            <asp:Label runat="server"   ID="Label25"  Text="寄件者："  meta:resourcekey="Label25Resource1"></asp:Label><asp:Label runat="server"   ID="Label26" Text='<%# Eval("Useraccount") %>' ></asp:Label>&nbsp;&nbsp; <asp:Label runat="server"   ID="Label27"  Text="收件者：" meta:resourcekey="Label27Resource1"></asp:Label><asp:Label runat="server"   ID="Label28" Text='<%# Eval("MessagetoAcc") %>' ></asp:Label>  
                        </asp:Panel>
                        <asp:Panel ID="PanelWKF" runat="server" >
                            <asp:Label runat="server"   ID="Label29"  Text="表單名稱：" meta:resourcekey="Label29Resource1"></asp:Label><asp:Label runat="server"   ID="Label30" Text='<%# Eval("WKFFormName") %>' ></asp:Label>&nbsp;&nbsp;<asp:Label runat="server"   ID="Label23"  Text="申請者：" meta:resourcekey="Label23Resource1"></asp:Label><asp:Label runat="server"   ID="Label31" Text='<%# Eval("author") %>' ></asp:Label> &nbsp;&nbsp;<asp:Label runat="server"   ID="Label32"  Text="申請者部門：" ></asp:Label><asp:Label runat="server"   ID="Label33" Text='<%# Eval("UsergroupName") %>' ></asp:Label> 
                        </asp:Panel>
                    </td>
                </tr>
            </table>
                 ...
                 <tr ><td >
            <hr />
            <table id="tbhot"><tr><td width="30"></td><td>
            ...
            <div id="divPlaceHolder2" style="display: block;overflow:hidden"><asp:PlaceHolder ID="PlaceHolder2" runat="server" ></asp:PlaceHolder></div><br /><br />
            ...
            <div id="divPlaceHolder3" style="display: block;overflow:hidden"><asp:PlaceHolder ID="PlaceHolder3" runat="server" ></asp:PlaceHolder></div>
                </asp:Panel>                
                </td></tr></table>
                </td></tr></table>
