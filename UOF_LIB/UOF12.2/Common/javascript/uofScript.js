...
var $uof = {
    ...
    dialog: {
        isInRadWindow: function () {
            ...
            /// </summary>
            var val = false;
            if (window.radWindow) return true;
            else if (window.frameElement && window.frameElement.radWindow) return true;
            else if (window.parent.frameElement && window.parent.frameElement.radWindow) return true;
            return val;
        },
        getCurrentWindow: function () {
            ...
            else if (window.parent.frameElement && window.parent.frameElement.radWindow) oWindow = window.parent.frameElement.radWindow;
            return oWindow;
        },
