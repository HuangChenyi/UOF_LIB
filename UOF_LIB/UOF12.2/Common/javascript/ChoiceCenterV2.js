...
Choice.switchMode = function switchMode(type) {
    if (type == Choice.ChoiceType.Department) {
        ...
        if (node != null) {
            ...
            Choice.submitSearchUser({ "action": "GetGroupUser", "id": "" });
        }
...
Choice.setExpendToUser = function setExpendToUser(type, id, groupId, isDepth) {
    ...
    $.ajax({
        ...
        type: "POST",
        dataType: "json",
        data: { "action": "GetExpendToUser", "type": strType, "id": id, "groupId": groupId, "isDepth": isDepth }
...
//#region 搜尋
Choice.searchDepartment = function searchDepartment() {
    $.ajax({
        url: "../../Common/ChoiceCenter/ChoiceHandler.ashx",
        type: "POST",
        dataType: "json",
        data: { "action": "SearchDepartment", "keyword": $("#txbKeyWordDept").val() }
    }).done(function (response, textStatus, jqXHR) {
...
Choice.searchDepartmentByLimit = function searchDepartmentByLimit(userGuid) {
    $.ajax({
        url: "../../Common/ChoiceCenter/ChoiceHandler.ashx",
        type: "POST",
        dataType: "json",
        data: { "action": "SearchDepartmentByLimit", "keyword": $("#txbKeyWordDept").val(), "userGuid": userGuid }
    }).done(function (response, textStatus, jqXHR) {
        Choice.Config.departmentCache = response;
        if (Choice.Config.departmentCache.length > 0) {
            Choice.Config.departmentIndex = 0;
...
Choice.searchUser = function searchUser(parameter) {
    var userType;
    ...
    Choice.submitSearchUser({ "action": "SearchUser", "userType": userType, "keyword": $("#txbKeyWordUser").val(), "userGuid": parameter });
};

Choice.searchLimitUser = function searchLimitUser(userGuid, limitData, isLimit) { 
    $.ajax({
        url: "../../Common/ChoiceCenter/ChoiceHandler.ashx",
        type: "POST",
        dataType: "json",
        data: { "action": "SearchLimitUser", "choiceType": Choice.Config.currentMode, "keyword": $("#txbKeyWordUser").val(), "userGuid": userGuid, "limitData": limitData }
    }).done(function (response, textStatus, jqXHR) {
...
Choice.searchUserByDeptLimit = function searchUserByDeptLimit(userGuid, isLimit) {
    $.ajax({
        url: "../../Common/ChoiceCenter/ChoiceHandler.ashx",
        type: "POST",
        dataType: "json",
        data: { "action": "SearchUserByDeptLimit", "choiceType": Choice.Config.currentMode, "keyword": $("#txbKeyWordUser").val(), "userGuid": userGuid }
    }).done(function (response, textStatus, jqXHR) {
        Choice.Config.userCache = response;
        Choice.Config.userMaxPageIndex = Math.ceil(Choice.Config.userCache.length / Choice.Config.userPageSize);
        Choice.setUserSearchPagingInfo();
