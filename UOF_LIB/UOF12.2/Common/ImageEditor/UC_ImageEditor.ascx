    ...
    <script type="text/javascript">
        ...
        Sys.Application.add_init(function () {
            ...
            Sys.Application.add_load(function () {
                ...
                Telerik.Web.UI.ImageEditor.CommandList["ImageUpload"] = function (imageEditor, commandName, args) {
                    FireSelectFile();
                }
                <%--if (isFirefox > -1) {
                    $("#divFF").show();
...
<div id="divFF">
    <asp:Label ID="lblNotFireFox" runat="server" Text="本功能不支援FireFox" ForeColor="Red" Font-Bold="true" Font-Size="Larger"></asp:Label></div>
<div id="<%=ClientID %>" class="<%=ClientID %>" style="overflow: hidden">
    ...
    <telerik:RadImageEditor ID="RadImageEditor1" runat="server"
        OnImageSaving="RadImgEdt_ImageSaving" OnImageLoading="RadImageEditor1_ImageLoading">
        <Tools>
            <telerik:ImageEditorToolGroup>
                ...
                <telerik:ImageEditorTool CommandName="Zoom"></telerik:ImageEditorTool>
                <telerik:ImageEditorTool CommandName="RotateRight"></telerik:ImageEditorTool>
                <telerik:ImageEditorTool CommandName="RotateLeft"></telerik:ImageEditorTool>
                <telerik:ImageEditorTool CommandName="ImageUpload" ImageUrl="../Images/Icon/icon_j24.gif"></telerik:ImageEditorTool>
            </telerik:ImageEditorToolGroup>
