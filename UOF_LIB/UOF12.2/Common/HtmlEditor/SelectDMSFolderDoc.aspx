...
function DownloadFileWithHandler(sHandlerUrl, sUserProxyIndex) {
   ...
   <table id="Table1" border="0" cellpadding="0" cellspacing="0" style="width: 100%; height: 450px; border: solid 2px silver; padding: 0px;">
	   <tr>
        ...
        OnNodeCreated="docTree_NodeCreated"
...
<asp:LinkButton runat="server" ID="linkVerAdd" meta:resourcekey="linkVerAddResource1" >版本連結</asp:LinkButton>
            ...
            <input id="hidRefDoc" runat="server" style="width: 39px" type="hidden" />&nbsp;
            <input id="hidSelectType" runat="server" style="width: 19px" type="hidden" />
    ...
    <asp:Label ID="lblSearch" runat="server"  Text="全文檢索" Visible="False" meta:resourcekey="lblSearchResource1"></asp:Label>
     ...
     <input id="hidClickValue" runat="server" style="width: 16px" type="hidden" /><input id="hdAppPath" runat="server" enableviewstate="true" style="width: 14px" type="hidden" />
    <input id="hidTabSelect" runat="server" enableviewstate="true" style="width: 9px"
		type="hidden" />
