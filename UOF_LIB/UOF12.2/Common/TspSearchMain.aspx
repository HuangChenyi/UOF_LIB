                                            ...
                                            <table id="dateTb">
                                                <tr>
                                                    <td style="padding-left: 2px; padding-right: 1px">
                                                        <telerik:RadDatePicker ID="WebDateChooserBegin" runat="server" Culture="zh-TW" meta:resourcekey="WebDateChooserBeginResource1">
...
<DatePopupButton ImageUrl="" HoverImageUrl="" CssClass=""></DatePopupButton>
                                                    ...
                                                    <td style="padding-left: 2px; padding-right: 1px">
                                                        <telerik:RadDatePicker ID="WebDateChooserEnd" runat="server" Culture="zh-TW" meta:resourcekey="WebDateChooserEndResource1">
<Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" EnableWeekends="True" Culture="zh-TW" FastNavigationNextText="&amp;lt;&amp;lt;"></Calendar>
