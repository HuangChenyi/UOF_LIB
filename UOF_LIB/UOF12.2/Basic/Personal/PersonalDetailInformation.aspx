        ...
        function RadToolBar1_ButtonClicking(sender, args) {
            ...
            if (value == "SendMessage") {
                ...
                $uof.dialog.open2("~/Basic/Personal/PrivateMessage/ReplyMessage.aspx", args.get_item(),
                      "", 1024, 768, OpenDialogResult, { "userId": '<%=Request["userid"]%>' });
            }
        }
    ...
    <asp:Panel ID="Panel2" runat="server" meta:resourcekey="Panel2Resource1">
        <table width="100%" class="PopTable" cellspacing="1">
            ...
            <tr>
                ...
                <td style="word-break: break-all">
                    <asp:HyperLink ID="hlMsn" runat="server" Target="_blank" meta:resourcekey="hlMsnResource1" Text="[hlMsn]"></asp:HyperLink></td>
            </tr>
            <tr>
                <td>
            ...
            <tr>
                ...
                <td>
                    <asp:Label ID="Label19" runat="server" Text="簽名" meta:resourcekey="Label19Resource1"></asp:Label></td>
                <td style="word-break:break-all">
                    <pre><asp:Label ID="LBLsign" runat="server" meta:resourcekey="LBLsignResource1"></asp:Label></pre></td>
            </tr>
            <tr>
                <td>
        ...
        <table width="100%" class="PopTable" cellspacing="1">
            ...
            <tr>
                ...
                <td colspan="3" style="word-break:break-all">
                    <pre><asp:Label ID="LBLSign2" runat="server" meta:resourcekey="LBLSign2Resource1"></asp:Label></pre></td>
            </tr>
            <tr>
                <td>
