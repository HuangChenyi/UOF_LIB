            ...
            <table width="99%" style="height:100%;">
                <tr>
                    <td style="background-image: url(<%=themePath %>/images/tree_bg.gif); text-align:left;vertical-align:top;">
                        <telerik:RadTreeView ID="treeMyAddr" runat="server" OnNodeClick="treeMyAddr_NodeClick"  EnableDragAndDrop="True"></telerik:RadTreeView>
                    </td>
                </tr>
            </table>
        </td>
        <td  style="background-image: url(<%=themePath %>/images/tree_bg.gif); width:50%; vertical-align:top;">
             <telerik:RadTreeView ID="treeEmployee" runat="server" EnableDragAndDrop="true" OnClientNodeClicking="treeEmployee_NodeClicking" OnClientNodeDropping="treeEmployee_NodeDropping" OnNodeDrop="treeEmployee_NodeDrop"></telerik:RadTreeView>
        </td>
            </tr>
        </table>
