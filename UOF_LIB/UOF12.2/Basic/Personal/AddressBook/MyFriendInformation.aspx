...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table cellspacing="1" class="PopTable">
        ...
        <tr>
            <td style="white-space: nowrap">
                <asp:Label ID="LBLqq" runat="server" meta:resourcekey="LBLqqResource1" Text="QQ"></asp:Label></td>
            <td>
                <asp:TextBox ID="txbQQ" runat="server" MaxLength="50" meta:resourcekey="txbQQResource1"></asp:TextBox></td>
            <td style="white-space: nowrap">
