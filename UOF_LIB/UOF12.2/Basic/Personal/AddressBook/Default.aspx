...
<asp:Content ID="Content3" ContentPlaceHolderID="LeftContentPlaceHolder" runat="Server">
    <telerik:RadMultiPage ID="RadMultiPage2" runat="server" SelectedIndex="0">
        ...
        <telerik:RadPageView ID="RadPageView5" runat="server">
            <telerik:RadTreeView ID="rtvTreeSkill" runat="server" OnNodeClick="rtvTreeSkill_NodeClick">
            </telerik:RadTreeView>
        </telerik:RadPageView>
        <telerik:RadPageView ID="RadPageView6" runat="server">
            <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <telerik:RadTreeView ID="rtvTreeMyAddr" runat="server" OnNodeClick="rtvTreeMyAddr_NodeClick" OnClientNodeClicked="onClientNodeClicked">
                    </telerik:RadTreeView>
                </ContentTemplate>
            </asp:UpdatePanel>
        </telerik:RadPageView>
        ...
        <telerik:RadPageView ID="RadPageView9" runat="server">
            <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    ...
                    <input id="hiddenNodeTag" runat="server" type="hidden"></input>
