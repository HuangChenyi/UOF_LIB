...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
            ...
            <tr>
                ...
                <td>
                    <table width="100%">
                        ...
                        <tr>
                            <td>
                                <telerik:RadTreeView ID="rtvTreeMyAddr" runat="server" Height="200px"  CheckBoxes="true" TriStateCheckBoxes="true">
                                </telerik:RadTreeView>
                            </td>
                        </tr>
                    </table> 
    ...
    <asp:HiddenField ID="hdMessage" Value="匯出至Excel" runat="server"  />
