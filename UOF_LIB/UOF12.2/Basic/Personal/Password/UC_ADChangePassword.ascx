...
<table class="PopTable" cellspacing="1" style="font-size:small">
    <tr>
        ...
        <td class="PopTableRightTD">
            <asp:TextBox ID="txtOldPassword" runat="server" TextMode="Password" meta:resourcekey="txtOldPasswordResource1"></asp:TextBox>
    ...
    <tr>
        ...
        <td class="PopTableRightTD">
            <asp:TextBox ID="txbConfirmPassword" runat="server" TextMode="Password" meta:resourcekey="txbConfirmPasswordResource1"></asp:TextBox>
