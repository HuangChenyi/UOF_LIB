<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="Basic_Personal_PrivateMessage_ViewUnReadMsg" Title="瀏覽未讀訊息" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="ViewUnReadMsg.aspx.cs" %>
...
td.JustAddBorder table tr td {
    ...
    function MessagePrint() {
        ...
        var url = '../PrivateMessage/PrintMessage.aspx?msgId=' + msgId + '&fontsize=' + fontsize;        
    ...
    <telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%" OnButtonClick="RadToolBar1_ButtonClick" OnClientButtonClicking="RadToolBar1_ButtonClicking" meta:resourcekey="RadToolBar1Resource1">
        <Items>
            ...
            <telerik:RadToolBarButton runat="server" Text="下一筆未讀訊息" Value="next"
            ...
            <telerik:RadToolBarButton runat="server" Text="返回訊息清單" Value="backList"
                ClickedImageUrl="~/Common/Images/Icon/icon_m62.gif" DisabledImageUrl="~/Common/Images/Icon/icon_m62.gif"
                HoveredImageUrl="~/Common/Images/Icon/icon_m62.gif" ImageUrl="~/Common/Images/Icon/icon_m62.gif" meta:resourcekey="RadToolBarButtonResource13">
            </telerik:RadToolBarButton>
    ...
    <table class="PopTable" style="border-spacing: 1;">
        <tr>
            ...
            <td style="width: 92%; word-wrap: break-word;">
                <asp:Panel ID="Panel2" runat="server" Width="900px" ScrollBars="Auto" meta:resourcekey="Panel2Resource1">
                    <asp:Label ID="lbTopic" runat="server" Width="900px" meta:resourcekey="lbTopicResource1"></asp:Label>
                </asp:Panel>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td style="width: 92%">&nbsp;<asp:Label ID="lbSender" runat="server" meta:resourcekey="lbSenderResource1"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="width: 8%; white-space: nowrap;">
                <asp:Label ID="lbLeftCreateTime" runat="server" Text="寄件時間" meta:resourcekey="lbLeftCreateTimeResource1"></asp:Label></td>
            <td style="width: 92%">&nbsp;<asp:Label ID="lbCreateTime" runat="server" meta:resourcekey="lbCreateTimeResource1"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="width: 8%; white-space: nowrap;">
                <asp:Label ID="lbLeftReadedTime" runat="server" Text="閱讀時間" meta:resourcekey="lbLeftReadedTimeResource1"></asp:Label></td>
            <td style="width: 92%">&nbsp;<asp:Label ID="lbReadedTime" runat="server" meta:resourcekey="lbReadedTimeResource1"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="width: 8%; white-space: nowrap;">
                <asp:Label ID="lbLeftReplyTime" runat="server" Text="回覆時間" meta:resourcekey="lbLeftReplyTimeResource1"></asp:Label></td>
            <td style="width: 92%">&nbsp;<asp:Label ID="lbReplyTime" runat="server" meta:resourcekey="lbReplyTimeResource1"></asp:Label>
            </td>
        </tr>
        <tr>
            <td style="width: 8%; white-space: nowrap;">
                <asp:Label ID="lbLeftContent" runat="server" Text="訊息內容" meta:resourcekey="lbLeftContentResource1"></asp:Label></td>
            <td style="line-height: normal; width: 92%; height:300px;" class="editorcontentstyle JustAddBorder">
                <asp:Literal ID="ltContext" runat="server" meta:resourcekey="ltContextResource1"></asp:Literal>
            </td>
        </tr>
        <tr>
            <td style="width: 8%; white-space: nowrap;">
