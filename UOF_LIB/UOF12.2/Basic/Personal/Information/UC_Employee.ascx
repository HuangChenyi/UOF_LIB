...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <tr>        
        ...
        <asp:Panel runat="server" ID="Panel_QRCode" Visible="false">
            <td style="white-space: nowrap;vertical-align:middle;">
    ...
    <tr>
        ...
        <td style="white-space: nowrap">
            <asp:Label ID="Label8" runat="server" Text="MSN信箱" meta:resourcekey="Label8Resource1"></asp:Label></td>
        <td>
            <asp:TextBox ID="txtMsn" runat="server" Columns="30" MaxLength="255" meta:resourcekey="txtMsnResource1"></asp:TextBox>
            <asp:Label ID="lblMsn" runat="server" meta:resourcekey="lblMsnResource1"></asp:Label>
        </td>
    </tr>
    <tr>
        <td>
    ...
    <tr>
        ...
        <td valign="top">
            <asp:TextBox ID="txtWebMailPWD" runat="server" TextMode="Password" autocomplete="new-password" MaxLength="128" meta:resourcekey="txtWebMailPWDResource1"></asp:TextBox>
    ...
    <tr>
        ...
        <td style="white-space: nowrap;vertical-align:middle;">
            <asp:Label ID="Label19" runat="server" Text="簽名" meta:resourcekey="Label19Resource1"></asp:Label>
        </td>
        <td style="vertical-align:middle;">
...
<asp:HiddenField ID="hidDomainGUID" runat="server" />
