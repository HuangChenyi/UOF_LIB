    ...
    <tr>
        ...
        <td>
            <asp:RadioButtonList ID="rboSex2" runat="server" RepeatDirection="Horizontal" meta:resourcekey="rboSex2Resource1">
                <asp:ListItem Selected="True" Value="M" meta:resourcekey="ListItemResource1" Text="男"></asp:ListItem>
        ...
        <td>
            <telerik:RadDatePicker ID="rdpChooserbirth" runat="server" Culture="zh-TW" meta:resourcekey="rdpChooserbirthResource3">
