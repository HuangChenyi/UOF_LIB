...
<script type="text/javascript" language="javascript" >
    function cbChoice_OnClick(obj)
    {
        ...
        if(hiddenCreate.val() == "Y" || hiddenOther.val() == "Y")
        {
            if (obj.checked) {
                if (isMobile == "True") {
                    txtCreate_M.attr("disabled", false);
                }
                else {
                ...
                if (isMobile == "True") {
                    txtCreate_M.attr("disabled", true);
                }
                else {
...
<table style="width: 100%; " border="0" cellspacing="0" cellpadding="0">
                ...
                <ContentTemplate>
                    <asp:Panel ID="pnlChoice" runat="server" meta:resourcekey="pnlChoiceResource1">
                        <asp:DataList ID="dsAnswerOption" runat="server" OnItemDataBound="dsAnswerOption_ItemDataBound"
                            ...
                            <ItemTemplate>
                                <table cellspacing="0" cellpadding="0" style=" border:0; vertical-align:top;" runat="server">
                                    <tr style="vertical-align: top;" >
                                        ...
                                        <td style="padding-top:1px;" id="uofCreateDisabled"  runat="server">
                                            <asp:Label ID="lblCreate" BackColor="White" style="display:block;word-wrap: break-word;"
                                                BorderWidth="2px" BorderColor="White" Text=" " Width="185px"
                                    ...
                                    <tr id="mobilePhoto" runat="server">
                                        <td>
                                            <div  style="margin-left:25px"">
                                                <asp:HyperLink ID="hylinkThumbnail_M" runat="server" Target="_blank"></asp:HyperLink>
                                            </div>
                                        </td>
                                    </tr>
                                </table>
                    ...
                    <asp:Panel ID="pnlText" runat="server" Style="overflow-x: hidden; text-align:left;" meta:resourcekey="pnlTextResource1">
                        ...
                        <asp:Label ID="lblAnswer" Style="word-wrap: break-word;" BackColor="White"
                            BorderWidth="2px" BorderColor="White" BorderStyle="Inset" runat="server" 
                            meta:resourcekey="lblAnswerResource1" Width="160px"></asp:Label>
                        <telerik:RadDatePicker ID="rdp_Answer" Runat="server"></telerik:RadDatePicker>
                    </asp:Panel>
    ...
    <tr id="memoTR" runat="server">
        <td style="white-space:nowrap;">
            ...
            <asp:Label ID="lblDescription" runat="server" Style="word-wrap: break-word; white-space:normal;" meta:resourcekey="lblDescriptionResource1"></asp:Label>
        </td>
    </tr>
</table>
