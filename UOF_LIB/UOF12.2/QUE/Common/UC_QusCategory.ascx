...
<input id="hiddenRepeat" type="hidden" runat="server" value="" />
<input id="hiddenNode" type="hidden" runat="server" value="" />
<input id="hiddenMsg" type="hidden" runat="server" value="類別不可以重復" />
<input id="hiddenEmpty" type="hidden" runat="server" value="類別不可以為空" />
<input id="hiddenDelete" type="hidden" runat="server" value="該類別不可以被刪除" />
<input id="hiddenRoot" type="hidden" runat="server" value="該類別不可以變更" />
<input id="hiddenValue" type="hidden" runat="server" value="" />
<input id="hidTag" type="hidden" runat="server" value="" />
<input id="hidName" type="hidden" runat="server" value="" />
