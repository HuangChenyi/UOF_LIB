...
<script type="text/javascript">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <telerik:RadSplitter ID="MasterRdSplitter" runat="server" Width="100%" LiveResize="True" Orientation="Horizontal" BorderSize="0" meta:resourcekey="MasterRdSplitterResource1" PanesBorderSize="0" SplitBarsSize="" OnClientResized="MasterRdSplitter_Resized">
                ...
                <telerik:RadPane ID="TreeRdPanel" runat="server" Index="1" meta:resourcekey="TreeRdPanelResource1" >
                    
                    <telerik:RadTreeView ID="treeCategory" runat="server" EnableNodeTextHtmlEncoding="True" OnClientNodeEditing="treeCategory_NodeEditing" EnableDragAndDrop="true"
    ...
    <input id="hiddenDelete" type="hidden" runat="server" value="類別內仍有子類別，請先刪除子類別" />
    <input id="hiddenHasQue" type="hidden" runat="server" value="類別內仍有問卷，不允許刪除" />
    <input id="hiddenRoot" type="hidden" runat="server" value="該類別不允許刪除" />
