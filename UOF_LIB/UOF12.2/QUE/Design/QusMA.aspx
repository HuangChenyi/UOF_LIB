    ...
    <script type="text/javascript" id="igClientScript">
        function maItemToolBarButtonClicking(sender, args) {
            ...
            switch (key) {
                ...
                case "ImportItem":
                    args.set_cancel(true);
                    $uof.dialog.open2("~/QUE/Design/ImportItem.aspx", args.get_item(), "<%=lblImportItems.Text%>", 840, 600, openDialogResult,
                        { "Type": "Add", "QusDesignGuid": "<%=lblDesignGuid.Text%>" });
                    break;
                case "ChangeOrder":
                    args.set_cancel(true);
                    ...
                    <td>
                        <telerik:RadToolBar ID="maItemToolBar" runat="server" OnButtonClick="maItemToolBar_OnButtonClick" OnClientButtonClicking="maItemToolBarButtonClicking" Width="100%" meta:resourcekey="maItemToolBarResource1" SingleClick="None">
                            <Items>
                                ...
                                <telerik:RadToolBarButton runat="server" CheckedImageUrl="~/Common/Images/Icon/icon_m179.gif" DisabledImageUrl="~/Common/Images/Icon/icon_m179.gif" HoveredImageUrl="~/Common/Images/Icon/icon_m179.gif" ImageUrl="~/Common/Images/Icon/icon_m179.gif" meta:resourcekey="maItemToolBarImportItemResource1" Text="匯入題目" Value="ImportItem"></telerik:RadToolBarButton>
        ...
        <telerik:RadPageView ID="rpvUsers" runat="server" meta:resourcekey="rpvUsersResource1">
            <table cellspacing="1" class="PopTable" style="width: 100%;">
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td style="width: 50px">
                                    <telerik:RadDatePicker ID="rdpStartDate" runat="server" Culture="zh-TW" meta:resourcekey="rdpStartDateResource1" AutoPostBack="True" OnSelectedDateChanged="rdpStartDate_SelectedDateChanged">
                                ...
                                <td style="width: 50px">
                                    <telerik:RadDatePicker ID="rdpEndDate" runat="server" Culture="zh-TW" meta:resourcekey="rdpEndDateResource1">
                                        <Calendar Culture="zh-TW" EnableWeekends="True" FastNavigationNextText="&amp;lt;&amp;lt;" UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False">
                                        </Calendar>
                ...
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td>
                                    <telerik:RadDatePicker ID="rdpShowReportTime" runat="server" Culture="zh-TW" meta:resourcekey="rdpShowReportTimeResource1">
                                        <Calendar Culture="zh-TW" EnableWeekends="True" FastNavigationNextText="&amp;lt;&amp;lt;" UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False">
                                        </Calendar>
                                        <DateInput DateFormat="yyyy/M/d" DisplayDateFormat="yyyy/M/d" LabelWidth="64px" Width="">
                                            <EmptyMessageStyle Resize="None" />
                ...
                <tr>
                    ...
                    <td>
                        <telerik:RadDatePicker ID="rdpExpired" runat="server" Culture="zh-TW" meta:resourcekey="rdpExpiredResource1">
                            <Calendar Culture="zh-TW" EnableWeekends="True" FastNavigationNextText="&amp;lt;&amp;lt;" UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False">
                            </Calendar>
                            <DateInput DateFormat="yyyy/M/d" DisplayDateFormat="yyyy/M/d" LabelWidth="64px" Width="">
                                <EmptyMessageStyle Resize="None" />
                ...
                <tr>
                    ...
                    <td>
                        <table style="padding: 0; width: 25%">
                            ...
                            <tr>
                                <td colspan="2">
                                    <asp:RadioButton ID="rbNoticeAtOnce" runat="server" Text="立即通知" GroupName="NoticeGroup" onclick="CheckRadioButtonStatus('Y')" meta:resourcekey="rbNoticeAtOnceResource1" AutoPostBack="True" OnCheckedChanged="rbNoticeAtOnce_CheckedChanged" />
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
                ...
                <tr>
                    <td colspan="2" style="text-align: left;">
                        ...
                        <br />
                        <asp:Label ID="Label2" runat="server" CssClass="SizeMemo" meta:resourcekey="Label2Resource1" Text="3. 問卷啟用後，如修改問 卷調查對象，將會修改問卷的發送數及回收數。"></asp:Label>
                    </td>
                </tr>
            </table>
        </telerik:RadPageView>
