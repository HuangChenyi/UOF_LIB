<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MobileMasterPage.master" AutoEventWireup="true" CodeBehind="FillOutMobileNext.aspx.cs" Inherits="QUE_FillOut_FillOutMobileNext" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <script type="text/javascript" id="igClientScript">
        ...
        $(function () {
            ...
            window.close = function () { window.location.href = '#InAppBrowserClosed'; };
        });
