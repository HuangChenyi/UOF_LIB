                            ...
                            <td>
                                <table cellspacing="1" class="PopTable" style="width: 100%">
                                    ...
                                    <tr>
                                        ...
                                        <td style="width: 12%">
                                            <telerik:RadDatePicker ID="rdpBeginDate" runat="server" meta:resourcekey="rdpBeginDateResource1" Culture="zh-TW">
                                        ...
                                        <td style="width: 12%">
                                            <telerik:RadDatePicker ID="rdpEndDate" runat="server" meta:resourcekey="rdpEndDateResource1" Culture="zh-TW">
                                                <Calendar UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False" Culture="zh-TW" EnableWeekends="True" FastNavigationNextText="&amp;lt;&amp;lt;">
                                                </Calendar>
