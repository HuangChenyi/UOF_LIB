...
// -->
    ...
    <asp:CustomValidator ID="cvMessage" runat="server" meta:resourcekey="cvMessageResource1"></asp:CustomValidator><br />
    ...
    <div style="margin-left:8px;"><uc1:UC_Qus ID="UC_Qus1" runat="server" /></div>
