<%@ Page Language="C#" MasterPageFile="~/Master/DefaultMasterPage.master" AutoEventWireup="true" EnableEventValidation="false" Inherits="Homepage" Title="" Culture="auto" meta:resourcekey="PageResource1"
         UICulture="auto" Codebehind="Homepage.aspx.cs" %>
 ...
 .RadDock_Design {
    ...
    <div style="margin-bottom: 3px;">
                ...
                <span style="padding-left: 20px;margin-top: 2px;  margin-right: 2px; margin-left: auto; display: block; width: 60px; height: 24px; background-image: url(Common/Images/Buttons/webpart_but03.png)">
                    <%--<asp:LinkButton ID="lbtnCatalog" runat="server" OnClientClick="return Open();">設計</asp:LinkButton>
                    <asp:LinkButton ID="lbtnClose" runat="server" Visible="False" OnClientClick="return Close();">關閉</asp:LinkButton>--%>
                    <a id="lbtnCatalog" href="#" runat="server" ><asp:Literal ID="Literal1" runat="server" Text="設計" meta:resourcekey="Literal1Resource1" /></a>
     ...
     <telerik:RadDockLayout runat="server" ID="RadDockLayout1" OnSaveDockLayout="RadDockLayout1_SaveDockLayout"
            ...
            <td >
                <table border="0" style="width:100%"><tr>
                    ...
                    <td style="white-space:nowrap;text-align:center; width:9%; background-image:url(<%=themePath %>/images/webpart/bar_Main.png)"><asp:Label ID="lblSysPanel" runat="server" Text="企業面板" meta:resourcekey="lblSysPanelResource1"></asp:Label></td>
                    ...
                    <td><img  src="<%=themePath %>/images/webpart/bar_L.png" /></td>
                    <td style="white-space:nowrap;text-align:center; width:9%; background-image:url(<%=themePath %>/images/webpart/bar_Main.png)"><asp:Label ID="Label4" runat="server" Text="個人面板" meta:resourcekey="LabelPersonResource1"></asp:Label></td>
                    <td><img  src="<%=themePath %>/images/webpart/bar_R.png" /></td>
                    <td style="width:90%;background-image:url(<%=themePath %>/images/webpart/bar_line.png)"></td></tr>                                  
