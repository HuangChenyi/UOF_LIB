        ...
        <ContentTemplate>
            <telerik:RadMultiPage ID="rmpTree" runat="server">
                <telerik:RadPageView ID="RadPageView3" runat="server">
                    <telerik:RadTreeView ID="rtvMyFolderTree" runat="server"
                        OnNodeClick="rtvMyFolderTree_NodeClick">
                    </telerik:RadTreeView>
                </telerik:RadPageView>
                <telerik:RadPageView ID="RadPageView5" runat="server">
                    <telerik:RadTreeView ID="rtvDepUserTree"
        ...
        <ContentTemplate>
            <telerik:RadMultiPage ID="rmpGrid" runat="server">
                <telerik:RadPageView ID="RadPageView4" runat="server">
                    <input id="hideCreateFileEnable" type="hidden" runat="server" value="1" />
                    <input id="hideCreateFolderEnable" runat="server" type="hidden" value="1" />
                    <input id="hideDeleteFileEnable" runat="server" type="hidden" value="1" />
                    <input id="hideSharingFolderEnable" runat="server" type="hidden" value="1" />
                    ...
                    <input id="hideFolderid" type="hidden" runat="server" />
                    <input id="hideNodecount" runat="server" type="hidden" />
                    <input id="hideFoldername" runat="server" type="hidden" />
                </telerik:RadPageView>
                <telerik:RadPageView ID="RadPageView6" runat="server">
                    ...
                    <input id="hideCurrentFolder" type="hidden" runat="server" />
                    <input id="hideUpperFolder" runat="server" type="hidden" />
                    <input id="hideLinkFolder" runat="server" type="hidden" />
...
<%--                            <asp:BoundField DataField="FILE_LENGTH" HeaderText="檔案大小(Byte)" meta:resourceKey="BoundFieldResource7" SortExpression="FILE_LENGTH"></asp:BoundField>--%>
                            <asp:TemplateField HeaderText="檔案大小" SortExpression="FILE_LENGTH" meta:resourceKey="BoundFieldResource7">
                                <ItemTemplate>
                ...
                <telerik:RadPageView ID="RadPageView8" runat="server">
                    ...
                    <Fast:Grid ID="searchGrid" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateCheckBoxColumn="True" AutoGenerateColumns="False"
                        ...
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="檔案大小" SortExpression="byteSize" meta:resourceKey="BoundFieldResource2">
                                <ItemTemplate>
                    ...
                    <input id="hideSearchKey" runat="server" type="hidden" />
                    <input id="hideSearchScope" runat="server" type="hidden" />
                </telerik:RadPageView>
            </telerik:RadMultiPage>
        </ContentTemplate>
    </asp:UpdatePanel>
    ...
    <input id="hideBriefcaseSize" type="hidden" runat="server" />
    <input id="hideScope" type="hidden" runat="server" />
</asp:Content>

<%--<asp:Content ID="Content0" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">

    <table cellpadding="0" cellspacing="0" style="height: 600px; width: 100%; border: 0;">
        <tr>
            <td valign="top" style="height: 600px; width: 100%">
                <asp:UpdatePanel ID="updatePtab" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                    <contenttemplate>
                        
                        <telerik:RadMultiPage ID="RadMultiPage1" Runat="server">
                            <telerik:RadPageView runat="server" id="rpvMyFolder" BackColor="White">
                                <table cellpadding="0" cellspacing="0" style="height: 100%; border: 0; width: 100%;">
                                    ...
                                    <tr>
                                        <td valign="top" align="left" style="height: 610px">
                                            <asp:UpdatePanel ID="updatePmyFolderTree" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                                                <ContentTemplate>
                                        ...
                                        <td valign="top" align="left" width="80%">
                                            <asp:UpdatePanel ID="updatePfileGrid" runat="server" UpdateMode="Conditional" RenderMode="Inline">
                                                <ContentTemplate>
                                                
                                            </ContentTemplate>
                                            <Triggers>
                                                <asp:AsyncPostBackTrigger ControlID="RadToolBar1" EventName="ButtonClick" />
                                                <asp:AsyncPostBackTrigger ControlID="rtvMyFolderTree" EventName="NodeClick" />
                                            </Triggers>
                                        </asp:UpdatePanel>
                        ...
                        <telerik:RadPageView runat="server" id="rpvSharedFolder" BackColor="White">
                            <table cellpadding="0" cellspacing="0" style="height: 100%; border: 0; width: 100%">
                                <tr>
                                    <td   style="height: 610px; vertical-align:top;">
                                        
                            </td>
                            <td style="width: 10px; height: 100%;">
                            </td>
                            <td valign="top" style="height: 100%" width="80%">
                                <asp:UpdatePanel ID="updatePShareGrid" runat="server" UpdateMode="Conditional" RenderMode="Inline"><ContentTemplate>
                             
                                </ContentTemplate>
                                <Triggers>
                                <asp:AsyncPostBackTrigger ControlID="rtvDepUserTree" EventName="NodeClick" />
                                </Triggers>
                                </asp:UpdatePanel>
                            </td>
                        </tr>
                ...
                <telerik:RadPageView runat="server" id="rpvLatestShare" BackColor="White">
                    <table cellpadding="0" cellspacing="0" style="height: 100%; border: 0; width: 100%">
                        <tr>
                            <td valign="top">
                ...
                <telerik:RadPageView runat="server" id="rpvSearchResult" BackColor="White">
                ...
                <tr>
                    <td valign="top">
                        <asp:UpdatePanel ID="updatePsearchGrid" runat="server" UpdateMode="Conditional">
                            <ContentTemplate>
