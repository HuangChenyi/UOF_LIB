...
<asp:Content ID="Content4" ContentPlaceHolderID="RightContentPlaceHolder" runat="Server">
                                        ...
                                        <table class="PopTable" cellpadding="0" cellspacing="1" style="width: 200px">
                                            ...
                                            <tr>
                                                <td colspan="2" class="PopTableRightTD">
                                                    ...
                                                    <asp:Label ID="lbException" runat="server" meta:resourcekey="lbExceptionResource1" ForeColor="Red"></asp:Label>
                                                </td>
                                            </tr>
                                        </table>
                                    </td>
    ...
    <asp:Label ID="lblSetPwd" runat="server" Text="設定簡訊發送的帳號及密碼。" Visible="False"
        meta:resourcekey="lblSetPwdResource1"></asp:Label>
    <asp:Label ID="lblSMSManager" runat="server" Text="簡訊管理者，可發送簡訊，及設定擁有發送簡訊權限之使用者。"
        Visible="False" meta:resourcekey="lblSMSManagerResource1"></asp:Label>
    <asp:Label ID="lblSMSUser" runat="server" Text="簡訊使用者，可使用簡訊的發送。" Visible="False"
        meta:resourcekey="lblSMSUserResource1"></asp:Label>
    <asp:Label ID="lblSucc" runat="server" Text="帳號密碼正確" Visible="False"
        meta:resourcekey="lblSuccResource1"></asp:Label>
    <asp:Label ID="lblFial" runat="server" Text="帳號密碼有誤" Visible="False"
        meta:resourcekey="lblFialResource1"></asp:Label>
    <asp:Label ID="lblSave" runat="server" Text="儲存成功" Visible="False"
        meta:resourcekey="lblSaveResource1"></asp:Label>
    <asp:Label ID="lblSetAccount" runat="server" Text="設定帳號密碼" Visible="False"
        meta:resourcekey="lblSetAccountResource1"></asp:Label>
    <asp:Label ID="lblSMSUserRole" runat="server" Text="簡訊使用者" Visible="False"
        meta:resourcekey="lblSMSUserRoleResource1"></asp:Label>
