<%@ Page Language="C#" MasterPageFile="~/Master/DefaultMasterPage.master" AutoEventWireup="true" Inherits="EIP_SMS_Default" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" CodeBehind="Default.aspx.cs" %>
        ...
        function RadToolBar1_ButtonClicking(sender, args) {
            ...
            switch (value) {
                case "Insert":
                    ...
                    $uof.dialog.open2("~/EIP/SMS/SendMsg.aspx", args.get_item(), "", 1000, 700, OpenDialogResult);
                        ...
                        <Fast:Grid ID="Grid1" runat="server" Width="100%"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="簡訊主旨" SortExpression="SUBJECT" meta:resourcekey="TemplateFieldResource1">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtnSubject" Style="word-break: break-all" runat="server" Text='<%# Bind("SUBJECT") %>'
                                ...
                                <asp:TemplateField HeaderText="簡訊內容" meta:resourcekey="TemplateFieldResource2">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("CONTENT") %>' meta:resourcekey="TextBox1Resource1"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label1" runat="server" Style="word-break: break-all" Text='<%# Bind("CONTENT") %>' meta:resourcekey="Label1Resource1"></asp:Label>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="發送時間" SortExpression="SEND_TIME" meta:resourcekey="BoundFieldResource6">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("SEND_TIME") %>'></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
