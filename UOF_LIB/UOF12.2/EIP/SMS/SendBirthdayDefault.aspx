<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TwoColumn.master" AutoEventWireup="true" CodeBehind="SendBirthdayDefault.aspx.cs" Inherits="Ede.Uof.Web.EIP.SMS.SendBirthdayDefault" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
            ...
            switch (key) {
                case "Send":
                    ...
                    if (checkedData != '') {
                        ...
                        $uof.dialog.open2("~/EIP/SMS/SendBirthdayMsg.aspx", args.get_item(), '<%=lblDialogTitle.Text%>', 800, 500,
                            openDialogResult,
                ...
                <ItemTemplate>
                    <table>
                        <tr>
                            ...
                            <td>
                                <telerik:RadDatePicker ID="rdpDateStart" runat="server" onselecteddatechanged="rdpDateStart_SelectedDateChanged" AutoPostBack="True" Culture="zh-TW" meta:resourcekey="rdpDateStartResource1">
                            ...
                            <td>
                                <telerik:RadDatePicker ID="rdpDateEnd" runat="server" Culture="zh-TW" meta:resourcekey="rdpDateEndResource1">
                                    <Calendar Culture="zh-TW" EnableWeekends="True" FastNavigationNextText="&amp;lt;&amp;lt;" UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False">
                                    </Calendar>
