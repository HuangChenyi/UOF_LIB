                        ...
                        <Fast:Grid ID="Grid1" runat="server"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="簡訊主旨" SortExpression="SUBJECT" meta:resourcekey="TemplateFieldResource1">
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtnSubject" Style="word-break: break-all" runat="server" Text='<%# Bind("SUBJECT") %>' meta:resourcekey="lbtnSubjectResource1"></asp:LinkButton>
                                    </ItemTemplate>
                                ...
                                <asp:TemplateField HeaderText="簡訊內容" meta:resourcekey="TemplateFieldResource2">
                                    <EditItemTemplate>
                                        <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("CONTENT") %>'
                                            meta:resourcekey="TextBox1Resource1"></asp:TextBox>
                                    </EditItemTemplate>
                                    <ItemTemplate>
                                        <asp:Label ID="Label1" runat="server" Style="word-break: break-all"
                                            Text='<%# Bind("CONTENT") %>' meta:resourcekey="Label1Resource1"></asp:Label>
                                    </ItemTemplate>
