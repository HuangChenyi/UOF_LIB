...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        ...
        (function () {
            ...
            LBExternalClass.text(hfExternalClassPath.val());
        ...
        function ChangeExternalStatus() {
            ...
            if (cbPublishExternal.length > 0) {
                ...
                if (cbPublishExternal.prop("checked")) {
                    ...
                    cbExternalPrint.attr('checked', false);
                    cbExternalShowUC.attr('disabled', 'disabled');
                    cbExternalShowUC.attr('checked', true);
                }
            }
        }
                    ...
                    <td style="white-space: nowrap;">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <telerik:RadDatePicker ID="wdcPublishDate" runat="server" Width="120px">
...
<%--                                    <asp:CustomValidator ID="cvSameDate" runat="server" Display="Dynamic" ErrorMessage="上架日期需晚於或等於今日" ClientValidationFunction="cvCheckPublicDateLate"
                                        meta:resourcekey="cvSameDateResource1"></asp:CustomValidator>--%>
                                </td>
                            </tr>
                        </table>
                    </td>
                    ...
                    <td style="white-space: nowrap;">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <telerik:RadDatePicker ID="OffShelfDate" runat="server" Width="120px" meta:resourcekey="WebDateChooser1Resource1">
                                    </telerik:RadDatePicker>
                                </td>
                                <td>
