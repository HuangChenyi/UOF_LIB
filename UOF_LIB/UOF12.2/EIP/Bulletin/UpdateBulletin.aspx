                    ...
                    <td style="white-space: nowrap;">
                        <table>
                            <tr>
                                ...
                                <td>
                                    <telerik:RadDatePicker ID="wdcPublishDate" runat="server" Enabled="false" Width="120px" >
                ...
                <tr runat="server" id="trExternalPublish">
                    ...
                    <td>
                        ...
                        <table class="PopTable" cellspacing="1">
                            ...
                            <tr runat="server">
                                <td style="width: 100px;" class="PopTableLeftTD" runat="server" id="trExternalMSG1">
