...
<asp:Content ID="Content1" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="Server">
    <script id="defaultjs" type="text/javascript">
        Sys.Application.add_load(function () {
            ...
            var BULLETINE_ID = "<%=Request["BULLETINEID"]%>";                        
        ...
        function RadToolBar1_ButtonClicking(sender, args) {            
            ...
            if (Key == "AdvanceSearch") {
                ...
                $uof.dialog.open2("~/Eip/Bulletin/CreateBulletin.aspx", args.get_item(), "", 1024, 768, openDialogResult, { "Classid": classID, "Classname": className });
            }
                ...
                args.set_cancel(true);
                $uof.dialog.open2("~/Eip/Bulletin/ClassSetting.aspx", args.get_item(), "", 660, 600, openDialogResult);
            }
            else if (Key == "Delete") {
                args.set_cancel(true);
...
<asp:Content ID="Content3" ContentPlaceHolderID="LeftContentPlaceHolder" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Inline" ChildrenAsTriggers="false">
        <ContentTemplate>
            <telerik:RadTreeView ID="classTree" runat="server" OnNodeClick="classTree_NodeClick" Height="100%" meta:resourcekey="classTreeResource2">
                <Nodes>
                                    ...
                                    <Fast:Grid ID="listGrid" runat="server" AutoGenerateCheckBoxColumn="True" AllowSorting="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="操作" ShowHeader="False" meta:resourcekey="TemplateFieldResource3"
                                                ...
                                                <ItemTemplate>
                                                    <asp:LinkButton ID="LinkButton2" runat="server" CausesValidation="False" meta:resourceKey="LinkButton2Resource1"
                                                        Text="瀏覽記錄"></asp:LinkButton>&nbsp
                                                    <asp:LinkButton ID="lbtnFavorites" runat="server" meta:resourceKey="lbtnFavoritesResource1"
                                                        Text="加入收藏"></asp:LinkButton>&nbsp
                                                    <asp:LinkButton ID="lbtnEditBull" runat="server" Text="維護" meta:resourceKey="lbtnEditBullResource1"
                                                        OnClick="lbtnEditBull_Click"></asp:LinkButton>&nbsp
