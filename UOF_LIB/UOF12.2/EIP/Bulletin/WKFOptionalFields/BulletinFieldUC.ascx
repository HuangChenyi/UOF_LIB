...
<script type="text/javascript">
    ...
    function cvCheckTwoDate(source, args) {
        ...
        if (rbPublishLater.prop("checked") && rbOff.prop("checked")) {
            ...
            if (publicdate != null && offDate != null) {
...
<%--                                <asp:CustomValidator ID="cvSameDate" runat="server" Display="Dynamic" ErrorMessage="上架日期需晚於或等於今日"
                                        ClientValidationFunction="cvCheckPublicDateLate" meta:resourcekey="cvSameDateResource1"></asp:CustomValidator>--%>
                        ...
                        <tr>
                            ...
                            <td colspan="3" style="vertical-align:baseline">
                                <uc1:UC_HtmlEditor runat="server" ID="radEditorContext" Width="870px" BulletinSize="true" ModuleName="WKF" SubFolder="BULLETIN"/>
                            ...
                            <table class="PopTable" cellspacing="1">
                                ...
                                <tr>
                                    ...
                                    <td class="PopTableRightTD" runat="server" id="tdInernal3">
                                        ...
                                        <asp:CheckBox ID="cbShowExternalReader" runat="server" Text="瀏覽時顯示" Checked="true" meta:resourcekey="cbShowExternalReaderResource1" />
