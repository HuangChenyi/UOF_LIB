<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="SetupField_BulletinUpdateField.aspx.cs" Inherits="Ede.Uof.Web.EIP.Bulletin.WKFOptionalFields.SetupField_BulletinUpdateField" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <colgroup class="PopTableRightTD">	</colgroup>
    <tr>
        <td align="center" class="PopTableHeader" colspan="4"><asp:Label ID="lblSingleLine" runat="server" Text="公告變更" meta:resourcekey="lblSingleLineResource1"></asp:Label></td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>	<asp:Label ID="lblSeq" runat="server" meta:resourcekey="lblSeqResource1"></asp:Label>
            <telerik:RadNumericTextBox ID="RadNumericTextBoxSeq" runat="server" MaxLength="3" MaxValue="999"
                    MinValue="0" Width="40px" Culture="zh-TW" DbValueFactor="1" LabelWidth="16px" meta:resourcekey="RadNumericTextBoxSeqResource1"></telerik:RadNumericTextBox></td>
    </tr>
     <tr>
            <td>
    ...
    <tr id="GrideDetail">
        ...
        <td colspan="3">
                ...
                MaxValue="1000" MinValue="0" NullText="0" Width="40px" Culture="zh-TW" DbValueFactor="1" LabelWidth="16px" meta:resourcekey="RadNumericViewLengthResource1"></telerik:RadNumericTextBox>
