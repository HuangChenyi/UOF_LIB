        ...
        Sys.Application.add_load(function () {
            ...
            DisplayExternalBtn();
             ...
             if (!$("#<%= rbPublishDate.ClientID %>").is(":disabled")) {
                 ...
                 if (publictime != null)
                     publictime.attr("disabled", !PublishisChecked);
            }
            if (!$("#<%= rbCloseDate.ClientID %>").is(":disabled")) {
                ...
                if (offtime != null)
                    offtime.attr("disabled", !OffShelfisChecked);
            }
        });
    ...
    function cvCheckDelExternalProcessing(source, args) {
        ...
        function OpenDatePicker(isOpen, dateType)
        {
            if (dateType == "Publish") {
                ...
                $('#<%=ddlPublishTime.ClientID%>').attr("disabled",!isOpen);
            }
            else if (dateType == "OffShelf") {
                $find("<%= RadDateClose.ClientID %>").set_enabled(isOpen);
                $('#<%=ddlOffShelfTime.ClientID%>').attr("disabled", !isOpen);
            }
...
<table style="width: 900px" class="PopTable">
    <tr>
    ...
    <tr>
        ...
        <td colspan="3">
            ...
            <asp:CheckBox ID="cbShowReader" runat="server" Text="瀏覽時顯示" meta:resourcekey="cbShowReaderResource1" />
    ...
    <tr>
        ...
        <td style="white-space: nowrap">
            ...
            <telerik:RadDatePicker ID="RadDatePublish" runat="server" Width="120px" meta:resourcekey="RadDatePublishResource1">
            ...
            <asp:CustomValidator ID="cvCheckPublicDate" runat="server" Display="Dynamic" ErrorMessage="上架時間需比現在晚，請重新選擇" ClientValidationFunction="cvCheckPublicDate" meta:resourcekey="cvCheckPublicDateResource1"></asp:CustomValidator>
        ...
        <td style="white-space: nowrap">
            ...
            <telerik:RadDatePicker ID="RadDateClose" runat="server" Width="120px" meta:resourcekey="RadDateCloseResource1">
                </telerik:RadDatePicker>
            ...
            <asp:CustomValidator ID="cvCheckOffDate" runat="server" Display="Dynamic" ErrorMessage="下架時間需比現在晚，請重新選擇" ClientValidationFunction="cvCheckOffDate" meta:resourcekey="cvCheckOffDateResource1"></asp:CustomValidator>
    ...
    <tr>
        ...
        <td colspan="3" style="vertical-align: baseline">
            <uc1:UC_HtmlEditor runat="server" ID="UC_HtmlEditor" Width="870px" BulletinSize="true" ModuleName="WKF" SubFolder="BULLETIN" />
            <asp:Panel ID="pnlContent" runat="server" ScrollBars="Auto" CssClass="editorcontentstyle JustAddBorder" meta:resourcekey="pnlContentResource1">
                <asp:Label runat="server" ID="lblHtmlEditor" meta:resourcekey="lblHtmlEditorResource1"></asp:Label>
            </asp:Panel>
    ...
    <tr>
        ...
        <td colspan="3">
            <table>
                <tr>
                    <td>
                        <asp:CheckBox ID="cbPublishExternal" runat="server" Text="同步複製到外部公告 (公告類別為內部公告方可啟用)" Enabled="False" meta:resourcekey="cbPublishExternalResource1" />
                ...
                <table class="PopTable" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td class="PopTableRightTD" runat="server" id="tdInernal3">
                            ...
                            <asp:CheckBox ID="cbShowExternalReader" runat="server" Text="瀏覽時顯示" meta:resourcekey="cbShowExternalReaderResource1" />
                    ...
                    <tr>
                        <td style="width: 100px;" class="PopTableLeftTD">
