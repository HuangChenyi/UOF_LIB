<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="EIP_Bulletin_WKFOptionalFields_SetupField_BulletinField" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" Codebehind="SetupField_BulletinField.aspx.cs" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <colgroup class="PopTableRightTD">	</colgroup>
    <tr>
        <td align="center" class="PopTableHeader" colspan="4"><asp:Label ID="lblSingleLine" runat="server" Text="公告審核欄位" meta:resourcekey="lblSingleLineResource1"></asp:Label></td>
    </tr>
    <tr>
