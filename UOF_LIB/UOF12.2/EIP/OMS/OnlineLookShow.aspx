   ...
   <div id="divplayer" runat="server">
	...
	<p>Your browser leaves much to be desired.</p>			
        ...
        <script>
           ...
           <center>
    <table id="divMovieeErr"><tr><td style="vertical-align:middle;"><asp:Label ID="lblShowMovieErr" Font-Bold="true" Font-Size="Large"  ForeColor="White" runat="server" Text="您所使用的瀏覽器無法觀看此影片，請使用其他瀏覽器觀看" 
    meta:resourcekey="lblShowMovieErrResource1"   ></asp:Label>
         <br /><center>
<asp:Image ID="Image1" ImageUrl="~/EIP/OMS/notplay.png" runat="server"></asp:Image> </center>
        </td></tr></table></center>
