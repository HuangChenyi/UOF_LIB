    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <Fast:Grid ID="listGrid" runat="server"
                ...
                DataKeyOnClientWithCheckBox="False" DefaultSortDirection="Descending" DefaultSortColumnName="OPEN_DATE"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="觀看次數" SortExpression="LOOK_COUNT" meta:resourcekey="TemplateFieldResource5">
                        <ItemTemplate>
                            <asp:LinkButton ID="lbtnLookCount" runat="server" Text='<%# Eval("LOOK_COUNT") %>' meta:resourcekey="lbtnLookCountResource1"></asp:LinkButton>
                        </ItemTemplate>
                        <HeaderStyle Wrap="False" />
