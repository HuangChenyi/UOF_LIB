    ...
    function RadToolBar1_ButtonClicking(sender, args) {
        ...
        switch (value) {
            ...
            case "ClassAuthMA":
                ...
                var classID = node.get_value();
                var className = node.get_text();
                $uof.dialog.open2("~/EIP/OMS/ClassAuthSetting.aspx", args.get_item(), "", 500, 500, OpenDialogResult, { "Classid": classID });                
                break;
        }
    }
    // -->
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <Fast:Grid ID="listGrid" runat="server" AllowSorting="True" AutoGenerateCheckBoxColumn="True"
                AutoGenerateColumns="False" AllowPaging="True" EnhancePager="True" DefaultSortColumnName="CREATE_DATE"
                DataKeyOnClientWithCheckBox="True"
                PageSize="15" Width="100%"
                OnPageIndexChanging="listGrid_PageIndexChanging" OnSorting="listGrid_Sorting"
                OnRowDataBound="listGrid_RowDataBound" DefaultSortDirection="Descending"
