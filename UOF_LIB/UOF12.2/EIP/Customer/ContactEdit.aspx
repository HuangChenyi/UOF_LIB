...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        ...
        function lbtnComAddress() {
            var CompanyAddress = $('#<%=lblCompanyAddress.ClientID %>').html();
        ...
        function lbtnInvoiceAddress() {
            var InvoiceAddress = $('#<%=lblInvoiceAddress.ClientID %>').html();
    var ContactAddress = $('#<%=txtAddr.ClientID %>');
    ContactAddress.val(InvoiceAddress);
}
//點選同公司電話1,複製到聯絡人電話
function lbtnTEL1() {
    var TEL1 = $('#<%=lblTEL1.ClientID %>').html();
...
//點選同公司電話2,複製到聯絡人電話
function lbtnTEL2() {
    var TEL2 = $('#<%=lblTEL2.ClientID %>').html();
    var TEL = $('#<%=txtTel.ClientID %>');
    TEL.val(TEL2);
}
            ...
            <table class="PopTable" cellspacing="1" style="width: 100%;">
                <tr>
                    ...
                    <td align="left" class="PopTableRightTD">
                        <telerik:RadDatePicker ID="rdDate" runat="server" Width="100px" SkinID="AllowEmpty">
                ...
                <tr>
                    ...
                    <td colspan="2" class="PopTableRightTD" align="left" style="width: 45%">
                        <asp:TextBox ID="txtEmail" runat="server" Width="100%" MaxLength="50"
                            meta:resourcekey="txtEmailResource1"></asp:TextBox></td>
                </tr>
                <tr>
                    <td align="right">
                        <asp:Label ID="Label9" runat="server" Text="電子郵件1" meta:resourcekey="Label9Resource1"></asp:Label></td>
                    <td colspan="2" style="width: 45%">
                        <asp:TextBox ID="txtEmail1" runat="server" Width="100%" MaxLength="50"
                            meta:resourcekey="txtEmail1Resource1"></asp:TextBox></td>
                    ...
                    <td colspan="2" class="PopTableRightTD" align="left" style="width: 45%">
                        <asp:TextBox ID="txtEmail2" runat="server" Width="100%" MaxLength="50"
                            meta:resourcekey="txtEmail2Resource1"></asp:TextBox></td>
                </tr>
                <tr>
                    <td align="right">
                ...
                <tr>
                    <td align="right">
                        <asp:Label ID="Label12" runat="server" Text="MSN" meta:resourcekey="Label12Resource1"></asp:Label></td>
                    <td colspan="2" style="width: 45%">
                        <asp:TextBox ID="txtMsn" runat="server" Width="100%" MaxLength="50"
