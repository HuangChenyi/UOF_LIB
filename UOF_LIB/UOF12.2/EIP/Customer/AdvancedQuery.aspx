...
<script id="igClientScript" type="text/javascript">
    function ibtnExport_Click(sender, args) {
        var CustID = $('#<%= HiddenField1.ClientID %>').val();//信息
        $uof.dialog.open2("~/EIP/Customer/AdvancedExportData.aspx", sender, "", 250, 200, OpenDialogResult, { "CustomerID": CustID });
    }
                ...
                <table width="100%" class="PopTable" cellspacing=1>
                    ...
                    <tr>
                        <td style="width:25%; text-align:left;" valign="top">  
                            <telerik:RadTreeView ID="rdtreeClass" Runat="server" Width="240px" CheckBoxes="True" Height="200px"></telerik:RadTreeView>                          
                        </td>
                        <td style="width:25%; text-align:left;" valign="top">  
                            <telerik:RadTreeView ID="rdtreeIndustry" Runat="server" Width="240px" CheckBoxes="True" Height="200px" ></telerik:RadTreeView>
                        </td>
                        <td style="width:20%; text-align:left;" valign="top">     
                            <telerik:RadTreeView ID="rdtreeGrade" Runat="server" Width="240px" CheckBoxes="True" Height="200px"></telerik:RadTreeView>
                        </td>
                        <td style="width:30%; text-align:left;" valign="top"> 
                            <telerik:RadTreeView ID="rdtreeArea" Runat="server" Width="250px" CheckBoxes="True" Height="200px"></telerik:RadTreeView>
                        </td>
                    </tr>
                </table>                           
                    ...
                    <tr>
                        <td colspan="3" style="text-align:left;">
                            <Fast:Grid ID="grd" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateCheckBoxColumn="False"
                                ...
                                <Columns>
                                    <asp:TemplateField HeaderText="客戶代號" meta:resourcekey="TemplateFieldResource1">
                                        <itemtemplate>
<asp:LinkButton runat="server" Text='<%# Eval("CUSTOMER_ID") %>' ID="lbtnCustomer" ></asp:LinkButton>
                                    ...
                                    <asp:BoundField DataField="CUSTOMER_NAME" HeaderText="客戶名稱" meta:resourcekey="BoundFieldResource1" >
                                        <headerstyle wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="GRADE_NAME" HeaderText="等級" meta:resourcekey="BoundFieldResource2" >
                                        <headerstyle wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="INDUSTRY_NAME" HeaderText="行業別" meta:resourcekey="BoundFieldResource3" >
                                        <headerstyle wrap="False" />
                                    </asp:BoundField>
                                    <asp:BoundField DataField="AREA_NAME" HeaderText="地區" meta:resourcekey="BoundFieldResource4" >
                                        <headerstyle wrap="False" />
                                    </asp:BoundField>
