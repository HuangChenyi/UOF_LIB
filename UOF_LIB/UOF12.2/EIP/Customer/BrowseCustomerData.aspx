                        ...
                        <tr>
                            ...
                            <td class="PopTableRightTD">
                                <asp:Panel ID="Panel1" runat="server" meta:resourcekey="Panel1Resource1">
                                    ...
                                    <telerik:RadTreeView runat="server" ID="rdtreeClass" Height="150px" Width="150px"></telerik:RadTreeView>
                                </asp:Panel>
                            ...
                            <td valign="top" class="PopTableRightTD">
                                <asp:Panel ID="Panel2" runat="server" meta:resourcekey="Panel2Resource1">
                                    <telerik:RadTreeView runat="server" ID="rdtreeArea" Height="150px" Width="150px"></telerik:RadTreeView>
                                </asp:Panel>
                            </td>
                            <td valign="top" class="PopTableLeftTD">
