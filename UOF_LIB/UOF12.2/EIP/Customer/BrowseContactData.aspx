        ...
        <ContentTemplate>
            <table class ="PopTable" cellspacing="1">
                <tr>
                    ...
                    <td align="left">
                        <asp:Label ID="lblName" runat="server" Width="150px" 
                            meta:resourcekey="lblNameResource1"></asp:Label></td>
                    <td align="right">
                    ...
                    <td align="left">
                        <asp:RadioButtonList ID="rbl" runat="server"  RepeatDirection="Horizontal" 
                            ...
                            <asp:ListItem Value="M" Selected="True" meta:resourcekey="ListItemResource1" 
                                Text="男"></asp:ListItem>
                ...
                <tr>
                    ...
                    <td colspan="2" align="left" style="width:45%">
                        <asp:Label ID="lblMsn" runat="server" meta:resourcekey="lblMsnResource1"></asp:Label></td>
                    <td align="right" class="PopTableLeftTD">
            ...
            <asp:Label ID="lblShowMessage" runat="server" 
                meta:resourcekey="lblShowMessageResource1"></asp:Label>
