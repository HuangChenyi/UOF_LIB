...
<asp:Content ID="Content3" ContentPlaceHolderID="LeftContentPlaceHolder" runat="Server">
    <asp:Label ID="lblLeftTitle" Text="主檔維護列表" Visible="false" runat="server"></asp:Label>
    ...
    <asp:UpdatePanel ID="UpdatePanelGrid" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:Panel ID="PanelGrid4" runat="server" Width="100%" Height="100%">
                <br />
                <telerik:RadTreeView ID="rdtreeArea" runat="server" Height="700px" Width="100%"></telerik:RadTreeView>
            </asp:Panel>
        </ContentTemplate>
        <%--                    <Triggers>
