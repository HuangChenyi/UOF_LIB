<%@ Page Language="C#" MasterPageFile="~/Master/TwoColumn.master" AutoEventWireup="true" Inherits="EIP_Customer_CustomerDataMaintain" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="CustomerDataMaintain.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="Server">
    <script type="text/javascript">
        function textboxblur() {
            button1 = $find("<%=rdbtnQuery.ClientID %>");
            button1.focus();
        }
        function EnterEvent(e) {
            if (e.keyCode == 13) {
                $("#<%=rdbtnQuery.ClientID%>").trigger("click");
            }
        }
            ...
            function RadToolBar1ButtonClicking(sender, args) {
                ...
                switch (key) {
                    case "btnAdd":
                        var oTabType = $('#<%= hiddenTabType.ClientID %>').val();
                        var oInsert = "Insert";
                    ...
                    case "btnSetting":
                        var CheckedData = $uof.fastGrid.getChecked('<%= grd.ClientID %>');
                        var choose = $('#<%= HiddenField1.ClientID %>').val();
                        if (CheckedData == "") {
                            alert(choose);
                            args.set_cancel(true);
                            return;
                    ...
                    case "btnImport":
                        args.set_cancel(true);
                        $uof.dialog.open2("~/EIP/Customer/ImportCustomerData.aspx", args.get_item(), "", 400, 250, OpenDialogResult, { "Mode": "Import" });
                        break;
                    case "btnExport":
                        args.set_cancel(true);
                    ...
                    case "btnPublish":
                        var CheckedData = $uof.fastGrid.getChecked('<%= grd.ClientID %>');
                        var choose = $('#<%= HiddenPublish.ClientID %>').val();//信息
                        if (CheckedData == "") {
                            alert(choose);
                            args.set_cancel(true);
                            return;
                            ...
                            if (!window.confirm($('#<%= hiddenConfirmPublish.ClientID %>').val())) {
                                args.set_cancel(true);
                            }
                        }
                        break;
                    case "btnAddUse":
                        var CheckedData = $uof.fastGrid.getChecked('<%= grd.ClientID %>');
                        var choose = $('#<%= hiddenUse.ClientID %>').val();//信息
                        if (CheckedData == "") {
                            alert(choose);
                            args.set_cancel(true);
                            return;
                    ...
                    case "btnCancelUse":
                        var CheckedData = $uof.fastGrid.getChecked('<%= grd.ClientID %>');
                        var choose = $('#<%= hiddenCancelUse.ClientID %>').val();//信息
                        if (CheckedData == "") {
                            alert(choose);
                            args.set_cancel(true);
                            return;
        ...
        <ContentTemplate>
            ...
            <telerik:RadMultiPage ID="rmp1" runat="server" SelectedIndex="1"  meta:resourcekey="rmp1Resource1" Style="text-align: left;">
                <telerik:RadPageView runat="server" ID="rpvTabUse" meta:resourcekey="rpvTabUseResource1">
                    <telerik:RadTreeView ID="rdCommonUsetree" runat="server" OnNodeClick="rdCommonUsetree_NodeClick" meta:resourcekey="rdCommonUsetreeResource1"></telerik:RadTreeView>
                ...
                <telerik:RadPageView runat="server" ID="rpvTabClass" meta:resourcekey="rpvTabClassResource1" Style="text-align: left;" Selected="True">
                    ...
                    <telerik:RadTreeView runat="server" ID="rdClasstree" OnNodeClick="rdClasstree_NodeClick" meta:resourcekey="rdClasstreeResource1"></telerik:RadTreeView>
                ...
                <telerik:RadPageView runat="server" ID="rpvTabIndustry" meta:resourcekey="rpvTabIndustryResource1" Style="text-align: left;">
                    ...
                    <telerik:RadTreeView runat="server" ID="industrytree" OnNodeClick="industrytree_NodeClick" meta:resourcekey="industrytreeResource1"></telerik:RadTreeView>
                ...
                <telerik:RadPageView runat="server" ID="rpvTabArea" meta:resourcekey="rpvTabAreaResource1">
                    ...
                    <telerik:RadTreeView runat="server" ID="areatree" OnNodeClick="areatree_NodeClick" meta:resourcekey="areatreeResource1"></telerik:RadTreeView>
            ...
            <ContentTemplate>
                <table class="PopTable" cellspacing="0" style="width: 100%">
                    <tr>
                        ...
                        <td style="word-wrap: break-word; width:25%">
                            <asp:Label ID="Label15" runat="server" Text="(客戶代號/客戶簡稱/名稱/統一編號/備註)關鍵字:" meta:resourcekey="Label15Resource1"></asp:Label></td>
                        <td>
                            <asp:TextBox ID="txtQuery" runat="server" Width="150px" onkeypress="return EnterEvent(event)" onblur="textboxblur()" meta:resourcekey="txtQueryResource1"></asp:TextBox></td>
                ...
                <Fast:Grid ID="grd" runat="server" AllowSorting="True" AutoGenerateCheckBoxColumn="True" AutoGenerateColumns="False" DataKeyNames="CUSTOMER_ID,CREATE_USER" DataKeyOnClientWithCheckBox="False" EnhancePager="True" PageSize="30" Width="100%" AllowPaging="True" OnRowDataBound="grd_RowDataBound"  DefaultSortDirection="Ascending" EmptyDataText="沒有資料" KeepSelectedRows="False" meta:resourcekey="grdResource2"  >
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="RM_ID" HeaderText="資料歸屬" meta:resourcekey="BoundFieldResource4">
                            <HeaderStyle Wrap="False" />
                        </asp:BoundField>
                        <asp:BoundField DataField="CONFIRM_PUBLISH" HeaderText="狀態" SortExpression="CONFIRM_PUBLISH"
