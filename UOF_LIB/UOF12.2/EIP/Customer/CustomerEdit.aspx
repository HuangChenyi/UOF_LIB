...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        function rdbtnSelectClass_OnClientClicked(sender, args) {
            var getclassID = $("#<%=hidClassID.ClientID %>").val();
        ...
        function checkCustData() {
            var hiddenflag = $('#<%=hiddenModify.ClientID %>').val();
...
function userToolBarButtonClicking(sender, args) {
    ...
    <script type="text/javascript">
        ...
        function getClassID() {
            return $("#<%=hidClassID.ClientID %>").val();
        }
                ...
                <ContentTemplate>
                    ...
                    <table cellspacing="1" class="PopTable" style="width: 100%">
                        ...
                        <tr>
                            ...
                            <td colspan="3">
                                <asp:TextBox ID="txtCusName" runat="server" MaxLength="255" meta:resourceKey="txtCusNameResource1" Width="360px"></asp:TextBox></td>
                            <td>
                        ...
                        <tr>
                            ...
                            <td valign="top">
                                <asp:Panel ID="Panel1" runat="server" meta:resourceKey="Panel1Resource1">
                                    ...
                                    <telerik:RadTreeView ID="classtree" runat="server" Height="100px" meta:resourcekey="classtreeResource1" Width="180px"></telerik:RadTreeView>
                                </asp:Panel>
                            </td>
                            <td valign="top">
                            ...
                            <td align="left" valign="top">
                                <asp:Panel ID="Panel2" runat="server" meta:resourceKey="Panel2Resource1">
                                    ...
                                    <telerik:RadTreeView ID="areatree" runat="server" Height="100px" meta:resourcekey="areatreeResource1" Width="180px"></telerik:RadTreeView>
                                </asp:Panel>
                            </td>
                            <td valign="top">
                        ...
                        <tr>
                            <td valign="top">
                                <asp:Label ID="Label32" runat="server" ForeColor="Red" meta:resourceKey="Label32Resource1" Text="*">

                                </asp:Label><asp:Label ID="Label24" runat="server" meta:resourceKey="Label24Resource1" Text="資料歸屬"></asp:Label></td>
                    ...
                    <asp:HiddenField ID="hidCustID" runat="server" Value=""></asp:HiddenField>
                </ContentTemplate>
            </asp:UpdatePanel>
        </telerik:RadPageView>
            ...
            <asp:UpdatePanel ID="UpdatePanel2" runat="server">
                <ContentTemplate>
                    <table style="width: 100%">
                        <tr>
                            <td>
                                <telerik:RadToolBar ID="userToolBar" runat="server" meta:resourcekey="userToolBarResource1" OnButtonClick="userToolBar_OnButtonClick" OnClientButtonClicking="userToolBarButtonClicking" Width="100%">
                                    <Items>
                                ...
                                <Fast:Grid ID="grd" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateCheckBoxColumn="True" AutoGenerateColumns="False"  DataKeyNames="CONTACT_ID" DataKeyOnClientWithCheckBox="True" DefaultSortDirection="Ascending" EmptyDataText="No data found" EnhancePager="True" KeepSelectedRows="False" meta:resourcekey="grdResource2" OnRowDataBound="grd_RowDataBound" PageSize="15"   Width="100%">
                                    ...
                                    <Columns>
                                        ...
                                        <asp:TemplateField HeaderText="電話" meta:resourceKey="TemplateFieldResource2">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="hlTEL" runat="server" meta:resourcekey="hlTELResource1" Text='<%# Eval("TEL") %>'></asp:HyperLink>
                                        ...
                                        <asp:TemplateField HeaderText="手機" meta:resourceKey="TemplateFieldResource3">
                                            <ItemTemplate>
                                                <asp:HyperLink ID="hlMobile" runat="server" meta:resourcekey="hlMobileResource1" Text='<%# Eval("MOBILE_PHONE") %>'></asp:HyperLink>
