<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="SetupField_BookingDetail.aspx.cs" 
    Inherits="WKF_OptionalFields_SetupField_BookingDetail" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <colgroup class="PopTableRightTD">	</colgroup>
    <tr>
        <td align="center" class="PopTableHeader" colspan="4"><asp:Label ID="lblSingleLine" runat="server" Text="借用明細" meta:resourcekey="lblSingleLineResource1"></asp:Label></td>
    </tr>
    <tr>
