...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <style>
        @import URL("./Common/superTables.css");
    </style>
    <script type="text/javascript" src="./Common/superTables.js"></script>
    <script type="text/javascript" src="./Common/jquery.superTable.js"></script>
    <script type="text/javascript">        
        Sys.Application.add_load(function () {
            ...
            if (pd) {
                $("#<%=hfborrowplant.ClientID%>").val($("#<%=Request["borrowPlants"]%>", pd).val());
            }
        });
        var plants = "";
        function addrow() {
        ...
        function BorrowPlant(startTime, endTime, detailGuid, plantGuid, selectingPlant) {
            if (imgClick == "") {
            ...
            <table>
                <tr>
                    <td style="vertical-align: top;">
                        <table width="984" height="690" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                                ...
                                                <table width="95%" border="0" style="text-align: center;" cellpadding="0" cellspacing="0">
                                                    ...
                                                    <tr>
                                                        <td style="text-align: left;">
                                                            <telerik:RadTreeView ID="treeEquipment" CheckBoxes="true" runat="server" OnNodeCheck="treeEquipment_NodeCheck" OnClientNodeChecked="treeEquipment_NodeChecked" OnClientNodeClicking="treeEquipment_NodeClicking" Width="200px" Height="550px"></telerik:RadTreeView>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </td>
                                ...
                                <td style="vertical-align: top;">
                                    <table width="750" border="0" cellpadding="0" cellspacing="0">
                                        ...
                                        <tr>
                                            <td height="25" style="background-image: url('<%=themePath%>/images/borrow_02.gif')" class="k">
                                                                            ...
                                                                            <td>
                                                                                <telerik:RadToolBar ID="RadToolBar1" runat="server" OnButtonClick="RadToolBar1_ButtonClick" Width="100%" meta:resourcekey="RadToolBar1Resource1">
                                                                                    <Items>
                                                                                        ...
                                                                                        <telerik:RadToolBarButton runat="server" Text="" meta:resourcekey="RadToolBarButtonResource3">
                                                                                        </telerik:RadToolBarButton>
                                                ...
                                                <asp:UpdatePanel ID="UpdatePanel3" runat="server" UpdateMode="Conditional">
                                                    <ContentTemplate>
                                                        <asp:Panel runat="server" ID="kk" Visible="False" meta:resourcekey="kkResource1">
                                                            <table width="750" border="0" cellpadding="0" cellspacing="0">
                                                                <tr>
                                                                    <td height="25" background="<%=themePath%>/images/borrow_03.gif" class="k">&nbsp;&nbsp;<asp:Label ID="Label1" runat="server" Text="目前借用記錄" meta:resourcekey="Label1Resource1"></asp:Label>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td>
