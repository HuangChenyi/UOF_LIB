...
<asp:Content ID="Content1" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            ...
            var Borrow_Guid = "<%=Request["BORROWGUID"]%>";
            var Owner_Guid = "<%=Request["OwnerGuid"]%>";
            var Plant_Guid = "<%=Request["PlantGuid"]%>";
...
<asp:Content ID="Content3" ContentPlaceHolderID="LeftContentPlaceHolder" runat="Server">
    <telerik:RadTreeView ID="treePlant" runat="server" OnNodeClick="treePlant_NodeClick" meta:resourcekey="treePlantResource2"></telerik:RadTreeView>
</asp:Content>
