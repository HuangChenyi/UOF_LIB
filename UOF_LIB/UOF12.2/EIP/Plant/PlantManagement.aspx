            ...
            switch (value) {
                ...
                case "CreatePlant":
                    ...
                    if (node == null) {
                       ...
                       "", 600, 700, OpenDialogResult, { ClassGuid: classID });
                    }
                    break;
...
<asp:Content ID="Content3" ContentPlaceHolderID="LeftContentPlaceHolder" runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanelTreeview" runat="server" UpdateMode="Conditional"
        ...
        <ContentTemplate>
            ...
            <telerik:RadTreeView ID="treeClass" runat="server" OnNodeClick="treeClass_NodeClick"></telerik:RadTreeView>
            <br />
    ...
    <asp:UpdatePanel ID="UpdatePanelGrid" runat="server" UpdateMode="Conditional">
        <ContentTemplate>
            ...
            <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" OldValuesParameterFormatString="original_{0}" 
                SelectMethod="GetAuthorityAllPlant" TypeName="Ede.Uof.EIP.Plant.ReadBorrowRecordUCO">
                <SelectParameters>
