<%@ Page Title="編輯SIP帳號" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="EIP_WebPhone_SIPAccountEdit" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" Codebehind="SIPAccountEdit.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <ContentTemplate>
            ...
            <table class="PopTable" cellspacing="1">
                <tr>
                    ...
                    <td>
                        <asp:TextBox ID="txtAccount" runat="server" Enabled="False" 
                            meta:resourcekey="txtAccountResource1"></asp:TextBox>
                        <asp:RequiredFieldValidator ID="rfvAccount" runat="server" ErrorMessage="帳號必須輸入" Display="Dynamic" 
                            ControlToValidate="txtAccount" ForeColor="Red" meta:resourcekey="rfvAccountResource1"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
                    <td><font color="red" >*</font>
                    ...
                    <td>
                        ...
                        <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ErrorMessage="密碼必須輸入" Display="Dynamic"
                            ControlToValidate="txtPWD" ForeColor="Red" meta:resourcekey="RequiredFieldValidator1Resource1"></asp:RequiredFieldValidator>
                    </td>
                </tr>
                <tr>
    ...
    <asp:Label ID="lblAccountExistError" runat="server" Text="帳號已存在" Visible="False" meta:resourcekey="lblAccountExistErrorResource1"></asp:Label>
    <asp:Label ID="lblOwnerMustSelect" runat="server" Text="私用帳號請指定擁有者" Visible="False" meta:resourcekey="lblOwnerMustSelectResource1"></asp:Label>
    <asp:Label ID="lblAccountError" runat="server" Text="帳號資料有問題，無法載入" Visible="False" meta:resourcekey="lblAccountErrorResource1"></asp:Label>
