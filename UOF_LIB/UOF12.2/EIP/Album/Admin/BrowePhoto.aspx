...
<asp:Content ID="Content1" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="Server">
    ...
    <script language="javascript" type="text/javascript">
        ...
        function MaintainPhoto(sender,albumGuid, photoGuid) {            
            $uof.dialog.open2("~/EIP/Album/Admin/UploadPhoto.aspx", sender, "", 550, 500, OpenDialogResult, { "AlbumGUID": albumGuid, "PhotoGUID": photoGuid });
            return false;
        }
        ...
        function RadToolBar1_ButtonClicking(sender, args) {
            ...
            switch (value) {
                ...
                case "AddPhoto":
                    ...
                    $uof.dialog.open2("~/EIP/Album/Admin/UploadPhoto.aspx", args.get_item(), "", 500, 500 , OpenDialogResult, {"AlbumGUID":AlbumGUID});
                    break;
                case "DeletePhoto":                    
