...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        function radToolBarClicking(sender, args) {
            ...
            switch (key) {
                case "Create":
                    ...
                    $uof.dialog.open2("~/EIP/Forum/CreateSubject.aspx", args.get_item(), "", 1024, 768, CreateResult, { "boardid": '<%=Request["boardid"] %>' });
                    break;
                case "Search":                    
                    ClearSiteMapNode();
                ...
                case "AdvanceSearch":
                    args.set_cancel(true);
                    $uof.dialog.open2("~/EIP/Forum/AdvanceSearch.aspx", args.get_item(), "", 700, 650, AdvanceSearchResult, { "boardid": '<%=Request["boardid"] %>' });
                break;
            case "ReturnForum":
                return;
                break;
    ...
    <table  style="height: auto;width:100%;"">
        <tr>
            <td style="height: 600px; max-height: inherit; vertical-align: top;">
