<%@ Control Language="C#" AutoEventWireup="true" Inherits="EIP_Forum_UC_MyRelyList" Codebehind="UC_MyRelyList.ascx.cs" %>
<%@ Register Assembly="Ede.Uof.Utility.Component.Grid" Namespace="Ede.Uof.Utility.Component" TagPrefix="Fast" %>
    <Fast:Grid ID="Grid2" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateCheckBoxColumn="True"
        ...
        OnRowDataBound="Grid2_RowDataBound"
          Width="100%" PageSize="30" DataKeyOnClientWithCheckBox="False">
        <Columns>
            ...
            <asp:BoundField DataField="REPLY_TIMES" HeaderText="回覆" SortExpression="REPLY_TIMES" meta:resourcekey="BoundFieldResource3" />
    ...
    <asp:ObjectDataSource ID="ObjectDataSource1" runat="server" SelectMethod="GetMyReplyTopic"
    ...
    <asp:Label ID="msgMyrely" runat="server" Text="我參與的" Visible="False" meta:resourcekey="msgMyrelyResource1"></asp:Label>
