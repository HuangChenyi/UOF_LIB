...
<asp:Content ID="Content4" ContentPlaceHolderID="RightContentPlaceHolder" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel4" runat="server">
        <ContentTemplate>
            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td width="80%" style="vertical-align: top; height: 100%;">
                        <telerik:RadTabStrip ID="rstTab" MultiPageID="rmp" runat="server"
                            ...
                            <Tabs>
                                ...
                                <telerik:RadTab runat="server" Value="WorkingTime"
    ...
    <asp:Label ID="lblTitle" Visible="false" runat="server" meta:resourcekey="Label1Resource1" Text="部門列表"></asp:Label>    
