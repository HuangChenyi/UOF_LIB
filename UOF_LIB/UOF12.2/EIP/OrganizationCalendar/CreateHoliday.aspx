            ...
            <table class="PopTable" cellspacing="0" width="100%">
                <tr>
                    ...
                    <td>
                        ...
                        <br />
                        <asp:Label ID="Label14" runat="server" Text="註：標題請勿使用特殊字元如&" CssClass="SizeMemo" meta:resourcekey="Label14Resource1"></asp:Label>
                        ...
                        <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="標題請勿使用特殊字元如& " ControlToValidate="txtSubject" meta:resourcekey="RegularExpressionValidator1Resource1"></asp:RegularExpressionValidator>
                    </td>
                </tr>
                <tr>
                    <td>
