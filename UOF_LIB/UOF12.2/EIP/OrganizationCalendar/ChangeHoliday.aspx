    ...
    <table class="PopTable" cellspacing="1" width="100%">
        <tr>
            ...
            <td>
                ...
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ErrorMessage="標題請勿使用特殊字元如& " ControlToValidate="txtSubject" Display="Dynamic" meta:resourcekey="RegularExpressionValidator1Resource1"></asp:RegularExpressionValidator>
            </td>
        </tr>
        <tr>
            <td>
