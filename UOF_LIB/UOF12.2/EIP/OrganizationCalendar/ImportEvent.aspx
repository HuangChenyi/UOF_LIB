<%@ Page Title="匯入事件" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="ImportEvent.aspx.cs" Inherits="EIP_OrganizationCalendar_ImportEvent" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <table class="PopTable" style="width: 100%;">
        <tr>
            <td style="width: 80px; white-space: nowrap;" class="PopTableLeftTD">
                <asp:Label ID="lblSelectFile" runat="server" Text="選擇檔案" meta:resourcekey="lblSelectFileResource1"></asp:Label>
            </td>
            <td class="PopTableRightTD" style="width: 80%">
                ...
                <asp:HyperLink ID="hlSample" Text="下載Excel範例"
                    NavigateUrl="~/EIP/OrganizationCalendar/Import_Event_Sample.xls"
        ...
        <tr>
            <td colspan="2" style="vertical-align: top;" class="PopTableRightTD">
                <asp:TextBox ID="txtErrorMsg" Width="100%" Rows="8" TextMode="MultiLine" ReadOnly="True" runat="server" meta:resourcekey="txtErrorMsgResource1"></asp:TextBox>
            </td>
        </tr>
    </table>
