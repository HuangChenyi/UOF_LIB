    ...
    <script type="text/javascript">
        ...
        function RadToolBar1_OnClientButtonClicking(sender, args) {
              if (args.get_item().get_value() === "createArticle") {
                  ...
                  $uof.dialog.open2('~/EIP/Calendar/DevolveForum/CreateArticle.aspx', args.get_item(), '<%=lblCreateTitle.Text%>', 900, 720, openDialogResult, { "devolveGuid": "<%=Request["devolveGuid"]%>"});
              }
          }
