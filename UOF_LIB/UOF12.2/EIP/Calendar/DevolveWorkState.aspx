...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" Width="100%">
        <telerik:RadPageView ID="pageView1" runat="server">
                        ...
                        <fieldset style="padding: 2;">
                            ...
                            <Ede:Grid ID="Grid1" runat="server" AllowSorting="True" AutoGenerateCheckBoxColumn="False"
                                ...
                                <Columns>
                                    ...
                                    <asp:BoundField DataField="PROCEEDING_DESC" HeaderText="進行中說明"
                                        SortExpression="PROCEEDING_DESC" meta:resourcekey="BoundFieldResource4">
                                    ...
                                    <asp:BoundField DataField="COMPLETE_DESC" HeaderText="完成說明"
                                        SortExpression="COMPLETE_DESC" meta:resourcekey="BoundFieldResource5">
                                        <HeaderStyle Width="120px" Wrap="false"/>
                                    </asp:BoundField>
            ...
            <input id="hideState" type="hidden" runat="server" value="False" />
            <br />
            <br />
            <table style="width: 100%;">
                <tr>
