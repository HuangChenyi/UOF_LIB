        ...
        <tr>
            <td valign="top" style="width:50%">
                 <table class="PopTable" cellspacing="1" width="100%">
                    ...
                    <tr>
                        <td >
                            <asp:Label ID="Label3" runat="server" Text="建立人員" meta:resourcekey="Label3Resource1"></asp:Label></td>
                        <td>
                            <asp:Label ID="lbCreator" runat="server" meta:resourcekey="lbCreatorResource1"></asp:Label></td>
                    </tr>
                </table>
            </td>
            <td style="width:45%; vertical-align:top;" >
                 <table class="PopTable" cellspacing="1" width="100%">
                    ...
                    <tr>
                        <td>
                            <asp:Label ID="lblDirectorTitle" runat="server" Text="交辦人" meta:resourcekye="lblDirectorTitleResource1"></asp:Label>
                        </td>
                        <td>
