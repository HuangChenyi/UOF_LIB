<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="EIP_Calendar_ReminderDetail" Title="修改備忘" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="ReminderDetail.aspx.cs" %>
     ...
     <table class="PopTable" cellspacing="0" style="width:100%; border-spacing:1px;">
        ...
        <tr>
            ...
            <td>
                ...
                <asp:CustomValidator ID="CustomValidator4" runat="server" Display="Dynamic" ErrorMessage="結束時間需晚於開始時間" OnServerValidate="CustomValidator4_ServerValidate" meta:resourcekey="CustomValidator4Resource1"></asp:CustomValidator>
        ...
        <tr>
            ...
            <td>
                <asp:Label ID="lblCreateUser" runat="server" Text="Label" meta:resourcekey="lblCreateUserResource1"></asp:Label></td>
        </tr>
    </table>
