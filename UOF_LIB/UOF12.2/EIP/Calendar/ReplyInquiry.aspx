                    ...
                    <tr>
                        <td valign="top" style="width: 45%">
                            <table class="PopTable" cellspacing="1" width="100%">
                                ...
                                <tr>
                                    <td style="white-space:nowrap;">
                                        <span style="color: #ff0000">*</span><asp:Label ID="Label7" runat="server" Text="徵詢載止時間" meta:resourcekey="Label7Resource2" ></asp:Label>
                                    </td>
                                    <td>
                                        ...
                                        <asp:CustomValidator ID="CustomValidator5" runat="server" Display="Dynamic" ErrorMessage="請填入徵詢載止時間" meta:resourcekey="CustomValidator5Resource2" ></asp:CustomValidator>
                                    </td>
                                </tr>                                                        
                                <tr>
                                    <td>
