...
<script type="text/javascript" id="telerikClientEvents1">
	...
	{
	    var UserGuid = $('#ctl00_ctl00_ContentPlaceHolder1_MainContentPlaceHolder_lbOwnerGuid').val();
	    ...
	    {	    
	        $uof.dialog.open2("~/EIP/Calendar/CreateMoreMeeting.aspx",args, "",600,700,openDialogResult,{"OwnerGuid": UserGuid, "Date": date });
	    }
	    ...
	    {	   
	        $uof.dialog.open2("~/EIP/Calendar/CreateReminder.aspx",args, "",600,500,openDialogResult,{"OwnerGuid": UserGuid, "Date": date});
	    }	
	    ...
	    {	   
	        $uof.dialog.open2("~/EIP/Calendar/CreateHoliday.aspx",args, "",600,400,openDialogResult,{"OwnerGuid": UserGuid, "Date": date});       
	    }	
	    else if(Key=='CreateDevolve')
	    {	   
	        $uof.dialog.open2("~/EIP/Calendar/CreateDevolve.aspx",args, "",460,520,openDialogResult,{"OwnerGuid": UserGuid, "Date": date});
	    }		
	    else
	    {
    ...
    function SetOtherOwner(userGuid)
    {
        ...
        $('#ctl00_ctl00_ContentPlaceHolder1_MainContentPlaceHolder_lbOwnerGuid').val(userGuid);
    }
    ...
    function SetManyOthers()
    {
        ...
        $('#ctl00_ctl00_ContentPlaceHolder1_MainContentPlaceHolder_lbOwnerGuid').val('');
...
<input id="hideCustTypes" runat="server" type="hidden" />