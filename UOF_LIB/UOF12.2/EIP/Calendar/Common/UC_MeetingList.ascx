...
<script id="MeetingListjs" type="text/javascript">
    ...
    function bar2_Click(sender, args) {
        ...
        if (Key == "delete") {
            ...
            $uof.dialog.open2("~/EIP/Calendar/CreateMoreMeeting.aspx", args.get_item(), "", 600, 700, openDialogResult, { "OwnerGuid": UserGuid, "Date": date });
        }
        else if (Key == "Export") {
                                ...
                                <telerik:RadSplitter ID="Radsplitter90" runat="server" Orientation="Horizontal" PanesBorderSize="0" Height="100%"
                                    ...
                                    <telerik:RadPane ID="Radpane1" runat="server" Index="0" meta:resourcekey="Radpane1Resource1">
                                        <Fast:Grid ID="gridOtherMeeting" runat="server" AllowSorting="True" AutoGenerateCheckBoxColumn="True"
                                            ...
                                            KeepSelectedRows="False"  meta:resourcekey="gridOtherMeetingResource3"  >
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="CREATE_USER" HeaderText="召集人" SortExpression="CREATE_USER" meta:resourcekey="BoundFieldResource11">
                                                    <HeaderStyle Width="150px" />
                                                    <ItemStyle Width="150px" />
                                                </asp:BoundField>
                                                <asp:BoundField HeaderText="狀態" DataField="REPLY_STATE" SortExpression="REPLY_STATE" meta:resourcekey="BoundFieldResource12">
...
<input id="hideMeetingIDs" type="hidden" runat="server" value="" />
