...
<%@ Register Src="UC_ScheduleTypeList.ascx" TagName="UC_ScheduleTypeList" TagPrefix="uc1" %>
                    ...
                    <tr>
                        <td style="width: 33%">
                            <table>
                                <tr>
                                    <td>
                                        <uc1:UC_ScheduleTypeList ID="UC_ScheduleTypeList1" runat="server" Visible="False" />
                                    </td>
...
<input id="hideCustTypes" type="hidden" runat="server" />
<input id="hideFirstDay" type="hidden" runat="server" />
<input id="hideTotalDays" type="hidden" runat="server" />
