        ...
        <tr>
            ...
            <td>
                <table>
                    <tr>
                        <td colspan="2" >
                            <asp:RadioButton ID="rbForever" runat="server" GroupName="repeat" Text="不結束" meta:resourcekey="rbForeverResource1" /></td>
                    </tr>
                    <tr>
                        <td>
                            <asp:RadioButton ID="rbToEnd" runat="server" GroupName="repeat" Text="重覆至" meta:resourcekey="rbToEndResource1" /></td>
