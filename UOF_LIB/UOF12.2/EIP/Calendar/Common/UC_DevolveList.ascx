...
<script id="DevolveListjs" type="text/javascript">
    function barDevolve_Click(sender, args) {
        ...
        if (Key == "Create") {
            ...
            if (MeetingGuid !== '')
                $uof.dialog.open2("~/EIP/Calendar/CreateDevolve.aspx", args.get_item(), "", 460, 520, openDialogResult, { "MeetingGuid": MeetingGuid, "OwnerGuid": OwnerGuid, "Date": date });
            else
                $uof.dialog.open2("~/EIP/Calendar/CreateDevolve.aspx", args.get_item(), "", 460, 520, openDialogResult, { "OwnerGuid": OwnerGuid, 'Date': date });
        }
        else if (Key == "Delete") {
            ...
            <telerik:RadPane ID="devRadpane2" runat="server" Index="2" meta:resourcekey="devRadpane2Resource1">
                <telerik:RadSplitter ID="devRadsplitter4" runat="server" Width="100%" Height="100%" Orientation="Horizontal"
                                    ...
                                    <ItemTemplate>
                                        <table>
                                            <tr>
                                                ...
                                                <td>
                                                    <telerik:RadDatePicker ID="rdpDateStart" runat="server" Culture="zh-TW" meta:resourcekey="rdpDateStartResource1">
                    ...
                    <telerik:RadPane ID="devRadpane3" runat="server" Index="1" meta:resourcekey="devRadpane3Resource1">
                        ...
                        <input id="hideIsEditable" type="hidden" runat="server" value="false" />
                       
                        

&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                        <input id="hideShowSchClass" runat="server" type="hidden" value="True" />
