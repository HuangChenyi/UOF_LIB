...
<input id="hideSchType"  type="hidden" runat="server" />
<input id="hideGridServerID" type="hidden" runat="server" />
<input id="hideClassGUID" type="hidden" runat="server" />
<input id="hideIsPostBack" type="hidden" runat="server" />
<input id="hideEditable" type="hidden" runat="server" />--%>
