...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            $.ajax({
                ...
                error: function (XMLHttpRequest, textStatus) {
                    if (textStatus === "timeout") {
                        ...
                        labHelp.html("<font color='red'>" + "<%=lblTimeOut.Text %>" + "</font>");
    ...
    if (pd) {
        meetingIDs = $("#<%=Request["hideClientID"]%>", curwindow).val();
    }
    ...
    var data = [userID, meetingIDs, lblAll, lblChair, lblRealAttend, lblSubject, lblLocation, lblDescription, lblStart, lblEnd, lblCreateUser, lblMinute, lblDecision, lblDevolve2, lblDevolve, lblAssignTo, lblStatus, lblComplete, lblUnfinish];
    ...
    var labHelp = $("#<%=labHelp.ClientID%>");
        ...
        if (fileID != null && fileID != "") {
            labHelp.html("<font color='blue'>" + "<%=lblSuccess.Text %>" + "</font>");
    }
    else
        labHelp.html("<font color='red'>" + "<%=lblError.Text %>" + "</font>");
});
