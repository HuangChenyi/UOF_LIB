...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <input id="hideCancel" runat="server" type="hidden" /><br />
    ...
    <script>
        ...
        function NewDevolveClick()
        {
            ...
            if (lblStartTime == "") {
                ...
                var startTime = $find("<%= rtpTimeStart.ClientID %>").get_selectedDate();
                ...
                var endTime = $find("<%= rtpTimeEnd.ClientID %>").get_selectedDate();
            ...
            $uof.dialog.open2("~/EIP/Calendar/CreateDevolve.aspx", "", "", 460, 520, function (returnValue) { return true; },
                {
                    "OwnerGuid": ownerGuid,
                    "Date": date,
