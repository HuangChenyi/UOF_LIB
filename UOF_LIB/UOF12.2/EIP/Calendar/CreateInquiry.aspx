                            ...
                            <tr>
                                <td style="white-space: nowrap;">
                                    <span style="color: #ff0000">*</span><asp:Label ID="Label7" runat="server"
                                        Text="徵詢載止時間" meta:resourcekey="Label7Resource2"></asp:Label></td>
                                <td>
                                    <table>
                                        <tr>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:CustomValidator ID="CustomValidator5" runat="server" Display="Dynamic"
                                                    ErrorMessage="請填入徵詢載止時間" meta:resourcekey="CustomValidator5Resource2">
                                                </asp:CustomValidator>
                                                <asp:CustomValidator ID="CustomValidator8" runat="server" Display="Dynamic"
                                                    ErrorMessage="徵詢載止時間不可晚於最早預計召開時間" meta:resourcekey="CustomValidator8Resource1">
                                                </asp:CustomValidator>
                                            </td>
