...
<ExportExcelSettings AllowExportToExcel="False"></ExportExcelSettings>
                <Columns>
                    <%--<asp:BoundField DataField="SLOGAN_CONTENT" HeaderText="語錄" HtmlEncode="False"  ItemStyle-CssClass="JustAddBorder"
                        meta:resourcekey="BoundFieldResource1" ItemStyle-BorderStyle="None" />--%>
    ...
    <tr>
        <td style="width:100%;text-align:right">
            <telerik:RadButton ID="rdbtnPlay" runat="server" Visible="false"  >
