<%@ Control Language="C#" AutoEventWireup="true" Inherits="EIP_Forecast_UC_DailyForecast" CodeBehind="UC_DailyForecast.ascx.cs" %>
                        ...
                        <tr>
                            ...
                            <td>
                                 <asp:DropDownList ID="ddlDailyArea" runat="server"
                                    ...
                                    <asp:ListItem Text="桃園縣" Value="36_05.xml" meta:resourcekey="ListItemResource5"></asp:ListItem>
                ...
                <table style="vertical-align:middle" width="100%">
                    <tr id="header" runat="server" style="background-color:White; border-bottom-width:thin; border-bottom-style:solid">
                        ...
                        <td style="width:15%" runat="server">
                            <asp:Label ID="Label4" runat="server" Text="降雨機率" meta:resourcekey="Label4Resource1"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td style="width:15%">
                            <asp:Label ID="lblRain" runat="server" meta:resourcekey="lblRainResource1"></asp:Label>
                        </td>
                    </tr>
                </table>
            </ItemTemplate>
