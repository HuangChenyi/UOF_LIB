                ...
                <asp:UpdatePanel ID="UpdatePanel3" runat="server">
                    <ContentTemplate>
                        ...
                        <Ede:Grid ID="grdLeave" runat="server" AutoGenerateCheckBoxColumn="False" AutoGenerateColumns="False" Width="100%" PageSize="10"
                            ...
                            DefaultSortColumnName="APPLICANT_GROUP_ID_NAME" OnSorting="grdLeave_Sorting" meta:resourcekey="grdLeaveResource1">
                            ...
                            <Columns>
                                <asp:BoundField HeaderText="部門" DataField="APPLICANT_GROUP_ID_NAME" SortExpression="APPLICANT_GROUP_ID_NAME" meta:resourcekey="BoundFieldResource2"  ItemStyle-Wrap="false"/>
                                <asp:BoundField HeaderText="姓名" DataField="APPLICANT_NAME" SortExpression="APPLICANT_NAME" meta:resourcekey="TemplateFieldResource1" ItemStyle-Wrap="false"/>
