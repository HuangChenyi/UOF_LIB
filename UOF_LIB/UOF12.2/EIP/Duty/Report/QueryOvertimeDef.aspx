            ...
            <div style="margin-top: 2px;">
                <Fast:Grid ID="grdLeave" runat="server" AutoGenerateCheckBoxColumn="False"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="APPLICANT_NAME" HeaderText="姓名" AccessibleHeaderText="APPLICANT_NAME"
                            SortExpression="APPLICANT_NAME" meta:resourcekey="BoundFieldResource1" HeaderStyle-Wrap="false" >
                        <HeaderStyle Wrap="False" />
