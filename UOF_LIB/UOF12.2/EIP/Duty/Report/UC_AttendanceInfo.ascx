...
<script>
    ...
    function OpenDetailDialog(applicant, selectdate) {
        $uof.dialog.open2("~/EIP/Duty/Report/AttendanceDetail.aspx", "", '<%=lblPersonalTitle.Text%>', 1300, 700, function (returnValue) { return false; }, { APPLICANT: applicant, DATE: selectdate });
        return false; 
    }
</script>
