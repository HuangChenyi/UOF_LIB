...
<asp:Content ID="Content3" ContentPlaceHolderID="LeftContentPlaceHolder" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <uc1:UC_DeptManagerTree ID="UC_DeptManagerTree1" runat="server" ShowDeptManagerTree="True" ShowDeptPersonalTree="True" ShowSuperiorTree="True" />
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
        ...
        <ContentTemplate>
            ...
            <table class="PopTable" style="width: 100%">
                <tr>
                    ...
                    <td style="width: 30%">
                        <telerik:RadDatePicker ID="rdTravelDateStart" runat="server" Culture="zh-TW" meta:resourcekey="rdTravelDateStartResource1">
                    ...
                    <td style="width: 30%">
                        <telerik:RadDatePicker ID="rdTravelDateEnd" runat="server" Culture="zh-TW" meta:resourcekey="rdTravelDateEndResource1">
                            <Calendar UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False" Culture="zh-TW" EnableWeekends="True" FastNavigationNextText="&amp;lt;&amp;lt;">
                            </Calendar>
                            <DateInput LabelWidth="40%" DateFormat="yyyy/M/d" DisplayDateFormat="yyyy/M/d" Width="">
                                <ClientEvents OnValueChanging="OnValueChanging" />
            ...
            <div style="margin-top: 2px;">
                <Fast:Grid ID="TravelGrid" runat="server" AutoGenerateCheckBoxColumn="False" Width="100%"
                    ...
                    <Columns>
                        ...
                        <asp:BoundField DataField="APPLICANT_NAME" HeaderText="出差人員" SortExpression="APPLICANT_NAME"
