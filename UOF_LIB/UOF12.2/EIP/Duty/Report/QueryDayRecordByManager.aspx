...
<asp:Content ID="Content3" ContentPlaceHolderID="LeftContentPlaceHolder" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional" RenderMode="Inline">
        <ContentTemplate>
            <uc1:UC_DeptManagerTree ID="UC_DeptManagerTree1" runat="server" ShowDeptManagerTree="True" ShowSuperiorTree="True" />
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
                ...
                <telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%" OnButtonClick="RadToolBar1_OnButtonClick" meta:resourcekey="RadToolBar1Resource1" SingleClick="None">
                    <Items>
                        ...
                        <telerik:RadToolBarButton runat="server" Value="startdate" meta:resourcekey="RadToolBarButtonResource2">
                            <ItemTemplate>
                                <telerik:RadDatePicker ID="rdStartDate" runat="server" Culture="zh-TW" meta:resourcekey="rdStartDateResource1">
