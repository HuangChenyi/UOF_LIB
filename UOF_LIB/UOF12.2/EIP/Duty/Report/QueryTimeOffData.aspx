...
<asp:Content ID="Content3" ContentPlaceHolderID="LeftContentPlaceHolder" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline" UpdateMode="Conditional">
        <ContentTemplate>
            <uc1:UC_DeptManagerTree ID="UC_DeptManagerTree1" runat="server" ShowSuperiorTree="true" ShowDeptPersonalTree="true" ShowDeptManagerTree="true" />               
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
        ...
        <tr>
            <td>
                ...
                <table class="PopTable" style="width:100%">
                    <tr>
                        <td style="width:20%">
                            <asp:Label ID="Label3" runat="server" Text="日期" meta:resourcekey="Label3Resource1"></asp:Label>
                        </td>
                        <td style="width:30%">
                            <telerik:RadDatePicker ID="rdStartDate" runat="server">
                                ...
                                <DateInput LabelWidth="40%" ClientEvents-OnValueChanging="OnValueChanging" runat="server"></DateInput>
