...
<asp:Content ID="Content3" ContentPlaceHolderID="LeftContentPlaceHolder" runat="server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline" UpdateMode="Conditional">
        <ContentTemplate>
            <uc1:UC_DeptManagerTree ID="UC_DeptManagerTree1" runat="server" ShowSuperiorTree="true" ShowDeptManagerTree="true" />
                        ...
                        <Fast:Grid ID="Grid1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateCheckBoxColumn="False"
                            ...
                            <Columns>
                                <asp:TemplateField HeaderText="帳號" SortExpression="ACCOUNT" meta:resourcekey="TemplateFieldResource1">
                                    ...
                                    <ItemTemplate>
                                        <asp:LinkButton ID="lbtnUserAccount" runat="server" Text='<%# Bind("ACCOUNT") %>'
                                            meta:resourcekey="lbtnUserAccountResource1"></asp:LinkButton>
                                    </ItemTemplate>
                                    <HeaderStyle Width="200px" Wrap="False" />
                                    <ItemStyle HorizontalAlign="Left" Width="200px" />
                                </asp:TemplateField>
                                <asp:BoundField HeaderText="姓名" DataField="NAME" SortExpression="NAME" meta:resourcekey="BoundFieldResource1">
                                    <HeaderStyle Width="200px" Wrap="False" />
                                    <ItemStyle HorizontalAlign="Left" Width="200px" />
                                </asp:BoundField>
