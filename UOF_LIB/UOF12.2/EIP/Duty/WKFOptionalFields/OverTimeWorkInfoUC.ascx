...
<script type="text/javascript">
    ...
    function OpenDialog(sender) {
        ...
        $uof.dialog.open2("~/EIP/Duty/WKFOptionalFields/ErrorInfo.aspx", sender, '', 400, 600,
            function () { return false }, { "StartDate": startDate, "Users": users, "BelongDate": belnogDate, "EndDate": endDate, "TaskId": taskId, "HolidayType": holidayType });
    }
    ...
    <tr>
        ...
        <td>
            <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                <ContentTemplate>
                    <asp:Label ID="lblMoreThanLawHoursMsg" runat="server" Visible="false" ForeColor="Blue" Text="{0}員工每日/每月加班總時數不得超過{1}，此員工{2}累積加班已達{3}(含本次)。<br>" meta:resourcekey="lblMoreThanLawHoursMsgResource1"></asp:Label>
                    <asp:Label ID="lbltempMsg" runat="server" Visible="false" ForeColor="Blue" Text="{0}員工每日/每月加班總時數不得超過{1}，此員工{2}累積加班已達{3}(含本次)。<br>" meta:resourcekey="lblMoreThanLawHoursMsgResource1"></asp:Label>
                    ...
                    <table class="PopTable" style="width: 800px">
                        ...
                        <tr>
                            ...
                            <td class="PopTableRightTD">
                                <asp:Label ID="lblActWorkHours" runat="server" 
                                    meta:resourcekey="lblActWorkHoursResource1" ></asp:Label>
                        ...
                        <tr>
                            ...
                            <td class="PopTableRightTD">
                                ...
                                <asp:Label ID="lblWorkType" runat="server" meta:resourcekey="lblWorkTypeResource1"></asp:Label>
                            </td>
                            <td class="popTableLeftTD" style="white-space: nowrap">
                            ...
                            <td class="PopTableRightTD">
                                ...
                                <asp:Label ID="lblChangeType" runat="server" Visible="false" meta:resourcekey="lblChangeTypeResource1"></asp:Label>
                    ...
                    <table cellpadding="0" cellspacing="0">
                        ...
                        <tr>
                            <td>
                                <asp:CustomValidator ID="cvSingleHolidayType" runat="server"
                                    ErrorMessage="請設定加班類型" Display="Dynamic"
                                    ClientValidationFunction="CheckSingleHolidayType" 
                                    meta:resourcekey="cvCheckSingleHolidayTypeResource1"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:CustomValidator ID="cvCheckActHours" runat="server"
                                    ErrorMessage="核銷時數不可為0或空白(請記得按下計算按鈕)" Display="Dynamic"
                                    ClientValidationFunction="CheckActHours" 
                                    meta:resourcekey="cvCheckActHoursResource1"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                        ...
                        <tr>
                            <td>
                                <asp:CustomValidator ID="cvAllowOverTime" runat="server"
                                    ErrorMessage="此加班類型不允許加班" Display="Dynamic"
                                    ClientValidationFunction="CheckAllowOverTime" 
                                    meta:resourcekey="cvAllowOverTimeResource1"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:CustomValidator ID="cvSameSetupHours" runat="server"
                                    ErrorMessage="加班人員使用的加班時數算法需為相同" Display="Dynamic"
                                    ClientValidationFunction="CheckSameSetupHours" 
                                    meta:resourcekey="cvSameSetupHoursResource1"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:CustomValidator ID="cvCheckHolidayType" runat="server"
                                    ErrorMessage="加班人員須為相同加班類型" Display="Dynamic"
                                    ClientValidationFunction="CheckHolidayType" 
                                    meta:resourcekey="cvCheckHolidayTypeResource1"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:CustomValidator ID="cvSameChangeType" runat="server"
                                    ErrorMessage="加班人員須為相同給付方式" Display="Dynamic"
                                    ClientValidationFunction="CheckSameChangeType" 
                                    meta:resourcekey="cvChangeTypeResource1"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
                                <asp:CustomValidator ID="cvChangeType" runat="server"
                                    ErrorMessage="請選擇給付方式" Display="Dynamic"
                                    ClientValidationFunction="CheckChangeType"
                                    meta:resourcekey="rfChangeTypeResource1"></asp:CustomValidator>
                            </td>
                        </tr>
                        <tr>
                            <td>
