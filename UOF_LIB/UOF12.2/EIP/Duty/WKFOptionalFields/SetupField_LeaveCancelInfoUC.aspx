<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKFOptionalFields_SetupField_LeaveCancelInfoUC" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="SetupField_LeaveCancelInfoUC.aspx.cs" %>
...
<asp:CustomValidator ID="cvCancelLeaveV1NotSuport" runat="server" ErrorMessage="此版的銷假資訊已不支援使用，如要申請，請選擇V2版本。" Display="Dynamic"
    ...
    <tr>
        <td align="center" class="PopTableHeader" colspan="4">
            <div style=" text-align:center;">
                <asp:Label ID="lblSingleLine" runat="server" Text="銷假資訊" 
