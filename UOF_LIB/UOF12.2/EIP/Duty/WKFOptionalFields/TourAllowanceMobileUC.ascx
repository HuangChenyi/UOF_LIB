<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="TourAllowanceUC.ascx.cs" Inherits="WKF_OptionalFields_TourAllowanceUC" %>
...
<script type="text/javascript">
    function wneUsedAmount_ValueChange(oEdit, oldValue, oEvent) {
        ...
        var temp = "ctl00_ContentPlaceHolder1_UC_MobileVersionFieldCollectionUsing_versionFieldUC{0}_Grid1_ctl{1}_rdNumUsedAmount";
        var total = 0;
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table style="width: 97%">
            <tr>
                <td>
                    <asp:Label ID="lblNotSupport" runat="server" Text="行動裝置目前不支援申請/編輯" Visible="False" ForeColor="Red" meta:resourcekey="lblNotSupportResource1"></asp:Label>
                    <asp:CustomValidator ID="cvCheckSupportMobile" runat="server" ForeColor="Red" ErrorMessage="行動裝置目前不支援申請/編輯" Display="Dynamic"
            ...
            <tr>
                <td style="padding-left:17px; padding-top:5px">
                    <asp:Label ID="Label1" runat="server" Text="申請年度" meta:resourcekey="Label1Resource1"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="padding-left:17px">
                    <asp:Label ID="lblApplyYear" runat="server" meta:resourcekey="lblApplyYearResource1"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="padding-left:17px; padding-top:15px">
                    <asp:Label ID="Label2" runat="server" Text="參加人員" meta:resourcekey="Label2Resource1"></asp:Label>
                </td>
            </tr>
            <tr>
            ...
            <tr>
                <td style="padding-left:17px">
                    <asp:CustomValidator ID="cvMustHaveDetail" runat="server" ErrorMessage="至少須新增一筆以上的明細!" Display="Dynamic" ForeColor="Red" EnableTheming="true"
                        ClientValidationFunction="CheckMustHaveDetail" meta:resourcekey="cvMustHaveDetailResource1"></asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td style="padding-left:19px">
                    <Fast:Grid ID="Grid1" runat="server" AutoGenerateCheckBoxColumn="False" AllowSorting="True" AutoGenerateColumns="False"
                        ...
                        OnRowCommand="Grid1_RowCommand" OnRowDataBound="Grid1_RowDataBound" OnRowDeleting="Grid1_RowDeleting" meta:resourcekey="Grid1Resource1">
                        ...
                        <Columns>
                            ...
                            <asp:BoundField HeaderText="員工" DataField="NAME" meta:resourcekey="BoundFieldResource2">
                                <HeaderStyle Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="職級" DataField="JOB_TITLE" meta:resourcekey="BoundFieldResource3">
                                <HeaderStyle Wrap="False" />
                            </asp:BoundField>
                            <asp:BoundField HeaderText="可補助金額" DataField="TOTAL_AMOUNT" DataFormatString="{0:#,0}" meta:resourcekey="BoundFieldResource4">
                                <HeaderStyle Wrap="False" />
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:BoundField>
                            <asp:TemplateField HeaderText="實際使用金額" meta:resourcekey="TemplateFieldResource2">
                                <ItemTemplate>
                                    ...
                                    <asp:Label ID="lblUsedAmount" runat="server" meta:resourcekey="lblUsedAmountResource1"></asp:Label>
                                </ItemTemplate>
                                <HeaderStyle Wrap="False" />
                                <ItemStyle HorizontalAlign="Right" />
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="公司補助金額" Visible="False" meta:resourcekey="TemplateFieldResource3">
                                <ItemTemplate>
                                    <asp:Label ID="lblConpanyAmount" runat="server" Text='<%# Bind("COMPANY_AMOUNT") %>' meta:resourcekey="lblConpanyAmountResource1"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                            <asp:TemplateField HeaderText="福委補助金額" Visible="False" meta:resourcekey="TemplateFieldResource4">
                                <ItemTemplate>
                                    <asp:Label ID="lblCommitteeAmount" runat="server" Text='<%# Bind("COMMITTEE_AMOUNT") %>' meta:resourcekey="lblCommitteeAmountResource1"></asp:Label>
                                </ItemTemplate>
                            </asp:TemplateField>
                        </Columns>
                    </Fast:Grid>
            ...
            <tr>
                <td style="padding-left:17px">
                    <asp:CustomValidator ID="cvNoArrive" runat="server" ErrorMessage="明細項目{0}的人員無到職日，請修改到職日並重新產生旅遊補助資訊!" Display="Dynamic" ForeColor="Red" EnableTheming="true"
                        ClientValidationFunction="CheckArrive" meta:resourcekey="cvNoArriveResource1"></asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td style="padding-left:17px">
                    <asp:CustomValidator ID="cvNoCreate" runat="server" ErrorMessage="明細項目{0}的人員未產生旅遊補助資訊，請重新產生旅遊補助資訊!" Display="Dynamic" ForeColor="Red" EnableTheming="true"
                        ClientValidationFunction="CheckCreate" meta:resourcekey="cvNoCreateResource1"></asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td style="padding-left:17px">
                    <asp:CustomValidator ID="cvFormRepet" runat="server" ErrorMessage="明細項目{0}人員的旅遊補助已申請過!" Display="Dynamic" ForeColor="Red" EnableTheming="true"
                        ClientValidationFunction="CheckRepet" meta:resourcekey="cvFormRepetResource1"></asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td style="padding-left:17px">
                    <asp:CustomValidator ID="cvPrice" runat="server" ErrorMessage="明細項目{0}的人員申請金額需大於零!" Display="Dynamic" ForeColor="Red" EnableTheming="true"
                        ClientValidationFunction="CheckPrice" meta:resourcekey="cvPriceResource1"></asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td style="padding-left:17px; padding-top:15px">
                    <asp:Label ID="Label3" runat="server" Text="申請補助總計" meta:resourcekey="Label3Resource1"></asp:Label>
                </td>
            </tr>
            <tr>
                <td style="padding-left:20px">
                    <asp:Label ID="lblTourTotalAmount" runat="server" Text="0" meta:resourcekey="lblTourTotalAmountResource1"></asp:Label>
                    <asp:Label ID="Label4" runat="server" Text="公式：Sum(參加人員：實際使用金額)" ForeColor="Gray" meta:resourcekey="Label4Resource1"></asp:Label>
                </td>
            </tr>
        </table>
        <br />
