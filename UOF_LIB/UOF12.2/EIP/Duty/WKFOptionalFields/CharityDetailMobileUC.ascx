<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="CharityDetailUC.ascx.cs" Inherits="WKFOptionalFields_CharityDetailUC" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table style="width:97%">
            <tr>
                <td>
                    <telerik:RadButton ID="rdbtnInsert" runat="server" Text="新增明細" CausesValidation="False"
                        OnClick="rdbtnInsert_Click" meta:resourcekey="rdbtnInsertResource1">
                    </telerik:RadButton>
                </td>
            </tr>
            <tr>
                <td style="padding-left:3px">
                    <Fast:Grid ID="Grid1" runat="server"
                        ...
                        <Columns>
                                        ...
                                        <tr>
                                            <td>
                                                <asp:LinkButton ID="lbtnModify" runat="server" Text="修改"
                                                    OnClick="lbtnModify_Click" meta:resourcekey="lbtnModifyResource1"></asp:LinkButton>
                                            </td>
                                            <td>
                                                <asp:LinkButton ID="lbtnDelete" runat="server" Text="刪除" CausesValidation="False"
                                                    OnClick="lbtnDelete_Click" OnClientClick="ConfirmDelete();" meta:resourcekey="lbtnDeleteResource1"></asp:LinkButton>
                                            </td>
                                        </tr>
                                    </table>
                                </ItemTemplate>
                            ...
                            <asp:BoundField DataField="ACTIVITY_HOURS" HeaderText="活動時數" meta:resourcekey="BoundFieldResource8" />
                            <asp:BoundField DataField="HOURS" HeaderText="公益時數" meta:resourcekey="BoundFieldResource4"></asp:BoundField>
                            <asp:BoundField DataField="LOCATION" HeaderText="地點" meta:resourcekey="BoundFieldResource5"></asp:BoundField>
                            <asp:BoundField DataField="NAME" HeaderText="名稱" meta:resourcekey="BoundFieldResource6"></asp:BoundField>
                            <asp:BoundField DataField="CONTENT" HeaderText="內容" meta:resourcekey="BoundFieldResource7"></asp:BoundField>
                        </Columns>
                    </Fast:Grid>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:CustomValidator ID="CustomValidator1" runat="server" Display="Dynamic" ForeColor="Red" EnableTheming="true" ErrorMessage="活動內容為必填欄位" ClientValidationFunction="CheckCount" meta:resourcekey="CustomValidator1Resource1"></asp:CustomValidator>
                    <asp:CustomValidator ID="cvCheckSend" runat="server" Display="Dynamic" ForeColor="Red" EnableTheming="true" ErrorMessage="該活動內容已申請過" ClientValidationFunction="CheckSend" meta:resourcekey="cvCheckSendResource1"></asp:CustomValidator>
                </td>
            </tr>
        </table>
    </ContentTemplate>
