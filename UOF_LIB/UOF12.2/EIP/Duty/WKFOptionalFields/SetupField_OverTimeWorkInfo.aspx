<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="SetupField_OverTimeWorkInfo.aspx.cs" Inherits="Ede.Uof.Web.EIP.Duty.WKFOptionalFields.SetupField_OverTimeWorkInfo" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <colgroup class="PopTableRightTD">	</colgroup>
    <tr>
        <td align="center" class="PopTableHeader" colspan="4"><asp:Label ID="lblSingleLine" runat="server" Text="加班資訊 3.0" meta:resourcekey="lblSingleLineResource1"></asp:Label></td>
    </tr>
    <tr>
