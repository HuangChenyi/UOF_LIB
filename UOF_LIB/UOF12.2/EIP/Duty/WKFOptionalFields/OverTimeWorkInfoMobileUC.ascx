...
function CheckMaxExpHours(e, args) {
    ...
    function OpenDialog(sender) {
        ...
        $uof.dialog.open2("~/EIP/Duty/WKFOptionalFields/ErrorInfo.aspx", sender, '', 400, 600,
            openDialogResult, { "StartDate": startDate, "Users": users, "BelongDate": belnogDate, "EndDate": endDate, "TaskId": taskId, "HolidayType": holidayType });
    }
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
            ...
            <tr>
                <td style="padding-left: 17px" colspan="2">
                    <asp:RadioButtonList ID="rblChangeType" runat="server" RepeatDirection="Horizontal" meta:resourcekey="rblChangeTypeResource1">
                        <asp:ListItem Text="轉補休" Value="TimeOff" meta:resourcekey="ListItemTimeOffResourcekey1"></asp:ListItem>
                        <asp:ListItem Text="轉費用" Value="Payment" meta:resourcekey="ListItemPaymentResourcekey1"></asp:ListItem>
                        <asp:ListItem Text="轉補休及費用" Value="Both" meta:resourcekey="ListItemBothResourcekey1"></asp:ListItem>
                    </asp:RadioButtonList>
        ...
        <table style="width: 97%" cellpadding="0" cellspacing="0">
            ...
            <tr>
                <td style="padding-left: 17px">
                    <asp:CustomValidator ID="cvSingleHolidayType" runat="server" ErrorMessage="請設定加班類型" Visible="False" Display="Dynamic" ForeColor="Red" EnableTheming="true"
