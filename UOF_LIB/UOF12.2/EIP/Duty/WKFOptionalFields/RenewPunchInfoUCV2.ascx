...
<script type="text/javascript">
    ...
    function CheckTime(source, arguments) {
        ...
        var cbWork = $('#<%=cbWorkPunch.ClientID%>').attr("checked") ? true : false;
        var cbOff = $('#<%=cbOffPunch.ClientID%>').attr("checked") ? true : false;
    ...
    function CheckRenewType(source, arguments) {
        ...
        var cbWork = $('#<%=cbWorkPunch.ClientID%>').attr("checked") ? true : false;
        var cbOff = $('#<%=cbOffPunch.ClientID%>').attr("checked") ? true : false;
        var rbRenewPunch = $('#<%=rbRenewPunch.ClientID%>').attr("checked") ? true : false;
            ...
            <table class="PopTable" cellpadding="0" cellspacing="0" style="width: 500px">
                <tr class="trTimeZone">
                    <td class="popTableLeftTD">
                        <asp:Label ID="Label9" runat="server"  Text="歸屬地點" meta:resourcekey="Label9Resource1"></asp:Label>
                    </td>
                            ...
                            <tr>
                                ...
                                <td>
                                    <table class="style1">
                                        <tr>
                                            <td>
                                                <telerik:RadDatePicker ID="rdWorkDate" runat="server" SkinID="AllowEmpty" meta:resourcekey="rdWorkDateResource1">
                                                    
                                                </telerik:RadDatePicker>
                                            </td>
                                            <td style="width: 5px;" align="center"></td>
                                            <td>
                                                <telerik:RadTimePicker ID="rdWorkTime" runat="server" SkinID="AllowEmpty" Width="100px" meta:resourcekey="rdWorkTimeResource1">
                            ...
                            <tr>
                                ...
                                <td class="style3">
                                    <table class="style1">
                                        <tr>
                                            <td>
                                                <telerik:RadDatePicker ID="rdOffDate" runat="server" SkinID="AllowEmpty" meta:resourcekey="rdOffDateResource1">
                                                    
                                                </telerik:RadDatePicker>
                                            </td>
                                            <td style="width: 5px;" align="center"></td>
                                            <td>
                                                <telerik:RadTimePicker ID="rdOffTime" runat="server" SkinID="AllowEmpty" Width="100px" meta:resourcekey="rdOffTimeResource1">
                                                </telerik:RadTimePicker>
                                            </td>
                                        </tr>
                                    </table>
                ...
                <tr>
                    ...
                    <td class="PopTableRightTD" style="width: 85%">
                        <table cellpadding="1" cellspacing="1">
                            <tr>
                                <td>
                                    <telerik:RadDatePicker ID="rdBelongDate" runat="server" AutoPostBack="true" OnSelectedDateChanged="rdBelongDate_SelectedDateChanged" meta:resourcekey="rdBelongDateResource1">
                                    </telerik:RadDatePicker>
                                </td>
