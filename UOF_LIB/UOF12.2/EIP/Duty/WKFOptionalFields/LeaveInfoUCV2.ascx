<%@ Control Language="C#" AutoEventWireup="true" Inherits="WKF_OptionalFields_LeaveInfoUCV2" Codebehind="LeaveInfoUCV2.ascx.cs" %>
...
<script type="text/javascript" >
    ...
    function CheckNotInRange(source, args) {
        ...
        var levCode = $('#<%=hfLeaveCode.ClientID%>').val();
        ...
        if (exception != true) {
            ...
            if (startDate != null) {
                var data = [applicantGuid, startDate, startTime, levCode, oldStartDate, fieldMode, taskID];
                if (result == "true")
    ...
    function CheckNotFindLev(source, args) {
        ...
        var applicantGuid = $("#<%=hfApplicantGuid.ClientID %>").val();
        var leaveCode = $('#<%=hfLeaveCode.ClientID%>').val();
...
<ContentTemplate>
<table style="width: 500px" class="PopTable">
    <tr class="trTimeZone">
        ...
        <td class="PopTableRightTD" style="width:420px;">
            <asp:Label ID="lblApplicantTimeZone" runat="server" meta:resourcekey="lblApplicantTimeZoneResource1"></asp:Label>
        </td>
    </tr>
    <tr>
        <td class="PopTableLeftTD" style="width:120px;" nowrap="nowrap">
        ...
        <td class="PopTableRightTD" style="width:420px;">
            <table style="white-space:nowrap;text-wrap:none; ">
                <tr>
                    <td style="white-space:nowrap;text-wrap:none; ">
                    ...
                    <td style="padding:0px 3px 0px 3px;white-space:nowrap;text-wrap:none;">
                        <asp:HyperLink ID="hlLeaveCode" runat="server" Target="_blank" Text="假別說明"
                            meta:resourcekey="hlLeaveCodeResource1"></asp:HyperLink>
                    </td>
                    <td style="padding:0px 3px 0px 3px;white-space:nowrap;text-wrap:none;">
                        <asp:LinkButton ID="lbtnUserLeaveData" runat="server" Text="可休假餘額"
                            CausesValidation="False" meta:resourcekey="lbtnUserLeaveDataResource1"></asp:LinkButton>
                    </td>
                    <td style="padding:0px 3px 0px 3px;white-space:nowrap;text-wrap:none;">
                ...
                <tr>
                    <td colspan="5">
                        <asp:CustomValidator ID="cusValiLeaCode" runat="server" ErrorMessage="假別必須選擇"
    ...
    <tr>
        ...
        <td class="PopTableRightTD">
            <table  cellpadding="0" cellspacing="0">
                <tr>
                    <td>
                        <telerik:RadDatePicker ID="rdStartDate" Runat="server"  onselecteddatechanged="rdStartDate_SelectedDateChanged" AutoPostBack="True" meta:resourcekey="rdStartDateResource1" >
                            <ClientEvents OnDateSelected="btnCalControl"/>
                        </telerik:RadDatePicker>                        
                         <asp:Label ID="lblStartDateView" runat="server" 
                            meta:resourcekey="lblStartDateViewResource1" ></asp:Label>
                    </td>
                        <td style="width: 5px;" align="center">
                        </td>
                        <td>
                            <telerik:RadTimePicker ID="rdStartTime" runat="server" OnSelectedDateChanged="rdStartTime_SelectedDateChanged" AutoPostBack="True" AutoPostBackControl="TimeView" meta:resourcekey="rdStartTimeResource3">
                                <ClientEvents OnDateSelected="btnCalControl"/>
        ...
        <td class="PopTableRightTD">
            <table cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td>
                        <telerik:RadTimePicker ID="rdEndTime" runat="server" OnSelectedDateChanged="rdEndTime_SelectedDateChanged" AutoPostBack="True" AutoPostBackControl="TimeView" meta:resourcekey="rdEndTimeResource3">
                            <ClientEvents OnDateSelected="btnCalControl"/>
                        </telerik:RadTimePicker>
                    </td>
                    <td style="width: 5px;" align="center">
        ...
        <td class="PopTableRightTD">
            <table cellpadding="0" cellspacing="1">
                <tr>
                    ...
                    <td>
                        <telerik:RadButton ID="rdbtnCal" CausesValidation="False" OnClientClicked="ClearCheck" runat="server" Text="計算" OnClick="rdbtnCal_Click" meta:resourcekey="rdbtnCalResource1">
                        </telerik:RadButton>
                    </td>
                    <td style="padding-left:5px;vertical-align:middle">
                        <asp:CheckBox ID="ckbIsFlexible" runat="server" Text="首日依彈性下班時間計算" Visible="False" AutoPostBack="True"  OnCheckedChanged="ckbIsFlexible_Click" meta:resourcekey="ckbIsFlexibleResource1"/>
    ...
    <tr>
        ...
        <td class="PopTableRightTD">
            <table style="width: 100%;">
                ...
                <tr>
                    <td colspan="2">
                        <telerik:RadDatePicker ID="rdActualDate" SkinID="AllowEmpty" runat="server" Culture="zh-TW" meta:resourcekey="rdActualDateResource4">
            ...
            <asp:CustomValidator ID="CusVailActualDate" runat="server" Display="Dynamic" ErrorMessage="實際發生日必須填寫" ClientValidationFunction="CheckActualDate" ForeColor="Red" meta:resourcekey="CusVailActualDateResource1" ></asp:CustomValidator>
        </td>
    </tr>
    <tr id="trLD" runat="server">
        <td class="PopTableLeftTD" id="Td1" runat="server" style="width:120px;" nowrap="nowrap">
            <asp:Label ID="lblLeaveDays" runat="server" Text="可用年休" meta:resourcekey="lblLeaveDaysResource1"></asp:Label>
        </td>
        <td class="PopTableRightTD" id="Td2" runat="server">
            <telerik:RadDropDownList ID="ddlLeaveDays2" runat="server"></telerik:RadDropDownList>
    ...
    <tr id="trException" runat="server">
        <td class="PopTableRightTD" style="text-align:left;width:100%" colspan="2" runat="server">
            <asp:CheckBox ID="cbException" Text="特殊情況" runat="server" meta:resourcekey="cbExceptionResource1" ></asp:CheckBox>
...
<asp:CustomValidator ID="CusVailDateTimeErr" runat="server" Display="Dynamic" meta:resourcekey="CusVailDateTimeErrResource1" ></asp:CustomValidator>

 <table cellpadding="0" cellspacing="0" border="0">
    <tr>
        <td>
            <asp:CustomValidator ID="cvApplicant" runat="server" Visible="False" ErrorMessage="無法確認申請者" ForeColor="Red" Display="Dynamic" meta:resourcekey="cvApplicantResource1" ></asp:CustomValidator>
        </td>
    </tr>
    <tr>
        <td>
            <asp:CustomValidator ID="cvStartBiggerThenEnd" runat="server"  ForeColor="Red" Display="Dynamic" ValidateEmptyText="True" ClientValidationFunction="CheckStartEndDate" meta:resourcekey="cvStartBiggerThenEndResource1"></asp:CustomValidator>
        </td>
    </tr>
    <tr>
        <td>
            <asp:CustomValidator ID="cvStartEndSameYear" runat="server" ErrorMessage="請假時間(起)(訖)需在同一年度" ForeColor="Red" Display="Dynamic" meta:resourcekey="cvStartEndSameYearResource1" ></asp:CustomValidator>
        </td>
    </tr>
    <tr>
        <td>
            <asp:CustomValidator ID="cvNotInRange" runat="server" ErrorMessage="已超過有效申請日" ForeColor="Red" Display="Dynamic" ClientValidationFunction="CheckNotInRange" meta:resourcekey="cvNotInRangeResource1"></asp:CustomValidator>
        </td>
    </tr>
    <tr>
        <td>
            <asp:CustomValidator ID="cvLock" runat="server" ErrorMessage="請假日期期間差勤結算已鎖定或關帳，不能申請" ForeColor="Red" Display="Dynamic" ClientValidationFunction="CheckLock" meta:resourcekey="cvLockResource1"></asp:CustomValidator>
        </td>
    </tr>
    <tr>
        <td>
            <asp:CustomValidator ID="cvDateError" runat="server" ErrorMessage="請假日期時間異常" ForeColor="Red" Display="Dynamic" meta:resourcekey="cvDateErrorResource1"></asp:CustomValidator>
        </td>
    </tr>
     <tr>
         <td>
    ...
    <tr>
        <td>
            <asp:CustomValidator ID="cvNotFindLev" runat="server" ForeColor="Red" Display="Dynamic" ClientValidationFunction="CheckNotFindLev" meta:resourcekey="cvNotFindLevResource1"></asp:CustomValidator>
        </td>
    </tr>
    <tr>
        <td>
            <asp:CustomValidator ID="cvOtherLeave" runat="server" ForeColor="Red" Display="Dynamic" ClientValidationFunction="CheckOtherLeave" meta:resourcekey="cvOtherLeaveResource1"></asp:CustomValidator>
        </td>
    </tr>
    <tr>
        <td>
            <asp:CustomValidator ID="cvRepeat" runat="server" ForeColor="Red" Display="Dynamic" ClientValidationFunction="CheckRpLeave" meta:resourcekey="cvRepeatResource1"></asp:CustomValidator>
        </td>
    </tr>
     <tr>
         <td>
...
<asp:Label ID="lblLeaveCodeMiss" runat="server" Text="選擇假別已被修改或移除，請洽管理員" style=" display:none;" meta:resourcekey="lblLeaveCodeMissResource1" ></asp:Label>
