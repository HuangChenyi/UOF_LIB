<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="LeaveCancelInfoUCV2.ascx.cs" Inherits="WKF_OptionalFields_LeaveCancelInfoUCV2" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table style="width: 97%;">
            ...
            <tr>
                <td style="padding-left: 17px">
                    <telerik:RadDropDownList ID="rddlLeaveNbr" runat="server" EnableTheming="True"
                        AutoPostBack="True" CausesValidation="False"
                        OnSelectedIndexChanged="rddlLeaveNbr_SelectedIndexChanged" meta:resourcekey="rddlLeaveNbrResource1">
            ...
            <tr id="placeTr" runat="server">
                <td runat="server">
                    <table>
                        <tr>
                            <td style="padding-left: 17px; padding-top: 10px">
                                <asp:Label ID="Label8" runat="server" Text="歸屬地點" meta:resourcekey="Label8Resource1"></asp:Label>
                            </td>
                        </tr>
                        <tr>
                            <td style="padding-left: 17px">
        ...
        <table cellpadding="0" cellspacing="0" border="0" style="width: 97%;">
            <tr>
                <td style="padding-left: 17px; padding-top: 10px">
                    <asp:CustomValidator ID="cvCheckLock" runat="server" ErrorMessage="請假日期期間差勤結算已鎖定或關帳，不能銷單" ForeColor="Red" EnableTheming="True" Display="Dynamic" ClientValidationFunction="CheckLock" meta:resourcekey="cvCheckLockResource1"></asp:CustomValidator>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:CustomValidator ID="cvCheckLeaDiffUse" runat="server" ForeColor="Red" Display="Dynamic" ClientValidationFunction="CheckLeaDiffUse" meta:resourcekey="cvCheckLeaDiffUseResource1"></asp:CustomValidator>
                </td>
            </tr>
        </table>
        <table style="width: 97%;">
