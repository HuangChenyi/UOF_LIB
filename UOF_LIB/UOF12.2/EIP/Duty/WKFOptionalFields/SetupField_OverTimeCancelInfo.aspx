<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_OptionalFields_SetupField_OverTimeCancelInfo" Title="" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="SetupField_OverTimeCancelInfo.aspx.cs" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    <tr>
        <td align="center" class="PopTableHeader" colspan="4">
            <div style=" text-align:center;">
                <asp:Label ID="lblSingleLine" runat="server" Text="銷班資訊" meta:resourcekey="lblSingleLineResource1"></asp:Label>
            </div>        
        </td>
    </tr>
    <tr>
    ...
    <tr id="GrideDetail">
        ...
        <td colspan="3">
            <telerik:RadNumericTextBox ID="rdNumericViewLength" runat="server" DataType="System.Int32" MaxLength="5" MaxValue="1000" MinValue="0" Width="40px" Value="0" Culture="zh-TW" DbValueFactor="1" LabelWidth="16px" meta:resourcekey="rdNumericViewLengthResource1"></telerik:RadNumericTextBox>
