...
<script>
    ...
    function ValidateApply_<%=ClientID%>(source, arguments) {
        ...
        data = [applicantCompanyNo, applicantEmployeeNo, agnetJSON, startDate, startTime, endDate, endTime, leaCode, reason, eventDate, 'true'];
...
<table class="LeaveTable104" style="width: 100%">
            ...
            <table>
                <tr>
                    <td>
                        ...
                        <asp:DropDownList ID="ddlLeaveCode" runat="server" EnableTheming="true">
    ...
    <tr>
        <td>
            <table>
                <tr>
                    <td>
                        <telerik:RadDatePicker ID="rdStartDate" runat="server"  AutoPostBack="False" EnableTheming="true" >
                        </telerik:RadDatePicker>
                    </td>
                    <td>
                        <asp:Label ID="lblStartDate" runat="server" Visible="False" ></asp:Label>
                        <telerik:RadTimePicker ID="rdStartTime" runat="server" EnableTheming="true">
    ...
    <tr>
        <td>
            <table>
                <tr>
                    <td>
                        <telerik:RadDatePicker ID="rdEndDate" runat="server"  AutoPostBack="False" EnableTheming="true" >
                        </telerik:RadDatePicker>
                    </td>
                    <td>
                        <asp:Label ID="lblEndDate" runat="server" Visible="False" ></asp:Label>
                        <telerik:RadTimePicker ID="rdEndTime" runat="server" EnableTheming="true">
                        </telerik:RadTimePicker>
                    </td>
                </tr>
            </table>
    ...
    <tr id="tdEventDate">
        <td >
            ...
            <telerik:RadDatePicker ID="rdEventDate" runat="server"  AutoPostBack="False" EnableTheming="true" >
            </telerik:RadDatePicker>
        </td>
    </tr>
    <tr>
...
<table>
    <tr>
        <td>
            <asp:CustomValidator ID="cvMissingInfo" runat="server" ErrorMessage="申請者無員工編號或公司統一編號資訊" Display="Dynamic" EnableTheming="true" ></asp:CustomValidator>
        </td>
    </tr>
    <tr>
        <td>
            <asp:CustomValidator ID="cvSelect" runat="server" ErrorMessage="請選擇假別" Display="Dynamic"  EnableTheming="true"></asp:CustomValidator>
        </td>
    </tr>
    <tr>
        <td>
            <asp:CustomValidator ID="cvCal" runat="server" ErrorMessage="請計算請假時(天)數" Display="Dynamic" EnableTheming="true" ></asp:CustomValidator>
        </td>
    </tr>
        <tr>
        <td>
            <asp:CustomValidator ID="cvApply" runat="server" ErrorMessage="" Display="Dynamic" EnableTheming="true" ></asp:CustomValidator>
        </td>
    </tr>
</table>
