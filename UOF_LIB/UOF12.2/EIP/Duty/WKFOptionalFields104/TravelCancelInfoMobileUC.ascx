...
<script type="text/javascript">
    function ValidateApplyM_<%=ClientID%>(source, arguments) {
        ...
        var tripId = $find("<%=ddlMTravelList.ClientID%>").get_selectedItem().get_value();
            ...
            <tr>
                <td>
                    <table>
                        <tr>
                            <td style="padding-left: 17px">
                                <telerik:RadDropDownList ID="ddlMTravelList" runat="server" OnSelectedIndexChanged="ddlMTravelList_SelectedIndexChanged" AutoPostBack="true"  EnableTheming="true" CausesValidation="false"></telerik:RadDropDownList>
                                <asp:DropDownList ID="ddlTravelList" runat="server" OnSelectedIndexChanged="ddlTravelList_SelectedIndexChanged" style="display:none" CausesValidation="false">
                                </asp:DropDownList>
            ...
            <tr>
                <td style="padding-left: 17px">
                    <Fast:Grid ID="Grid1" runat="server" AutoGenerateCheckBoxColumn="False"
                        AllowSorting="False" AutoGenerateColumns="False"  EnableTheming="true"
...
<asp:CustomValidator ID="CustomValidator1" runat="server" ErrorMessage="" Display="Dynamic" EnableTheming="true"></asp:CustomValidator>
