...
<table>
    ...
    <tr>
        <td>
            <asp:CustomValidator ID="cvCal" runat="server" ErrorMessage="請先計算請假時(天)數" Display="Dynamic" EnableTheming="true" ></asp:CustomValidator>
        </td>
    </tr>
    <tr>
        <td>
