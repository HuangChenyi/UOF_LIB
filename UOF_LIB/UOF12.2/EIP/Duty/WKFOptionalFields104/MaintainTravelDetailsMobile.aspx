<%@ Page Title="行程資訊" Language="C#" MasterPageFile="~/Master/MobileMasterPage.master" AutoEventWireup="true" CodeBehind="MaintainTravelDetails.aspx.cs" Inherits="Ede.Uof.Web.EIP.Duty.WKFOptionalFields104.MaintainTravelDetails" %>
                                    ...
                                    <telerik:CompositeLayoutColumn Span="12">
                                        <Content>
                                            <h3 class="blockheader">
                                                <asp:Label ID="Label1" runat="server" Text="明細"></asp:Label>
                                            </h3>
                                        </Content>
                                        <Rows>
