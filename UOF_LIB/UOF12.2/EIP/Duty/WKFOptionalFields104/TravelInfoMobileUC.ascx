...
<table class="TravelTable104" style="width:100%">
    ...
    <tr>
        <td>
            ...
            <asp:DropDownList ID="ddlCurrency" runat="server" EnableTheming="true"></asp:DropDownList>
        </td>
    ...
    <tr>
        <td>
            ...
            <telerik:RadNumericTextBox ID="txtCashAdvance" runat="server" Width="115px" MinValue="0" EnableTheming="true">
    ...
    <tr>
        <td>
            <table>
                <tr>
                    <td>
                        <telerik:RadButton ID="rdbtnAddDetail" runat="server" Text="新增明細" CausesValidation="False" OnClick="rdbtnAddDetail_Click" EnableTheming="true"></telerik:RadButton>
                    </td>
                </tr>
                <tr>
                    <td>
