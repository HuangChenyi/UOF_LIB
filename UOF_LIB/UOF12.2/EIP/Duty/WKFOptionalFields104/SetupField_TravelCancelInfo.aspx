<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="SetupField_TravelCancelInfo.aspx.cs" Inherits="Ede.Uof.Web.EIP.Duty.WKFOptionalFields104.SetupField_TravelCancelInfo" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    <tr>
        <td align="center" class="PopTableHeader" colspan="4">
            <div style=" text-align:center;">
                <asp:Label ID="lblSingleLine" runat="server" Text="銷出差資訊" 
                    meta:resourcekey="lblSingleLineResource1" ></asp:Label>
            </div>           
        </td>
    </tr>
    <tr>
    ...
    <tr>
        ...
        <td>	<asp:Label ID="lblSeq" runat="server" meta:resourcekey="lblSeqResource1"></asp:Label>
                <telerik:RadNumericTextBox ID="rdNumericEditFieldSeq" runat="server" MaxLength="3" MaxValue="999" MinValue="0" Width="40px" DataType="System.Int32"></telerik:RadNumericTextBox>
        </td>
    </tr>
             <tr>
            <td>
    ...
    <tr id="GrideDetail" style="display:none;">
        ...
        <td colspan="3">
            <telerik:RadNumericTextBox ID="rdNumericViewLength" runat="server" MaxLength="5" MaxValue="1000" MinValue="0" Width="40px" DataType="System.Int32" Value="0"></telerik:RadNumericTextBox>
