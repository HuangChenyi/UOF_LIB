                ...
                <tr>
                    ...
                    <td>
                        <table>
                            <tr>
                                <td>
                                    <telerik:RadDatePicker ID="rdStrDate" runat="server" Culture="zh-TW" meta:resourcekey="rdStrDateResource1">
                                        <Calendar UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False" Culture="zh-TW" EnableWeekends="True" FastNavigationNextText="&amp;lt;&amp;lt;"></Calendar>
                                ...
                                <td>&nbsp;</td>
                                <td>
                                    <telerik:RadTimePicker ID="rdStrTime" runat="server" Width="80px" meta:resourcekey="rdStrTimeResource1">
                    ...
                    <td style="width: 40%">
                        <table>
                            <tr>
                                <td>
                                    <telerik:RadDatePicker ID="rdEndDate" runat="server" Culture="zh-TW" meta:resourcekey="rdEndDateResource1">
                                        <Calendar UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False" Culture="zh-TW" EnableWeekends="True" FastNavigationNextText="&amp;lt;&amp;lt;"></Calendar>
                                        <DateInput LabelWidth="40%" DateFormat="yyyy/M/d" DisplayDateFormat="yyyy/M/d" Width="">
                                            <ClientEvents OnValueChanging="OnValueChanging" />
                                            <EmptyMessageStyle Resize="None" />
