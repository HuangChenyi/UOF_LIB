...
<asp:Content ID="Content3" ContentPlaceHolderID="LeftContentPlaceHolder" runat="server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" RenderMode="Inline" UpdateMode="Conditional">
        <ContentTemplate>
            <uc1:UC_DeptManagerTree runat="server" ID="UC_DeptManagerTree" ShowDeptManagerTree="true" ShowDeptPersonalTree="false" ShowSuperiorTree="false"/>                                 
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
                ...
                <Fast:Grid ID="gridLeave" runat="server" AutoGenerateCheckBoxColumn=False AllowSorting="True" AutoGenerateColumns="False"                    
                    ...
                    <ExportExcelSettings AllowExportToExcel="True" DataSourceType="ObjectDataSource" />                    
                        <Columns>
                            ...
                            <asp:TemplateField HeaderText="總年休天(時)數" 
                            ...
                            <asp:TemplateField HeaderText="本年度可休天(時)數" SortExpression="LEAVE_DAYS" 
                            ...
                            <asp:BoundField HeaderText="本年度已用天(時)數" DataField="USED_DAYS" SortExpression="USED_DAYS" DataFormatString="{0:#,##0.##}"  
                            ...
                            <asp:TemplateField HeaderText="去年度保留天(時)數" 
                            ...
                            <asp:BoundField HeaderText="去年度已用天(時)數" DataField="LAST_USED_DAYS" SortExpression="LAST_USED_DAYS" DataFormatString="{0:#,##0.##}"  
