...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript">
        ...
        $(function () {
            $('#<%=ddlSelectMonth.ClientID %>').attr("disabled", false);
            $('#<%=ddlSelectDay.ClientID %>').attr("disabled", false);
        });
        ...
        function CopyFiled() {
            ...
            clipboardData.setData("Text", $('#<%= txtMsg.ClientID %>').val());
                ...
                $('#<%=ddlSelectMonth.ClientID %>').attr("disabled", true);
                $('#<%=ddlSelectDay.ClientID %>').attr("disabled", true);
