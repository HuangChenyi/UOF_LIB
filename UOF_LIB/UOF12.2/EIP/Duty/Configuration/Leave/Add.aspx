...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <script type="text/javascript">
     ...
     function ChangeLabelText()
     {
         ...
         {
             lblType.val($('#<%=hfDay.ClientID %>').val());
         }
        ...
        function SetEnable3() {
            ...
            if (check == true) {
                before.enable();
                after.disable();
                $('#<%=cbApplyTimeLimit2.ClientID %>').attr("checked", false);
            }
            else
                before.disable();
        }
        ...
        function SetEnable4() {
            ...
            if (check == true) {
                after.enable();
                before.disable();
                $('#<%=cbApplyTimeLimit1.ClientID %>').attr("checked", false)
            }
            else
                after.disable();
        }
...
<style type="text/css"> 
    ...
    <table width="100%" class="PopTable" cellspacing="1">    
        <tr>
            ...
            <td>
                ...
                <asp:CustomValidator ID="CustomValidator1" runat="server" ControlToValidate="txtLeaveCode" Display="Dynamic" ErrorMessage="假別代碼(與其他部門)重複請重新輸入" ForeColor="Red" onservervalidate="CustomValidator1_ServerValidate" meta:resourcekey="CustomValidator1Resource1"></asp:CustomValidator>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="txtLeaveCode" Display="Dynamic" ErrorMessage="請輸入假別代碼" ForeColor="Red"  meta:resourcekey="RequiredFieldValidator1Resource1"></asp:RequiredFieldValidator>
                <asp:CustomValidator ID="CustomValidator2" runat="server" ErrorMessage="此為系統保留字，不允許使用" ForeColor="Red" onservervalidate="CustomValidator2_ServerValidate" meta:resourcekey="CustomValidator2Resource1" Display="Dynamic"></asp:CustomValidator>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                <asp:CustomValidator ID="CustomValidator7" runat="server" ControlToValidate="txtName" Display="Dynamic" ErrorMessage="假別名稱重複請重新輸入" ForeColor="Red" onservervalidate="CustomValidator7_ServerValidate" meta:resourcekey="CustomValidator7Resource1"></asp:CustomValidator>
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="txtName" Display="Dynamic" ErrorMessage="請輸入假別名稱" ForeColor="Red" meta:resourcekey="RequiredFieldValidator2Resource1"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="RadioButtonList1" Display="Dynamic" ErrorMessage="請選擇扣薪與否" ForeColor="Red"  meta:resourcekey="RequiredFieldValidator4Resource1" ></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td>
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="RadioButtonList2" Display="Dynamic" ErrorMessage="請選擇連休" meta:resourcekey="RequiredFieldValidator3Resource1" ForeColor="Red" ></asp:RequiredFieldValidator>
            </td>
        </tr>
            <tr>
            <td>
        ...
        <tr>
            ...
            <td style="white-space:nowrap;">
                ...
                <p>
                    <asp:Label ID="Label20" runat="server" CssClass="SizeMemo" Text="註:設定0表示需為當天才可申請，不設定表示不限制。" meta:resourcekey="Label20Resource1"></asp:Label>                   
                </p>
            </td>
        </tr>
        <tr>
            ...
            <td style="white-space:nowrap;" >
                ...
                <br />
                    ...
                    <asp:Label ID="Label18" runat="server" Text="請假開始日後" Style="vertical-align: bottom;" meta:resourcekey="Label18Resource1"></asp:Label>
    ...
    <script type="text/javascript">
        ...
        {
            var oldLeaCode = '<%=Request["LeaCode"] %>';           
            if (oldLeaCode != "")
            {
                var newLeaCode = $('#<%=txtLeaveCode.ClientID %>').val();
                if (oldLeaCode != newLeaCode)
                {
                    if (!confirm('<asp:Literal runat="server" Text="變更假別代碼有可能會造成使用原假別代碼的資料遺失,確定要繼續嗎?" />'))
                    {
    ...
    <asp:HiddenField ID="hfHr" runat="server" Value="時" meta:resourcekey="hfHrResource1"/>
    <asp:HiddenField ID="hfDay" runat="server" Value="天" meta:resourcekey="hfDayResource1"/>
</asp:Content>
