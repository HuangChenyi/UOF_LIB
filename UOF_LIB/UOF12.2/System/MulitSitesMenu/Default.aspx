...
function SelectSite() {
    ...
    lblRealLink.text(ddlDomainUrl.val());
}
...
<asp:Content ID="Content1" ContentPlaceHolderID="ToolbarContentPlaceHolder" Runat="Server">
    ...
    <asp:Content ID="Content2" ContentPlaceHolderID="LeftContentPlaceHolder" Runat="Server">        
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Always">
                    <ContentTemplate>
                        <telerik:RadTreeView ID="RadTreeView1" runat="server" Height="450px" Width="250px" OnNodeClick="RadTreeView1_NodeClick"></telerik:RadTreeView>
