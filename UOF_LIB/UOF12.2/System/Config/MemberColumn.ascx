 ...
 <table  class="PopTable" cellspacing="1" width="100%" >
        ...
        <tr><td  colspan="4" align="center" class="PopTableHeader">
            <center><asp:Label ID="lblCustomColumn" runat="server" Text="自訂欄位顯示名稱" 
                meta:resourcekey="lblCustomColumnResource1"></asp:Label></center></td></tr>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtOptionA" runat="server" 
                    meta:resourcekey="txtOptionAResource1"></asp:TextBox></td>
            ...
            <td>
                <asp:TextBox ID="txtOptionB" runat="server" 
                    meta:resourcekey="txtOptionBResource1"></asp:TextBox></td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtOptionC" runat="server" 
                    meta:resourcekey="txtOptionCResource1"></asp:TextBox></td>
            ...
            <td>
                <asp:TextBox ID="txtOptionD" runat="server" 
                    meta:resourcekey="txtOptionDResource1"></asp:TextBox></td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtOptionE" runat="server" 
                    meta:resourcekey="txtOptionEResource1"></asp:TextBox></td>
            ...
            <td>
                <asp:TextBox ID="txtOptionF" runat="server" 
                    meta:resourcekey="txtOptionFResource1"></asp:TextBox></td>
        </tr>
        <tr><td  colspan="4" align="center" class="PopTableHeader">
            <center><asp:Label ID="Label38" runat="server" Text="個人資料欄位顯示名稱" 
                meta:resourcekey="Label38Resource1"></asp:Label></center></td></tr>
            
        <tr>
            <td> <asp:Label ID="Label39" runat="server" Text="個人資料1" 
                    meta:resourcekey="Label39Resource1"></asp:Label></td>
            <td>
                <asp:TextBox ID="txtPersonalA" runat="server" 
                    meta:resourcekey="txtPersonalAResource1"></asp:TextBox></td>
            <td> <asp:Label ID="Label40" runat="server" Text="個人資料2" 
                    meta:resourcekey="Label40Resource1"></asp:Label></td>
            <td>
                <asp:TextBox ID="txtPersonalB" runat="server" 
                    meta:resourcekey="txtPersonalBResource1"></asp:TextBox></td>
        </tr>
        <tr>
            <td> <asp:Label ID="Label41" runat="server" Text="個人資料3" 
                    meta:resourcekey="Label41Resource1"></asp:Label></td>
            <td>
                <asp:TextBox ID="txtPersonalC" runat="server" 
                    meta:resourcekey="txtPersonalCResource1"></asp:TextBox></td>
            <td> <asp:Label ID="Label42" runat="server" Text="個人資料4" 
                    meta:resourcekey="Label42Resource1"></asp:Label></td>
            <td>
                <asp:TextBox ID="txtPersonalD" runat="server" 
                    meta:resourcekey="txtPersonalDResource1"></asp:TextBox></td>
        </tr>
        <tr>
            <td> <asp:Label ID="Label43" runat="server" Text="個人資料5" 
                    meta:resourcekey="Label43Resource1"></asp:Label></td>
            <td>
                <asp:TextBox ID="txtPersonalE" runat="server" 
                    meta:resourcekey="txtPersonalEResource1"></asp:TextBox></td>
            <td> <asp:Label ID="Label44" runat="server" Text="個人資料6" 
                    meta:resourcekey="Label44Resource1"></asp:Label></td>
            <td>
                <asp:TextBox ID="txtPersonalF" runat="server" 
                    meta:resourcekey="txtPersonalFResource1"></asp:TextBox></td>
        </tr>
        <tr>
