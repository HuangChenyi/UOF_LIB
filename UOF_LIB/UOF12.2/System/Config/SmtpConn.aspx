...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    <table class=PopTable cellspacing=1 width=100%>
        ...
        <tr>
            ...
            <td>
                <asp:TextBox ID="txbPwd" runat="server" MaxLength="50" TextMode="Password" 
        ...
        <tr>
            ...
            <td align=left>
                <asp:Label ID="lbSuccess" runat="server" Text="測試連線成功" Visible=False ForeColor="Blue" meta:resourcekey="lbSuccessResource1"></asp:Label>
                <asp:Label ID="lbFailed" runat="server" Text="測試連線失敗" Visible=False ForeColor=Red meta:resourcekey="lbFailedResource1"></asp:Label></td>
        </tr>
    </table>
