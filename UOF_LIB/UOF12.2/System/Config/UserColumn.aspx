<%@ Page Language="C#" MasterPageFile="~/Master/DefaultMasterPage.master" AutoEventWireup="true" Inherits="System_Config_UserColumn" Title="" Culture="auto"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <asp:Label ID="Label1" runat="server" Text="內部員工欄位維護" meta:resourcekey="Label1Resource2"
        Visible="false"></asp:Label>
    <asp:Label ID="Label2" runat="server" Text="外部會員欄位維護" meta:resourcekey="Label2Resource2"
        Visible="false"></asp:Label>
</asp:Content>
