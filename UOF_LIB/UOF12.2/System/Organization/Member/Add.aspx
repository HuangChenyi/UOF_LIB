...
<DatePopupButton ImageUrl="" HoverImageUrl="" CssClass=""></DatePopupButton>
        ...
        <tr>
            ...
            <td colspan="3">
                <asp:CheckBoxList ID="cbClassList" runat="server" RepeatColumns="5" RepeatDirection="Horizontal"
                    meta:resourcekey="cbClassListResource1">
                </asp:CheckBoxList>
            </td>
        </tr>
        <tr>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" CssClass=""></DatePopupButton>
        ...
        <tr>
            ...
            <td style="white-space: nowrap">
                <asp:Label ID="Label22" runat="server" Text="MSN" meta:resourcekey="Label22Resource1"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtMSN" runat="server" MaxLength="50" meta:resourcekey="txtMSNResource1"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="white-space: nowrap">
        ...
        <tr>
            ...
            <td>                
                <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Image ID="imgBigPicture" runat="server" Width="100px" Height="100px" meta:resourcekey="imgBigPictureResource1" />
                        <br />
    ...
    <input id="hideClass" type="hidden" runat="server" />
