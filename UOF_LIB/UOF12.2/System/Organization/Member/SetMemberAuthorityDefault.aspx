...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            <Ede:Grid ID="authGrid" runat="server" AllowPaging="True"
        ...
        DefaultSortDirection="Ascending" EnhancePager="True" OnRowDataBound="authGrid_RowDataBound" CustomDropDownListPage="False" EmptyDataText="No data found" KeepSelectedRows="False" SelectedRowColor="" UnSelectedRowColor="" OnSelectedIndexChanging="authGrid_SelectedIndexChanging" meta:resourcekey="authGridResource2" AllowSorting="True">
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="可維護人員">
                        <EditItemTemplate>
