...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="Server">
    <script type="text/javascript">
        ...
        function EndRequestHandler(sender, args) {
            ...
            //display scroll bar
            window.setTimeout(function () { resizeGroupTree($("#leftX").val(), $("#leftY").val()); }, 500);
...
<asp:Content ID="Content4" ContentPlaceHolderID="LeftContentPlaceHolder" runat="Server">
    ...
    <input type="hidden" id="leftX" />
    <input type="hidden" id="leftY" />
    <input type="hidden" id="doEndRequestHandler" />
</asp:Content>
