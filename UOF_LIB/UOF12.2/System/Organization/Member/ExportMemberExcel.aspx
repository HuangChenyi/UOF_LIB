            ...
            <table width="100%" class="PopTable" cellspacing="1">
                ...
                <tr>
                    <td style="white-space: nowrap">
                        <asp:Label ID="Label2" runat="server" Text="包含帳號過期人員" meta:resourcekey="Label2Resource1"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td style="white-space: nowrap">
                        <asp:Label ID="Label3" runat="server" Text="包含帳號被鎖定人員" meta:resourcekey="Label3Resource1"></asp:Label>
                    </td>
                    <td>
                ...
                <tr>
                    <td style="white-space: nowrap">
                        <asp:Label ID="Label4" runat="server" Text="包含帳號被停用人員" meta:resourcekey="Label4Resource1"></asp:Label>
                    </td>
                    <td>
