...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table class="PopTable" cellspacing="1" style="width: 100%">
        ...
        <tr>
            ...
            <td>
                <telerik:RadDatePicker ID="chooserExpire" runat="server" SkinID="AllowEmpty" Culture="zh-TW" meta:resourcekey="chooserExpireResource2">
                ...
                <table class="NormalPopTable" width="100%">
                    <tr runat="server" id="plusTR0">
                        ...
                        <td valign="top" align="left" class="PopTableRightTD" style="border-top-style: none; border-right-style: none; background-color: White;width:30%" runat="server">
                            ...
                            <input id="hideMaster" runat="server" type="hidden" />
                            </input>
                            <input id="hideOldMaster" runat="server" type="hidden"></input>
                            </input>
                        </td>
                    </tr>
                    <tr runat="server" id="plusTR1">
                        ...
                        <td valign="top" align="left" class="PopTableRightTD" style="padding-bottom: 5px; background-color: White;" runat="server">
                            ...
                            <input id="hidePlus1" runat="server" type="hidden" />
                            </input>
                            <input id="hideOldPlus1" runat="server" type="hidden"></input>
                            </input>
                        </td>
                    </tr>
                    <tr runat="server" id="plusTR2">
                        ...
                        <td valign="top" align="left" class="PopTableRightTD" style="padding-bottom: 5px; background-color: White;" runat="server">
                            ...
                            <input id="hidePlus2" runat="server" type="hidden" />
                            </input>
                            <input id="hideOldPlus2" runat="server" type="hidden"></input>
                            </input>
                        </td>
                    </tr>
                    <tr runat="server" id="plusTR3">
                        ...
                        <td valign="top" align="left" class="PopTableRightTD" style="border-bottom-style: none; padding-bottom: 5px; background-color: White;" runat="server">
                            ...
                            <input id="hidePlus3" runat="server" type="hidden" />
                            </input>
                            <input id="hideOldPlus3" runat="server" type="hidden"></input>
                            </input>
                        </td>
                    </tr>
                    <tr runat="server" id="plusTR4" visible="False">
                        ...
                        <td valign="top" align="left" class="PopTableRightTD" style="border-bottom-style: none; padding-bottom: 5px; background-color: White;" runat="server">
                            ...
                            <input id="hidePlus4" runat="server" type="hidden" />
                            </input>
                            <input id="hideOldPlus4" runat="server" type="hidden"></input>
                            </input>
                        </td>
                    </tr>
                    <tr runat="server" id="plusTR5" visible="False">
                        ...
                        <td valign="top" align="left" class="PopTableRightTD" style="border-bottom-style: none; padding-bottom: 5px; background-color: White;" runat="server">
                            ...
                            <input id="hidePlus5" runat="server" type="hidden" />
                            </input>
                            <input id="hideOldPlus5" runat="server" type="hidden"></input>
                            </input>
                        </td>
                    </tr>
                    <tr runat="server" id="plusTR6" visible="False">
                        ...
                        <td valign="top" align="left" class="PopTableRightTD" style="border-bottom-style: none; padding-bottom: 5px; background-color: White;" runat="server">
                            ...
                            <input id="hidePlus6" runat="server" type="hidden" />
                            </input>
                            <input id="hideOldPlus6" runat="server" type="hidden"></input>
                            </input>
                        </td>
                    </tr>
                    <tr runat="server" id="plusTR7" visible="False">
                        ...
                        <td valign="top" align="left" class="PopTableRightTD" style="border-bottom-style: none; padding-bottom: 5px; background-color: White;" runat="server">
                            ...
                            <input id="hidePlus7" runat="server" type="hidden" />
                            </input>
                            <input id="hideOldPlus7" runat="server" type="hidden"></input>
                            </input>
                        </td>
                    </tr>
                    <tr runat="server" id="plusTR8" visible="False">
                        ...
                        <td valign="top" align="left" class="PopTableRightTD" style="border-bottom-style: none; padding-bottom: 5px; background-color: White;" runat="server">
                            ...
                            <input id="hidePlus8" runat="server" type="hidden" />
                            </input>
                            <input id="hideOldPlus8" runat="server" type="hidden"></input>
                            </input>
                        </td>
                    </tr>
                    <tr runat="server" id="plusTR9" visible="False">
                        ...
                        <td valign="top" align="left" class="PopTableRightTD" style="border-bottom-style: none; padding-bottom: 5px; background-color: White;" runat="server">
                            ...
                            <input id="hidePlus9" runat="server" type="hidden" />
                            </input>
                            <input id="hideOldPlus9" runat="server" type="hidden"></input>
                            </input>
                        </td>
                    </tr>
                </table>
        ...
        <tr>
            ...
            <td>
                <asp:RadioButtonList ID="rblSex" runat="server" RepeatDirection="Horizontal" meta:resourcekey="rblSexResource1">
                    <asp:ListItem Selected="True" Value="M" Text="男" meta:resourcekey="ListItemResource1"></asp:ListItem>
            ...
            <td>
                <telerik:RadDatePicker ID="chooserBirth" runat="server" SkinID="AllowEmpty" Culture="zh-TW" meta:resourcekey="chooserBirthResource2">
<Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" EnableWeekends="True" Culture="zh-TW" FastNavigationNextText="&amp;lt;&amp;lt;"></Calendar>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" CssClass=""></DatePopupButton>
        ...
        <tr>
            ...
            <td>
                <telerik:RadDatePicker ID="chooserArrive" runat="server" SkinID="AllowEmpty" Culture="zh-TW" meta:resourcekey="chooserArriveResource2">
<Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" EnableWeekends="True" Culture="zh-TW" FastNavigationNextText="&amp;lt;&amp;lt;"></Calendar>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" CssClass=""></DatePopupButton>
        ...
        <asp:Panel runat="server" ID="Panel_104HRModel">
        <tr>
            <td style="white-space:nowrap">
                <asp:Label ID="lblComponyNo" runat="server" Text="公司別" meta:resourcekey="lblComponyNoResource1"></asp:Label>
            </td>
            <td>
        ...
        <tr>
            ...
            <td style="white-space:nowrap">
                <asp:Label ID="Label18" runat="server" Text="MSN信箱" meta:resourcekey="Label18Resource1"></asp:Label>
            </td>
            <td>
                <asp:TextBox ID="txtMsn" runat="server" MaxLength="255" meta:resourcekey="txtMsnResource1"></asp:TextBox>
            </td>
        </tr>
        <tr>
            <td style="white-space:nowrap">
        ...
        <tr>
            ...
            <td>
                <asp:UpdatePanel ID="UpdatePanel4" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                        <asp:Image ID="imgBigPicture" runat="server" Height="100px" Width="100px" meta:resourcekey="imgBigPictureResource1" />
                        <br />
            ...
            <td style="height: 80px;">
                <asp:TextBox ID="txtSign" runat="server" TextMode="MultiLine" MaxLength="3" Width="100%"
    ...
    <input id="hideAD" type="hidden" runat="server" />
