...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%" class="PopTable" cellspacing="1">
        ...
        <tr>
            ...
            <td>
                <asp:CheckBox ID="cbExpire" runat="server" meta:resourcekey="cbExpireResource1" />
            </td>
        </tr>
        <tr>
            <td style="white-space: nowrap">
            ...
            <td>
                <asp:CheckBox ID="cbLock" runat="server" meta:resourcekey="cbLockResource1" />
            </td>
        </tr>
        <tr>
            <td style="white-space: nowrap">
        ...
        <tr>
            ...
            <td style="vertical-align: top">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <uc1:DepartmentTree ID="DepartmentTree1" runat="server" />
                    </ContentTemplate>
                </asp:UpdatePanel>
