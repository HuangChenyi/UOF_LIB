<%@ Page Title="批次更新期別資料" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="ImportDutySettTypeData.aspx.cs" Inherits="System_Organization_Employee_ImportDutySettTypeData" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <table class="PopTable" cellspacing="1">
        <tr>
            ...
            <td>
                ...
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/System/Organization/Employee/Import_DutySettTypeData_Sample.xls" Text="下載Excel範例" Target="_blank" meta:resourcekey="HyperLink1Resource2"></asp:HyperLink>
            </td>
        </tr>
        </table>
    ...
    <asp:Label ID="lblMsgDutySettNotFound" runat="server" Text="差勤結算類別不存在，請先至差勤結算處理頁面新增資料。" Visible="False" meta:resourcekey="lblMsgDutySettNotFoundResource2" ></asp:Label>
