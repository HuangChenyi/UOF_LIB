    ...
    <script>
        function checkAddress() {
            ...
            if (cbxAddress.prop("checked")) {
                ...
                txtPermanentZip.attr("disabled", true);
                txtPermanentAddr.attr("disabled", true);
            }
            else {

                txtPermanentZip.attr("disabled", false);
                txtPermanentAddr.attr("disabled", false);
            }
        }
        ...
        function checkPhone() {
            ...
            if (cbPhone.prop("checked")) {
                ...
                txtPermanentPhone.attr("disabled", true);
            }
            else {

                txtPermanentPhone.attr("disabled", false);
            }
        }
            ...
            <td>
                <table class="PopTable" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td style="white-space: nowrap; vertical-align: middle;" rowspan="2">
                            <asp:Label ID="Label54" runat="server" Text="照片" meta:resourcekey="Label54Resource1"></asp:Label>
                        </td>
                        <td style="white-space: nowrap; width: 25%" rowspan="2">
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:DropDownList ID="ddlCostCenter" runat="server" meta:resourcekey="ddlCostCenterResource1">
                            </asp:DropDownList>
                        </td>
                    </tr>
                    <tr>
                        ...
                        <td class="PopTableRightTD" colspan="4">
                            <table class="PopTable" cellpadding="0" cellspacing="1">
                                ...
                                <tr>
                                    ...
                                    <td class="PopTableRightTD" style="text-align: left">
                                        <telerik:RadDatePicker ID="wdcFatherAge" runat="server" SkinID="AllowEmpty" Culture="zh-TW" meta:resourcekey="wdcFatherAgeResource1">
...
<DatePopupButton ImageUrl="" HoverImageUrl="" CssClass=""></DatePopupButton>
                                ...
                                <tr>
                                    ...
                                    <td class="PopTableRightTD" style="text-align: left">
                                        <telerik:RadDatePicker ID="wdcMotherAge" runat="server" SkinID="AllowEmpty" Culture="zh-TW" meta:resourcekey="wdcMotherAgeResource1">
<Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" EnableWeekends="True" Culture="zh-TW" FastNavigationNextText="&amp;lt;&amp;lt;"></Calendar>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" CssClass=""></DatePopupButton>
                                ...
                                <tr>
                                    ...
                                    <td class="PopTableRightTD" style="text-align: left">
                                        <telerik:RadDatePicker ID="wdcSpouseAge" runat="server" SkinID="AllowEmpty" Culture="zh-TW" meta:resourcekey="wdcSpouseAgeResource1">
<Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" EnableWeekends="True" Culture="zh-TW" FastNavigationNextText="&amp;lt;&amp;lt;"></Calendar>
                    ...
                    <tr>
                        ...
                        <td class="PopTableRightTD" colspan="3">
                            <table cellpadding="0" cellspacing="0">
                                <tr>
                                    <td>
                                        <telerik:RadDatePicker ID="wdcMilitaryFrom" runat="server" SkinID="AllowEmpty" Culture="zh-TW" meta:resourcekey="wdcMilitaryFromResource1">
<Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" EnableWeekends="True" Culture="zh-TW" FastNavigationNextText="&amp;lt;&amp;lt;"></Calendar>
...
<DatePopupButton ImageUrl="" HoverImageUrl="" CssClass=""></DatePopupButton>
                                    ...
                                    <td>
                                        <telerik:RadDatePicker ID="wdcMilitaryTo" runat="server" SkinID="AllowEmpty" Culture="zh-TW" meta:resourcekey="wdcMilitaryToResource1">
<Calendar UseRowHeadersAsSelectors="False" UseColumnHeadersAsSelectors="False" EnableWeekends="True" Culture="zh-TW" FastNavigationNextText="&amp;lt;&amp;lt;"></Calendar>
                                                ...
                                                <Fast:Grid ID="gridExp" runat="server" DataKeyNames="EXP_GUID" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        <asp:TemplateField HeaderText="服務單位" meta:resourcekey="TemplateFieldResource1">
                                                            <ItemTemplate>
                                                                <asp:LinkButton ID="lbtnModify" runat="server" CommandName="lbtnModify" Text='<%# Bind("COMPANY") %>' meta:resourcekey="lbtnModifyResource1"></asp:LinkButton>
                                                            </ItemTemplate>
                                                        ...
                                                        <asp:BoundField HeaderText="是否擔任主管職" DataField="MANAGE" meta:resourcekey="BoundFieldResource3" />
                                            ...
                                            <td>
                                                <Fast:Grid ID="gridEdu" runat="server" DataKeyNames="EDU_GUID" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField HeaderText="畢業/肄業" DataField="GRADUATED" meta:resourcekey="BoundFieldResource12" />
                                                        <asp:BoundField HeaderText="教育程度(學位)" DataField="LEVEL" meta:resourcekey="BoundFieldResource13" />
                                            ...
                                            <td>
                                                <Fast:Grid ID="gridLicense" runat="server" DataKeyNames="LICE_GUID" EmptyDataText="沒有資料" meta:resourcekey="gridLicenseResource1"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="TYPE_NAME" HeaderText="類別" meta:resourcekey="BoundFieldResource15">
                                                        ...
                                                        <asp:BoundField DataField="EFFE_DATE" HeaderText="有效期限" DataFormatString="{0:yyyy/MM/dd}"
                                            ...
                                            <td>
                                                <Fast:Grid ID="gridLang" runat="server" AllowSorting="True" AutoGenerateCheckBoxColumn="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="LISTENING" HeaderText="聽" meta:resourcekey="BoundFieldResource26">
                                                            <ItemStyle Width="60px" HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="SPEAKING" HeaderText="說" meta:resourcekey="BoundFieldResource27">
                                                            <ItemStyle Width="60px" HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="READING" HeaderText="讀" meta:resourcekey="BoundFieldResource28">
                                                            <ItemStyle Width="60px" HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                                        <asp:BoundField DataField="WRITING" HeaderText="寫" meta:resourcekey="BoundFieldResource29">
                                                            <ItemStyle Width="60px" HorizontalAlign="Left" />
                                                        </asp:BoundField>
                                            ...
                                            <td>
                                                <Fast:Grid ID="gridPref" runat="server" DataKeyNames="PERF_GUID" AllowSorting="True"
                                                    ...
                                                    <Columns>
                                                        ...
                                                        <asp:BoundField DataField="RANK" HeaderText="等次" meta:resourcekey="BoundFieldResource31" />
