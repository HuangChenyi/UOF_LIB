<%@ Page Title="匯出人員" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="System_Organization_Employee_ExportEmployeeExcelHierarchical" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="ExportEmployeeExcelHierarchical.aspx.cs" %>

<%@ Register Src="../../../Common/Organization/Hierarchical_Department.ascx" TagName="Hierarchical_Department" TagPrefix="uc2" %>
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%" class="PopTable" cellspacing="1">
        <tr>
            <td nowrap="noWrap" width="1%">
                <asp:Label ID="Label2" runat="server" Text="包含帳號過期人員" meta:resourcekey="Label2Resource1"></asp:Label></td>
            <td>
                <asp:CheckBox ID="cbExpire" runat="server" meta:resourcekey="cbExpireResource1" /></td>
        </tr>
        <tr>
            <td nowrap="noWrap" width="1%">
                <asp:Label ID="Label3" runat="server" Text="包含帳號被鎖定人員" meta:resourcekey="Label3Resource1"></asp:Label></td>
            <td>
                <asp:CheckBox ID="cbLock" runat="server" meta:resourcekey="cbLockResource1" /></td>
        </tr>
        <tr>
            <td nowrap="noWrap" width="1%">
                <asp:Label ID="Label4" runat="server" Text="包含帳號被停用人員" meta:resourcekey="Label4Resource1"></asp:Label></td>
            <td>
                <asp:CheckBox ID="cbSuspend" runat="server"
                    meta:resourcekey="cbSuspendResource1" /></td>
        </tr>
        <tr>
            <td nowrap="noWrap" width="1%">
            ...
            <td valign="top">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        <uc2:Hierarchical_Department ID="Hierarchical_Department1" runat="server" />
                    </ContentTemplate>
                </asp:UpdatePanel>
            </td>
        </tr>
