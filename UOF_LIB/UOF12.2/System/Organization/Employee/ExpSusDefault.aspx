            ...
            <table cellpadding="0" cellspacing="0" width="100%">
                ...
                <tr>
                    <td>
                        ...
                        <Fast:Grid ID="grdExpSus" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateCheckBoxColumn="False" AutoGenerateColumns="False" CustomDropDownListPage="False" DataKeyOnClientWithCheckBox="False" DefaultSortDirection="Ascending" EmptyDataText="沒有資料" EnhancePager="True" KeepSelectedRows="False" meta:resourceKey="grdExpSusResource1" OnPageIndexChanging="grdExpSus_PageIndexChanging" OnRowDataBound="grdExpSus_RowDataBound" OnSorting="grdExpSus_Sorting" PageSize="15" SelectedRowColor="" UnSelectedRowColor="" Width="100%">
