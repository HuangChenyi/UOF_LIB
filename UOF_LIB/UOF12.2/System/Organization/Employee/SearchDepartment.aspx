<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="System_Organization_Employee_SearchDepartment" Title="搜尋部門" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="SearchDepartment.aspx.cs" %>
    ...
    <Fast:Grid ID="Grid1" runat="server" AllowSorting="True" AutoGenerateCheckBoxColumn="False" AutoGenerateColumns="False" OnRowDataBound="Grid1_RowDataBound" Width="100%" meta:resourcekey="Grid1Resource1" DataKeyOnClientWithCheckBox="False" AllowPaging="True" OnPageIndexChanging="Grid1_PageIndexChanging">
        <Columns>
            ...
            <asp:TemplateField HeaderText="部門名稱" meta:resourcekey="TemplateFieldResource2">
                <ItemTemplate>
                    <asp:LinkButton runat="server" ID="LinkButton1" Text='<%# Bind("GROUP_NAME") %>' CommandName="return" meta:resourceKey="LinkButton1Resource1" __designer:wfdid="w16" OnCommand="LinkButton1_Command"></asp:LinkButton>
