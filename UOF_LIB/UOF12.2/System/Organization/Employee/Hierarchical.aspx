...
<asp:Content ID="Content2" ContentPlaceHolderID="ScriptContentPlaceHolder" runat="Server">
    <script type="text/javascript">
        ...
        function RadToolBar1_HR_ButtonClicking(sender, args) {
            ...
            if (Key === "AddEmployee") {
                var groupObj = $("#<%=hfddlClientID.Value%>");
            ...
            args.set_cancel(true);
            $uof.dialog.open2("~/System/Organization/Department/HierarchicalDepartment.aspx", args.get_item(), "", 500, 600, OpenDeptDialogResult, { "groupId": m_groupId, "focusNode": groupId });
        }
        else if (Key === "EmpMove") {
            var groupObj = $("#<%=hfddlClientID.Value%>");
            var m_groupId = groupObj.val();
            ...
            if (node !== null) {
                ...
                var keyword = $("#<%=hftxtClientID.Value%>").val();
                if (keyword === "") {
...
<asp:Content ID="Content4" ContentPlaceHolderID="LeftContentPlaceHolder" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional" ChildrenAsTriggers="False">
        <ContentTemplate>
            <uc1:Hierarchical_Department ID="HRDepartmentTree" runat="server" Width="300px" Height="600px" />
