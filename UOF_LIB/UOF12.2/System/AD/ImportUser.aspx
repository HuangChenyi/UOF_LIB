...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
            ...
            <input id="hidADServerIP" type="hidden" runat="server" />
            <input id="hidADUser" type="hidden" runat="server" />
            <input id="hidPW" type="hidden" runat="server" />
            <input id="hidIsSearch" type="hidden" runat="server" />
