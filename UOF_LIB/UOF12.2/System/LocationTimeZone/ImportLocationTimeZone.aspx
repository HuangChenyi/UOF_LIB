<%@ Page Title="匯入歸屬地點" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" CodeBehind="ImportLocationTimeZone.aspx.cs" Inherits="System_Organization_LocationTimeZone_ImportLocationTimeZone" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" %>
    ...
    <table width="100%" class="PopTable">
        <tr>
            <td style="white-space:nowrap">
                <asp:Label ID="lblImportLocation" runat="server" Text="匯入歸屬地點" meta:resourcekey="lblImportLocationResource1"></asp:Label>
            </td>        
            <td>
                <uc1:UC_FileCenter runat="server" id="UC_FileCenter" allowedfiletype="Excel" allowedmultiplefileselection="false" />
                <asp:HyperLink ID="HyperLink1" runat="server" NavigateUrl="~/System/LocationTimeZone/Import_Location_Sample.xls" Text="下載Excel範例" Target="_blank" meta:resourcekey="btnDownloadResource1"></asp:HyperLink>
            </td>
        </tr>
    </table>
