...
<asp:Content ID="Content2" ContentPlaceHolderID="LeftContentPlaceHolder" runat="Server">
    <asp:UpdatePanel ID="UpdatePanel1" runat="server" RenderMode="Inline" UpdateMode="Conditional" ChildrenAsTriggers="False">
        <ContentTemplate>
            <telerik:RadTreeView ID="RadTreeView1" runat="server" OnNodeClick="RadTreeView1_NodeClick" meta:resourcekey="RadTreeView1Resource1"></telerik:RadTreeView>
        </ContentTemplate>
    </asp:UpdatePanel>
</asp:Content>
                ...
                <table class="PopTable" width="100%" cellspacing="1">
                    <tr>
                        ...
                        <td>
                            ...
                            <asp:Label ID="lblRequireMenuTextMsg" runat="server" Text="此為必要欄位" Font-Bold="True"
                                ...
                                <Fast:Grid ID="Grid1" runat="server" AutoGenerateCheckBoxColumn="True" AutoGenerateColumns="False"
                                    ...
                                    <Columns>
                                        <asp:TemplateField HeaderText="參數名稱" meta:resourcekey="TemplateFieldResource1">
                                            <ItemTemplate>
                                                <asp:LinkButton ID="lbName" runat="server" Text='<%# Bind("NAME") %>' OnClick="lbName_Click"
                                                    meta:resourcekey="lbNameResource1"></asp:LinkButton>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                                        <asp:TemplateField HeaderText="資料來源" meta:resourcekey="TemplateFieldResource2">
                                            <ItemTemplate>
                                                <asp:Label ID="lbSource" runat="server" Text='<%# Bind("SOURCE") %>' meta:resourcekey="lbSourceResource1"></asp:Label>
                                            </ItemTemplate>
                                        </asp:TemplateField>
                    ...
                    <tr id="htmleditor" runat="server">
                        ...
                        <td runat="server">                            
                            ...
                            <asp:Label ID="lblHtml" runat="server" meta:resourcekey="lblHtmlResource1"></asp:Label>       
