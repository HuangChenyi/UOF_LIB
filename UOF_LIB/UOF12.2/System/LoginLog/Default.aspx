                                    ...
                                    <table>
                                        <tr>
                                            ...
                                            <td style="padding-left:0px; padding-right:2px">
                                                <telerik:RadDatePicker ID="rdpStartTime" runat="server" Culture="zh-TW" 
                                            ...
                                            <td style="padding-left:0px; padding-right:2px">
                                                <telerik:RadDatePicker ID="rdpEndTime" runat="server" Culture="zh-TW" 
                        ...
                        <ContentTemplate>
                            <Fast:Grid ID="DGFormList" runat="server" AllowPaging="True" AutoGenerateCheckBoxColumn="False"
                                ...
                                meta:resourcekey="DGFormListResource2"  
                                 DefaultSortColumnName="TIME" CustomDropDownListPage="False" SelectedRowColor="" UnSelectedRowColor="">
                                <EnhancePagerSettings ShowHeaderPager="True" />
                                <ExportExcelSettings AllowExportToExcel="False" />
                                <Columns>
                                    <asp:TemplateField HeaderText="使用者名稱" meta:resourcekey="TemplateFieldResource1" SortExpression="NAME">
                                        <ItemTemplate>
                                    ...
                                    <asp:TemplateField HeaderText="時間" SortExpression="TIME" meta:resourcekey="TemplateFieldResource2">
                                        <EditItemTemplate>
                                            <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("TIME") %>' meta:resourcekey="TextBox1Resource1"></asp:TextBox>
                                        </EditItemTemplate>
                                        <ItemTemplate>
                                            <asp:Label ID="lblTime" runat="server" Text='<%# Bind("TIME") %>' meta:resourcekey="lblTimeResource1"></asp:Label>
                                        </ItemTemplate>
                                    </asp:TemplateField>
                                    <asp:BoundField DataField="IP" HeaderText="IP" meta:resourcekey="BoundFieldResource3"
                                        SortExpression="IP" />
                                </Columns>
                            </Fast:Grid>
                        </ContentTemplate>
