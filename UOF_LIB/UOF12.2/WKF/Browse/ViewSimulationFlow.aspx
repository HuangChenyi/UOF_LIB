...
<asp:Panel ID="pnlActual" runat="server" meta:resourcekey="pnlActualResource1">
        ...
        <ExportExcelSettings AllowExportToExcel="False"></ExportExcelSettings>
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="簽核意見" meta:resourcekey="TemplateFieldResource1">
                        <ItemTemplate>
                    ...
                    <asp:TemplateField HeaderText="簽核時間" meta:resourcekey="BoundFieldResource4" >
                        <ItemTemplate>
                            <asp:Label ID="lblSignTime" runat="server"></asp:Label>
                        </ItemTemplate>
                    <ItemStyle Width="120px" HorizontalAlign="Center" />
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="簽核狀態" meta:resourcekey="TemplateFieldResource2"> 
                        <ItemTemplate>
    ...
    <asp:Panel ID="pnlSimulation" runat="server" 
        ...
        <ExportExcelSettings AllowExportToExcel="False"></ExportExcelSettings>
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="簽核型態" meta:resourcekey="TemplateFieldResource3">
                        <ItemTemplate>
...
<asp:Label ID="lblFieldFlowSite" runat="server" Text="組織欄位站點" Visible="false"></asp:Label>
<asp:Label ID="lblAlertSite" runat="server" Text="知會站點" Visible="false"></asp:Label>
<asp:Label ID="lblSkipped" runat="server" Text="(自動簽核)" Visible="false"></asp:Label>    
