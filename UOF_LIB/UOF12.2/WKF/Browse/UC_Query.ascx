...
<asp:Panel ID="Panel1" runat="server" Width="100%" Visible="False" meta:resourcekey="Panel1Resource1">
    <table class="PopTable" cellspacing="1" width="100%" >
        <tr>
            ...
            <center>
                <asp:Label ID="lblSpecialQuery" runat="server" Text="進階查詢" meta:resourcekey="lblSpecialQueryResource1"></asp:Label></center></td>
        </tr>
        ...
        <tr>
            ...
            <td style="height: 25px;" align="left" class="PopTableRightTD">
                ...
                <asp:Label ID="lblMsgChoice" runat="server" ForeColor="Red" Text="請選擇表單" meta:resourcekey="lblMsgChoiceResource1"></asp:Label>       </td>          
        </tr>
        <tr>
