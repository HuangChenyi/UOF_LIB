...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script id="DesignFormFlowJS" type="text/javascript">
        ...
        function SaveFlowName() {
            $uof.dialog.open2("~/WKF/ExternalModule/ModifyMasterFlowName.aspx", this, "", 400, 200, openDialogResult, { "formVersionId": "<%=formVersionId%>", "masterFlowId": "<%=flowId%>" });
            return false;
        }
    ...
    <script type="text/javascript" id="telerikClientEvents1">
        function RadToolBar1_ButtonClicking(sender, args) {
            ...
            if (value == "ModifyMasterFlow") {//維護主流程
                ...
                $uof.dialog.open2("~/WKF/FlowManagement/SetupMasterFlow.aspx", args.get_item(), "", 800, 800, openDialogResult, { "formVersionId": "<%=formVersionId%>", "masterFlowId": "<%=flowId%>" });
            }
    ...
    <table width="100%">
        ...
        <tr>
            <td align="center" style="height: 71px;">
                ...
                <asp:Panel ID="Panel1" ScrollBars="Auto" runat="server" Width="885px" meta:resourcekey="Panel1Resource1" Height="565">
                    <table>
                        <tr>
                            <td>
