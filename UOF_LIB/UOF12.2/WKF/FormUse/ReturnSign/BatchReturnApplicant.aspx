                ...
                <tbody>
                    <tr>
                        ...
                        <td style="text-align: left; width: 35%; vertical-align: middle">
                            <telerik:RadDatePicker ID="radDateStart" runat="server" Culture="zh-TW" meta:resourcekey="radDateStartResource1">
                            ...
                            ~
                            &nbsp;
                            <telerik:RadDatePicker ID="radDateEnd" runat="server" Culture="zh-TW" meta:resourcekey="radDateEndResource1">
                                <Calendar EnableWeekends="True" UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False">
                                </Calendar>
                                <DateInput DateFormat="yyyy/M/d" DisplayDateFormat="yyyy/M/d" LabelWidth="64px" Width="">
                                    <EmptyMessageStyle Resize="None" />
            ...
            <table style="width:100%">
                <tr>
                    <td style="text-align:left">
                         <asp:Label ID="lblErrorMsg" runat="server" Text="筆資料退簽失敗" Visible="False" ForeColor="Red" BackColor="White" meta:resourcekey="lblErrorMsgResource1"></asp:Label>
                    </td>
                </tr>
