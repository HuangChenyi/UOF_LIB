        ...
        $(function () {
            ...
            try {
                ...
                if (actionMode == "NextSite" || actionMode == "ReturnSign") {
                    $uof.dialog.open2('<%=confirmWinUrl%>', '', '<%= dialogTitleName%>', '<%=confirmWinWidth%>', '<%=confirmWinHeight%>', signDialogResult);
        ...
        function OnBarMainClick(sender, args) {
            ...
            else if (args.get_item().get_value() == "PrintForm")
            {
               //args.set_cancel(true);
                ...
                ajaxManager.ajaxRequest(JSON.stringify({ "Key": "FormPrint", "Value": "" }));
                --%>
