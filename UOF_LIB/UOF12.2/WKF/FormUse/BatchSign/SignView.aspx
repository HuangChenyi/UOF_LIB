<%@ Page Title="批次簽核" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_FormUse_BatchSign_SignView" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="SignView.aspx.cs" %>


<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript" src="BatchSign.js"></script>
    <script type="text/javascript">
        function CustSign(labelId,sender) 
        {
            ...
            this.enabled =false;
            $uof.dialog.open2("~/WKF/FormUse/FreeTask/SignNodeForm.aspx",sender,'',<%=signWindowWidth%>,<%=signWindowHeight%>,function(){return true;},{'TASK_ID':taskId,'SITE_ID':siteId,'NODE_SEQ':nodeSeq});
            return false;
        }
                    ...
                    if (objEle.prop("name")== s[0]) 
                    {
                        ...
                        else 
                        {
                            ...
                            switch (s[2]) 
                            {
                                ...
                                case "11" : label.html( "<br><%=lbl_Fail.Text%><%=lbl_AdditionalSiteMsg.Text%>"); break;
        ...
        {
            var o = $("#<%=radToolbar1.Items.FindItemByValue("radBtnItems").FindControl("ddlFormList").ClientID%>");
            location.href = "SignView.aspx?formId=" + o.val();
        }
    ...
    <div id="layer0" style="width:100%;height:5%; border: 0px;">
        ...
        <table border="0">
            <tr>
                ...
                <td>
                    <asp:DropDownList ID="ddlFormList" runat="server"
                        onchange="changeFormCategory();" meta:resourcekey="ddlFormListResource1">
                    </asp:DropDownList>
                    &nbsp;&nbsp;&nbsp;
    ...
    <asp:Label ID="lbl_AdditionalSiteMsg" Text="加簽站點不支援批次簽核" Visible="False" runat="server" meta:resourcekey="lbl_AdditionalSiteMsgResource1"></asp:Label>
