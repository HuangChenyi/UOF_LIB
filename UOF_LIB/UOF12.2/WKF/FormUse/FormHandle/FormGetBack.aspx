...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <table>
        <tr>
            <td>
                <asp:CustomValidator ID="cvError" runat="server" Display="Dynamic" ErrorMessage="請輸入草稿名稱"
 meta:resourcekey="cvErrorResource1"></asp:CustomValidator>
            </td>
        </tr>
        <tr>
            <td>
                        <asp:CustomValidator ID="cvCancelForm" runat="server" Display="Dynamic" ErrorMessage="作廢原因必填"
 ></asp:CustomValidator>
            </td>
        </tr>
    </table>
    ...
    <asp:Label ID="lblFormEnd" runat="server" Text="此表單已結案，無法取回" Visible="False" meta:resourcekey="lblFormEndResource1"></asp:Label>
