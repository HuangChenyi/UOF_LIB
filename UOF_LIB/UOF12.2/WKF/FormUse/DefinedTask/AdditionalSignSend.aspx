<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_FormUse_DefinedTask_AdditionalSignSend" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" Codebehind="AdditionalSignSend.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script id="AdditionalSignSendjs" type="text/javascript">
        function RadToolBar1_ButtonClicking(sender, args) {
            ...
            if (value == "ReturnForm") {
                ...
                args.set_cancel(true);
                $uof.dialog.open2("~/WKF/Custom/SelectCustSite.aspx", args.get_item(), args.get_item().get_text(), 1280, 1080, openDialogResult, { "custSiteId": "<%=HiddenCustSiteId.Value%>" });
            }
        }
...
<div style="display:none">
    ...
    <asp:Panel ID="panelAgent" runat="server" Width="100%" meta:resourcekey="panelAgentResource1">
        <asp:Label ID="lblMsgAgentExcept" runat="server" ForeColor="Red" Text="!下列人員有啟動代理設定，但系統找不到他的代理人，如果您堅持送出，系統將只會送給原簽核者!" Visible="False" EnableViewState="False" meta:resourcekey="lblMsgAgentExceptResource1"></asp:Label><br>
