<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_FormUse_DefinedTask_OtherSiteSend_Parallel" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="OtherSiteSend_Parallel.aspx.cs" %>
...
<style type="text/css"> 
    ...
    <telerik:RadToolBar ID="webToolBar" runat="server" OnClientButtonClicking="OnBarMainClick"
        ...
        <Items>
            <telerik:RadToolBarButton runat="server" meta:resourceKey="TBarButtonResource1" CheckedImageUrl="~/Common/Images/Icon/icon_m101.gif"
