<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_FormUse_DefinedTask_OtherSiteSend" Title="表單簽核" Culture="auto" UICulture="auto" meta:resourcekey="PageResource1" Codebehind="OtherSiteSend.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script id="OtherSiteSendjs" type="text/javascript">
        function OnBarMainClick(sender, args) {
            if (args.get_item().get_value() == "ReturnForm") {
                ...
                args.set_cancel(true);
                $uof.dialog.open2("~/WKF/Custom/SelectCustSite.aspx?custSiteId=" + '<%=HiddenCustSiteId.Value%>', args.get_item(), args.get_item().get_text(), 1280, 1080, openDialogResult);
            }
            else if (args.get_item().get_value() == "GroupSite") {
                args.set_cancel(true);
                $uof.dialog.open2("~/WKF/Custom/SelectGroupSite.aspx?srcSiteId=" + '<%= HiddenSrcSiteId.Value %>' + "&taskId=" + '<%= taskId%>', args.get_item(), args.get_item().get_text(), 1280, 1080, openDialogResult);
                }
            }
        ...
        function NotifyAdmin(taskId) {
            $uof.dialog.open2("~/WKF/FormUse/DefinedTask/NotifyAdmin.aspx", '', '', 255, 320, openDialogResult, { 'taskId': taskId });
        }
    ...
    <telerik:RadToolBar ID="webToolBar" runat="server" OnClientButtonClicking="OnBarMainClick"
        ...
        <Items>
            <telerik:RadToolBarButton runat="server"  CausesValidation="false"  meta:resourceKey="TBarButtonResource1" CheckedImageUrl="~/Common/Images/Icon/icon_m101.gif"
                DisabledImageUrl="~/Common/Images/Icon/icon_m101.gif" HoveredImageUrl="~/Common/Images/Icon/icon_m101.gif"
            ...
            <telerik:RadToolBarButton runat="server" CausesValidation="false" meta:resourceKey="TBarButtonResource2" Visible="false"
                CheckedImageUrl="~/Common/Images/Icon/icon_m10.gif" DisabledImageUrl="~/Common/Images/Icon/icon_m101.gif"
                HoveredImageUrl="~/Common/Images/Icon/icon_m101.gif" ImageUrl="~/Common/Images/Icon/icon_m101.gif"
                Text="定義自訂流程" Value="CustSite">
            </telerik:RadToolBarButton>
            ...
            <telerik:RadToolBarButton runat="server" CausesValidation="false" meta:resourceKey="TBarButtonResource3" Visible="false"
                CheckedImageUrl="~/Common/Images/Icon/icon_m10.gif" DisabledImageUrl="~/Common/Images/Icon/icon_m101.gif"
                HoveredImageUrl="~/Common/Images/Icon/icon_m101.gif" ImageUrl="~/Common/Images/Icon/icon_m101.gif"
                Text="定義自選流程" Value="GroupSite">
            </telerik:RadToolBarButton>
    ...
    <table width="100%" class="PopTable" cellspacing="1">
        ...
        <tr>
            <td>
                <asp:Label ID="lblMasterFlow" runat="server" EnableViewState="False" Text="主流程" meta:resourcekey="lblMasterFlowResource1"></asp:Label>
            </td>
            <td>
                <asp:Panel ID="panelMasterSelect" runat="server" Width="100%" meta:resourcekey="panelMasterSelectResource1">
                    <asp:RadioButtonList ID="rblMasterFlow" runat="server" RepeatDirection="Horizontal"
            ...
            <td>
                <asp:Label ID="lobSubFlow" runat="server" EnableViewState="False" Text="副流程" meta:resourcekey="lobSubFlowResource1"></asp:Label>
            </td>
            <td>
                <asp:Panel ID="panelSubSelect" runat="server" Width="100%" meta:resourcekey="panelSubSelectResource1">
                    <asp:RadioButtonList ID="rblSubFlow" runat="server" RepeatDirection="Horizontal"
        ...
        <asp:Panel ID="PanelNextSite" runat="server" Width="100%" meta:resourcekey="PanelNextSiteResource1"
            CssClass="panelDiv">
            <tr>
                <td class="PopTableHeader" colspan="4" style="height: 25px; text-align: center">
                    <center>
                        <asp:Label ID="Label5" runat="server" Text="下一站點資訊" meta:resourcekey="Label5Resource1"></asp:Label></center>
                </td>
            </tr>
            <tr>
                <td>
                    <asp:Label ID="lblNextSiteSet" runat="server" EnableViewState="False" Text="簽核型態"
                        meta:resourcekey="lblNextSiteSetResource1"></asp:Label>
                </td>
                <td>
            ...
            <tr>
                <td>
                    <asp:Label ID="lblNextSiteSigner" runat="server" EnableViewState="False" Text="簽核人員"
                        meta:resourcekey="lblNextSiteSignerResource1"></asp:Label>
                </td>
                <td colspan="3">
    ...
    <asp:CustomValidator ID="CustomValidatorCustSite" runat="server" Display="Dynamic"
        ErrorMessage="下一站為自訂流程站點，請先定義自訂流程" meta:resourcekey="CustomValidatorCustSiteResource1"></asp:CustomValidator>
    <asp:CustomValidator ID="CustomValidatorGroupSite" runat="server" Display="Dynamic"
        ErrorMessage="下一站為自選流程站點，請先定義自選流程" meta:resourcekey="CustomValidatorGroupSiteResource1"></asp:CustomValidator>
    <asp:CustomValidator ID="CustomValidatorAdditionalSite" runat="server" Display="Dynamic"
    ...
    <asp:Panel ID="panelAgent" runat="server" Width="100%" meta:resourcekey="panelAgentResource1">
        <asp:Label ID="lblMsgAgentExcept" runat="server" ForeColor="Red" Text="!下列人員有啟動代理設定，但系統找不到他的代理人，如果您堅持送出，系統將只會送給原簽核者!"
            Visible="False" EnableViewState="False" meta:resourcekey="lblMsgAgentExceptResource1"></asp:Label><br>
        <asp:Label ID="lblAgentList" runat="server" ForeColor="Blue" Text="&lt;br&gt;" EnableViewState="False"
