                                                                    ...
                                                                    <tr>
                                                                        <td>
                                                                            <Fast:Grid ID="DGSignCommentList" runat="server" AllowSorting="True"
                                                                                ...
                                                                                EmptyDataText="沒有資料"
                                                                                KeepSelectedRows="False" meta:resourcekey="DGSignCommentListResource3">
                                                    ...
                                                    <table border="0" width="100%">
                                                        <tr>
                                                            <td valign="top" width="15%" nowrap="nowrap">
                                                                <asp:Label runat="server" ID="lblFile" meta:resourceKey="lblFileResource1" Text="相關附件："></asp:Label></td>
                                                            <td valign="top">
