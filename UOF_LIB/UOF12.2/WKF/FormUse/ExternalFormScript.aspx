...
<script id="ExternalFormScriptjs" type="text/javascript">
    ...
    function OnBarMainClick(sender, args) {
        if (args.get_item().get_value() == "ShowFlow") {
            ...
            $uof.dialog.open2("~/WKF/Browse/ViewMasterFlow.aspx", args.get_item(), "<%=dialogTitleName%>", 800, 650, openDialogResult,
                {
                        ...
                        <tbody>
                            <tr>
                                <td class="PopTableHeader""
                                    align="center" height="20px">
                                    <center>
                                    <asp:Label ID="Label5" runat="server" Text="相關附件" meta:resourcekey="Label5Resource1"></asp:Label>
                                    </center>
                                    </td>
                            </tr>
                            <tr>
                                ...
                                <div style=" width:100%; height:99%; overflow:auto;">
                                    <uc3:UC_FileCenter runat="server" ID="UC_FileCenter" ModuleName="WKF" ProxyEnabled="true"/>
--%>                                    </div>
                                </td>
                            </tr>
                        </tbody>
