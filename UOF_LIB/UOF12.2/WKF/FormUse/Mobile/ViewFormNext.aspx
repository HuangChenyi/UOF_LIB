<%@ Page Title="" Language="C#" MasterPageFile="~/Master/MobileMasterPage.master" AutoEventWireup="true" CodeBehind="ViewForm.aspx.cs" Inherits="Ede.Uof.Web.WKF.FormUse.Mobile.ViewForm" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/javascript">
        ...
        $(function () {
            //表單計算欄位
            try {
                if ("<%=Request["SignedStatus"] %>" == "IsSigned") {
                alert("<%=lblIsSigned.Text%>");
            } else if ("<%=Request["SignedStatus"] %>" == "IsCallFail") {
 ...
 function OnBarMainClick(sender, args)
{
    ...
    {
        args.set_cancel(true);
        $uof.dialog.open2('~/WKF/FormUse/SiteSignInfo.aspx', args.get_item(), '', 800, 650, function () { return false; }, {"TASK_ID":"<%=Request["TASK_ID"]%>","SITE_ID":"<%=Request["SITE_ID"]%>"});
                        ...
                        <Rows>
                                                ...
                                                <Rows>
                                                    ...
                                                    <telerik:LayoutRow ID="currentSignerRow" runat="server">
                                                        <Columns>
                                                            <telerik:LayoutColumn Span="12">
                                                                <label class="title">
                                                                    <asp:Literal ID="Literal2" runat="server" Text="現在處理者" meta:resourcekey="Label1Resource1"></asp:Literal></label>
                                                            </telerik:LayoutColumn>
                                                            <telerik:LayoutColumn Span="12">
                                                                <label>
                                                                    <asp:Literal ID="Label6" runat="server" meta:resourcekey="lblLockerResource1"></asp:Literal>
                                                                </label>
                                                            </telerik:LayoutColumn>
                                                        </Columns>
                                                    </telerik:LayoutRow>
                            ...
                            <telerik:LayoutRow RowType="Container" WrapperHtmlTag="Div">
                                <Columns>
                                    <telerik:CompositeLayoutColumn Span="12">
                                        <Content>
                                            <h3 class="blockheader"><asp:Label ID="lblForm" runat="server" Text="表單"></asp:Label></h3>
                                        </Content>
                                        <Rows>
                            ...
                            <telerik:LayoutRow RowType="Container" WrapperHtmlTag="Div">
                                <Columns>
                                    <telerik:CompositeLayoutColumn Span="12">
                                        <Content>
                                            <h3 class="blockheader">
                                                <asp:Label ID="lblFileUpload" runat="server" Text="相關附件" meta:resourcekey="lblFileUploadResource1"></asp:Label></h3>
                                        </Content>
                                        <Rows>
                                            <telerik:LayoutRow RowType="Generic" CssClass="content">
                                                <Columns>
                                                    <telerik:LayoutColumn Span="12">
                                                        ...
                                                        <div style="text-align: left">
                                                            <uc7:UC_FileCenter runat="server" id="UC_FileCenter" ProxyEnabled="true"/>
                                                        </div>
                                                    </telerik:LayoutColumn>
                                                </Columns>
                                            </telerik:LayoutRow>
                             ...
                             <telerik:LayoutRow RowType="Container" WrapperHtmlTag="Div">
                                <Columns>
                                    <telerik:CompositeLayoutColumn Span="12">
                                        <Content>
                                            <h3 class="blockheader"><asp:Label ID="lblFormFlow" runat="server" Text="表單流程" meta:resourcekey="lblFormFlowResource1"></asp:Label></h3>
                                        </Content>
                                        <Rows>
                                            <telerik:LayoutRow RowType="Generic" CssClass="content">
                                                <Columns>
        ...
        <tr>
            <td style="background-image: url(<%=themePath %>/images/wf_bg.gif);vertical-align:top">
                                                        ...
                                                        <tr>
                                                            <td style="background-color: white; height: 100%; margin: 0; padding: 0" valign="top">
                                                                ...
                                                                <table cellpadding="0" cellspacing="0" width="100%" runat="server" style="height: 135px; margin: 0; padding: 0">
                                                                    ...
                                                                    <tr>
                                                                        <td style="text-align: right; width: 35%;">
                                                                            <asp:Label ID="Label1" runat="server" Text="現在處理者：" meta:resourcekey="Label1Resource1"></asp:Label>
                                                                        </td>
                                                                        <td style="text-align: left">
                                            ...
                                            <tr>
                                                <td>
                                                    <asp:Panel ID="Panel1" runat="server" Width="100%" meta:resourcekey="Panel1Resource1">
                                                        <%--<uc1:VersionFieldCollectionUsingUC ID="VersionFieldCollectionUsingUC2" runat="server" />--%>
                                                    </asp:Panel>
                                                </td>
                                            </tr>
                                        </table>
                ...
                <asp:Label ID="lblNoSiteMessage" runat="server" Text="您無法簽核此表單(已被簽核過或無簽核權限)!" Visible="false"
                 ...
                 <asp:Label ID="lblNotAllowMobileSign" runat="server" Text="此表單不允許行動裝置簽核" Visible="false" ></asp:Label>
                <asp:Label ID="lblNodata" runat="server" Text="無法找到表單相關資訊" Visible="false" meta:resourcekey="lblNodataResource1"></asp:Label>
