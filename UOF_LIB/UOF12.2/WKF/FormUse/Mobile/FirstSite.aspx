    ...
    <script type="text/javascript" id="telerikClientEvents1">
        ...
        function RadToolBar1_ButtonClicking(sender, args) {
            ...
            if (value == "ForOpinion") {
                ...
                var ScriptID = "<%=hiddenScriptId.Value%>";
                var UserDept = "<%=hiddenUserDept.Value%>";
                var IsScriptIQY = 1;
                var agentUserGuid = '<%= Request["selectUserGUID"] %>';
                args.set_cancel(true);
        ...
        Sys.Application.add_load(function () {
            ...
            try {
                ...
                if (actionMode == "Send") {
                    ...
                    <%--window.location = '<%=confirmWinUrl%>';--%>

                    <%--uofapp_android.open_chrome('<%=confirmWinUrl%>');--%>
                    <%--location.replace('<%=confirmWinUrl%>');--%>
                    //window.close();
                   <%-- $uof.dialog.open2('<%=confirmWinUrl%>', '', '<%= dialogTitleName%>', '<%=confirmWinWidth%>', '<%=confirmWinHeight%>',
                        ...
                        <Rows>
                            ...
                            <telerik:LayoutRow RowType="Container" WrapperHtmlTag="Div">
                                <Columns>
                                    <telerik:CompositeLayoutColumn Span="12">
                                        <Content>
                                            <h3 class="blockheader"><asp:Label ID="Label10" runat="server" Text="表單附件" meta:resourcekey="Label10Resource1"></asp:Label></h3>
                                        </Content>
                                        <Rows>
                                                ...
                                                <Columns>
                                                    <telerik:LayoutColumn Span="12">
                                                        ...
                                                        <div style="text-align: left">
                                                            <uc7:UC_FileCenter runat="server" ID="UC_FileCenter1" ProxyEnabled="true" />
                                                        </div>
                                    ...
                                    <telerik:CompositeLayoutColumn Span="12">
                                        <Content><h3 class="blockheader"><asp:Label ID="Label11" runat="server" Text="個人附件" meta:resourcekey="Label11Resource1"></asp:Label></h3>
                                        </Content>
                                        <Rows>
                                            <telerik:LayoutRow RowType="Generic" CssClass="content nopadding">
                                                <Columns>
                                                    <telerik:LayoutColumn Span="12">
                                                        ...
                                                        <div style="text-align: left">
                                                            <uc7:UC_FileCenter runat="server" ID="UC_PersonalFileCenter" ProxyEnabled="true" />
                                                        </div>
                                                        <asp:HiddenField ID="lblPersonalFileGroupId" runat="server" />
                                                    </telerik:LayoutColumn>
                                                </Columns>
                                            </telerik:LayoutRow>
                                        </Rows>
...
<table width="96%" border="0" align="center" cellpadding="0" cellspacing="0">
  <tr>
    ...
    <asp:Label ID="lblAddSignComment" runat="server" Text="加入簽核意見" Visible="False" 
        meta:resourcekey="lblAddSignCommentResource1"></asp:Label>
