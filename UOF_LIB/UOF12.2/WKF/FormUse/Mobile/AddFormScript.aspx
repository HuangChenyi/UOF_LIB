                                    ...
                                    <telerik:CompositeLayoutColumn Span="12">
                                        ...
                                        <Rows>
                                            <telerik:LayoutRow RowType="Generic" CssClass="content nopadding">
                                                <Columns>
                                                    <telerik:LayoutColumn Span="12">
                                                        <asp:LinkButton ID="lbtnRemoteFileCenter" runat="server" ForeColor="OliveDrab" CausesValidation="False" Text="檔案操作" meta:resourcekey="lbtnRemoteFileCenterResource1"></asp:LinkButton>
