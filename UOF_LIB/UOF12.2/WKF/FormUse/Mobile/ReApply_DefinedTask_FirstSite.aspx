...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script id="mainjs" type="text/javascript">
        ...
        function OnBarMainClick(sender, args) {
            ...
            if (args.get_item().get_value() == "ReturnForm") {
                ...
                args.set_cancel(true);
                $uof.dialog.open2('~/WKF/Custom/SelectCustSite.aspx', args.get_item(), args.get_item().get_text(), 650, 600, openDialogResult, { "custSiteId": "<%=HiddenCustSiteId.Value%>" });
            }
            else if (args.get_item().get_value() == "GroupSite") {
                args.set_cancel(true);
                $uof.dialog.open2('~/WKF/Custom/SelectGroupSite.aspx', args.get_item(), args.get_item().get_text(), 700, 500, openDialogResult, { "srcSiteId": "<%=HiddenSrcSiteId.Value%>","taskId":"<%=taskId%>" });
            }
        }
    ...
    <asp:Label ID="lblNoSignerMsg" runat="server" EnableViewState="False" ForeColor="Red"
        Text="至少需有一名簽核人員，才能送往下一站點！" Visible="False" meta:resourcekey="lblNoSignerMsgResource1"></asp:Label>
                                                                ...
                                                                <asp:Label ID="lblEndSiteMsg" runat="server" Text="找不到下一站點！此人已是最未站點，按下送出即結案！" Visible="False"
                                                                ...
                                                                <asp:Label ID="lbeAgentMsg" runat="server" meta:resourcekey="lbeAgentMsgResource1"
                                                                    Text="下列人員有啟動代理設定，但系統找不到他的代理人，如果您堅持送出，系統將不會通知其代理人!" Visible="False"></asp:Label><asp:Label
                                                                        ID="lblSendMsg" runat="server" meta:resourcekey="lblSendMsgResource1" Text="表單 {0} 已建立"
                                                                        Visible="False"></asp:Label><asp:Label ID="lblFormNum" runat="server" meta:resourcekey="lblFormNumResource1"
                                                                            Text="表單編號為:" Visible="False"></asp:Label><asp:Label ID="lblGeneral" runat="server"
                                                                                meta:resourcekey="lblGeneralResource1" Text="一般" Visible="False"></asp:Label><asp:Label
                                                                                    ID="lblAnd" runat="server" meta:resourcekey="lblAndResource1" Text="會簽" Visible="False"></asp:Label><asp:Label
                                                                                        ID="lblOr" runat="server" meta:resourcekey="lblOrResource1" Text="並簽" Visible="False"></asp:Label><asp:Label
                                                                                            ID="lblSiteExceptMsg1" runat="server" Text="站點異常：簽核型態為一般，簽核者只允許一位" Visible="False"
                                                                                            meta:resourcekey="lblSiteExceptMsg1Resource1"></asp:Label><asp:Label ID="lblSiteExceptMsg2"
                                                                                                runat="server" Text="站點異常：找不到任何一位簽核者" Visible="False" meta:resourcekey="lblSiteExceptMsg2Resource1"></asp:Label>
                                                                <asp:Label ID="lblJobTitleMsg" runat="server" Text="此人無設定職級，無法尋找節點！" Visible="False"
                                                                    meta:resourcekey="lblJobTitleMsgResource1"></asp:Label>
