...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script id="ReApplyFormJS" type="text/javascript">
                ...
                if (actionMode == "Send") {
                    $uof.dialog.open2('<%=confirmWinUrl%>', '', '<%=dialogTitleName%>', '<%=confirmWinWidth%>', '<%=confirmWinHeight%>', function checkReturn(returnValue) {
                        if (returnValue == "DoubleSigned") {
                            location.href = "../ViewForm.aspx?TASK_ID=" + "<%=Request["TASK_ID"]%>" + "&SignedStatus=IsSigned";
                            return true;
                        }
        ...
        function CanCommentSelected() {
            $uof.dialog.open2("~/WKF/FormUse/Mobile/SignComment.aspx", $("#<%=lbtnCanComment.ClientID%>"), "", 0, 0, CanCommentCallBack);
            return false;
        }

        function CanCommentCallBack(returnValue) {
            if (typeof (returnValue) != "undefined") {
                if (ajaxManager == null)
                    ajaxManager = $find("<%= RadAjaxManager1.ClientID %>");
                ajaxManager.ajaxRequest(JSON.stringify({ "Key": "CanCommentSelected", "Value": returnValue }));
                return true;
            }
        ...
        function OnBarMainClick(sender, args) {
            if (args.get_item().get_value() == "SaveFormDraft") {
                ...
                args.set_cancel(true);
                $uof.dialog.open2('~/WKF/Browse/ViewMasterFlow.aspx', args.get_item(), '<%=dialogTitleName%>', 1280, 1080, openDialogResult, { 'formVersionId': '<%=formVersionId%>', 'flowId': '<%=flowId%>' });
            }
            else if (args.get_item().get_value() == "ViewFlow") {
                args.set_cancel(true);
                $uof.dialog.open2('~/WKF/Browse/ViewSignFlow.aspx', args.get_item(), '<%=dialogTitleName%>', 800, 650, function () { return false; },
                    { 'TASK_ID': '<%=Request["TASK_ID"]%>', 'SITE_ID': '<%=Request["SITE_ID"]%>', 'NODE_SEQ': '<%=Request["NODE_SEQ"]%>' });
            }
            else if (args.get_item().get_value() == "ViewFlowDetail") {
                args.set_cancel(true);
                $uof.dialog.open2('~/WKF/FormUse/SiteSignInfo.aspx', args.get_item(), '<%=dialogTitleName%>', 800, 650, function () { return false; },
                    { 'TASK_ID': '<%=Request["TASK_ID"]%>', 'SITE_ID': '<%=Request["SITE_ID"]%>' });
            }
            else if (args.get_item().get_value() == "SignComment") {
                var para = {
                    'ScriptID': '<%=Request["TASK_ID"]%>',
                ...
                var para = {
                    "USER_GUID": "<%=hiddenUserGUID.Value%>",
                    "TASK_ID": "<%=hiddenTaskId.Value%>",
                    "IS_SCRIPT_IQY": "0",
                    "USER_DEPT": "<%=hiddenUserDEPT.Value%>",
                    "SITE_ID": "<%=hiddenSiteid.Value%>",
                    "NODE_SEQ": "<%=hiddenNodeSEQ.Value%>"
                };
                args.set_cancel(true);
                ...
                args.set_cancel(true);
                $uof.dialog.open2('~/WKF/FormForum/DefaultDialog.aspx', args.get_item(), '', 0, 0, function () { return false; }, { 'taskid': '<%=hiddenTaskId.Value%>' });
            }
                        ...
                        <Rows>
                                                ...
                                                <Rows>
                                                    ...
                                                    <telerik:LayoutRow ID="trApplicantDept" runat="server">
                                                        <Columns>
                                                            <telerik:LayoutColumn Span="12">
                                                                <label class="title">
                                                                    <asp:Literal ID="Literal3" runat="server" Text="申請部門" meta:resourcekey="Literal3Resource1"></asp:Literal></label>
                                                            </telerik:LayoutColumn>
                                                            <telerik:LayoutColumn Span="12">
                                                                <label>
                                                    ...
                                                    <telerik:LayoutRow>
                                                        <Columns>
                                                            <telerik:LayoutColumn Span="12">
                                                                <label class="title">
                                                                    <asp:Literal ID="Literal5" runat="server" Text="申請時間" meta:resourcekey="Literal5Resource1"></asp:Literal></label>
                                                            </telerik:LayoutColumn>
                                                            <telerik:LayoutColumn Span="12">
                                                    ...
                                                    <telerik:LayoutRow>
                                                        <Columns>
                                                            <telerik:LayoutColumn Span="12">
                                                                <label class="title">
                                                                    <asp:Literal ID="Literal7" runat="server" Text="緊急程度" meta:resourcekey="Literal7Resource1"></asp:Literal></label>
                                                            </telerik:LayoutColumn>
                                                            <telerik:LayoutColumn Span="12">
                                                                <label>
                                                                    <asp:Literal ID="lblurgentLevel" runat="server" Text="" ></asp:Literal>
                                                                </label>
                                                    ...
                                                    <telerik:LayoutRow ID="agentRow" runat="server">
                                                        <Columns>
                                                            <telerik:LayoutColumn Span="12">
                                                                <label class="title">
                                                                    <asp:Literal ID="Literal9" runat="server" Text="代理填寫者" meta:resourcekey="Literal9Resource1"></asp:Literal></label>
                                                            </telerik:LayoutColumn>
                                                            <telerik:LayoutColumn Span="12">
                                                                <label>
                            ...
                            <telerik:LayoutRow RowType="Container" WrapperHtmlTag="Div">
                                <Columns>
                                    <telerik:CompositeLayoutColumn Span="12">
                                        <Content>
                                            <h3 class="blockheader"><asp:Label ID="Label4" runat="server" Text="表單" meta:resourcekey="Label4Resource1"></asp:Label></h3>
                                        </Content>
                                        <Rows>
                                            ...
                                            <telerik:LayoutRow RowType="Generic" CssClass="content nopadding">
                                                <Columns>
                                                    <telerik:LayoutColumn Span="12">
                                                        ...
                                                        <div style="text-align: left">
                                                            <uc2:UC_FileCenter runat="server" id="UC_PersonalFileCenter" ModuleName="WKF" Editable="false" ProxyEnabled="true"/>
                                                        </div>
                                    ...
                                    <telerik:CompositeLayoutColumn Span="12">
                                        ...
                                        <Rows>
                                            <telerik:LayoutRow RowType="Generic" CssClass="content nopadding">
                                                <Columns>
                                                    <telerik:LayoutColumn Span="12">
                                                        <asp:LinkButton ID="lbtnCanComment" runat="server" ForeColor="OliveDrab" Text="罐頭意見" OnClientClick="return CanCommentSelected();" meta:resourcekey="lbtnCanCommentResource1"></asp:LinkButton>
                                                        <br />
                                                        <br />
    ...
    <table cellpadding="0" border="0" style="height: 100%; width: 100%;display: none">
        <tr>
            <td style="background-image: url(<%=themePath %>/images/wf_bg.gif);vertical-align:top">
                ...
                <asp:Label ID="lblReturnSignComment" runat="server" ForeColor="Red" Text="請在意見欄輸入退簽意見"
                ...
                <asp:Label ID="lblJumpSign" runat="server" Text="跳關送出" Visible="False" 
                    meta:resourcekey="lblJumpSignResource1"></asp:Label>
