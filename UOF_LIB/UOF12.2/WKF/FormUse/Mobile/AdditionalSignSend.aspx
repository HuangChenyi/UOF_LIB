                                            ...
                                            <telerik:LayoutRow RowType="Generic" CssClass="content">
                                                <Rows>
                                                    ...
                                                    <telerik:LayoutRow>
                                                        <Columns>
                                                            <telerik:LayoutColumn Span="12" >
                                                                <label class="title"><asp:Literal ID="lblNextSiteSigner" runat="server" Text="簽核人員" meta:resourcekey="lblNextSiteSignerResource1"></asp:Literal></label>
                                                            </telerik:LayoutColumn>
                                                        </Columns>
                                                        <Columns>
                                                            <telerik:LayoutColumn Span="12" >
                                                        ...
                                                        <Columns>
                                                            <telerik:LayoutColumn Span="12">
                                                                        ...
                                                                        <asp:Panel ID="panelAgent" runat="server" Width="100%" meta:resourcekey="panelAgentResource1">
                                                                            <asp:Label ID="lblMsgAgentExcept" runat="server" ForeColor="Red" Text="!下列人員有啟動代理設定，但系統找不到他的代理人，如果您堅持送出，系統將只會送給原簽核者!" Visible="False"  meta:resourcekey="lblMsgAgentExceptResource1"></asp:Label><br>
