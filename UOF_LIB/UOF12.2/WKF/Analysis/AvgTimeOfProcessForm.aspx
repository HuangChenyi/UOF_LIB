...
<asp:Content ID="Content3" ContentPlaceHolderID="LeftContentPlaceHolder" runat="Server">
    ...
    <telerik:RadTreeView ID="treeFormList" runat="server" OnNodeClick="treeFormList_NodeClick" OnClientNodeClicking="treeFormList_NodeClicking"></telerik:RadTreeView>
</asp:Content>
