                ...
                <tr>
                    <td style="height: 327px;text-align:left; vertical-align:top;">
                        ...
                        <Fast:Grid runat="server" EnhancePager="True" Width="575px"
                            ...
                            KeepSelectedRows="False" meta:resourcekey="DGListApplyCountResource2"
                             >
                            <EnhancePagerSettings ShowHeaderPager="True"></EnhancePagerSettings>
                            <ExportExcelSettings AllowExportToExcel="False" />
                            <Columns>
                                <asp:BoundField DataField="CATEGORY_NAME" SortExpression="CATEGORY_NAME" HeaderText="類別" meta:resourceKey="BoundFieldResource1"></asp:BoundField>
