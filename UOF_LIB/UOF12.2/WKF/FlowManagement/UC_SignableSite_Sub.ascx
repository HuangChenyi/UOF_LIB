                ...
                <td style="text-align: center; width: 100%" align="center">
                    ...
                    <div style="text-align: center">
                        <table border="0" cellpadding="1" cellspacing="1" class="PopTable" width="500px" style="text-align: center">
                            <tr>
                                <td align="center" class="PopTableLeftTD" style="height: 23px" width="25%">
                                    <div align="center">
                                        <asp:Label ID="lblTitleSignSite" runat="server" meta:resourcekey="lblTitleSignSiteResource1"
                                            Text="上一站指定"></asp:Label>
                                    </div>
                                </td>
                                <td align="center" class="PopTableLeftTD" style="height: 23px" width="25%">
                                    <div align="center">
                                ...
                                <td align="center" class="PopTableLeftTD" style="height: 23px" width="25%">
                                    <div align="center">
                                        <asp:Label
                                            ID="Label3" runat="server" Text="可否修改" meta:resourcekey="Label3Resource1"></asp:Label>
                                    </div>
                                </td>
                                <td align="center" class="PopTableLeftTD" style="height: 23px" width="25%">
                                    <div align="center">
                                        <asp:Label ID="lblTimeoutTitle" runat="server" Text="逾時" meta:resourcekey="lblTimeoutTitleResource1"></asp:Label></div>
                                </td>
                            </tr>
                            <tr>
                                <td class="PopTableRightTD" style="height: 36px; text-align: center" width="25%">&nbsp;<asp:Image
                                    ID="imgAssign" runat="server" meta:resourcekey="imgIsMoidfiableResource1" /></td>
                                <td class="PopTableRightTD" style="height: 36px; text-align: center" width="25%">
                            ...
                            <tr>
                                <td align="center" class="PopTableLeftTD" style="height: 24px; text-align: center" width="25%">
                                    <div align="center">
                                        <asp:Label ID="lblTitleSpecialSigner" runat="server" Text="特殊簽核" meta:resourcekey="lblTitleSpecialSignerResource1"></asp:Label></div>
                                </td>
                                <td align="center" class="PopTableLeftTD" style="height: 24px" width="25%">
                                    <div align="center">
                                        <asp:Label ID="lbGeneralSigner" runat="server" Text="一般簽核" meta:resourcekey="lbGeneralSignerResource1"></asp:Label></div>
                                </td>
                                <td align="center" class="PopTableLeftTD" style="height: 24px" width="25%">
                                    <div align="center">
                                        <asp:Label ID="Label2" runat="server" Text="特殊知會" meta:resourcekey="Label2Resource1"></asp:Label></div>
                                </td>
                                <td align="center" class="PopTableLeftTD" style="height: 24px" width="25%">
                                    <div align="center">
                                        <asp:Label ID="Label1" runat="server" Text="一般知會" meta:resourcekey="Label1Resource1"></asp:Label></div>
                                </td>
                            </tr>
                            <tr>
                                <td align="left" class="PopTableRightTD" valign="top" width="25%" style="text-align: left">
                                    <div style="text-align: left; width: 100%;">
                                        <asp:PlaceHolder ID="PlaceHolder1" runat="server"></asp:PlaceHolder>
                                    </div>
                                </td>
                                <td class="PopTableRightTD" valign="top" width="25%" style="text-align: center">
                                ...
                                <td class="PopTableRightTD" valign="top" width="25%">
                        ...
                        <div align="right" style="width: 100%">
                            ...
                            <asp:Panel ID="Panel1" runat="server" Visible="False" meta:resourcekey="Panel1Resource1">
                                ...
                                <asp:Label ID="lblJumpTitle" runat="server" Text="跳簽" meta:resourcekey="lblJumpTitleResource1"
                                    Width="30px"></asp:Label>
                                <asp:Label ID="lblFlowEndTitle" runat="server" Text="結束"
                                        meta:resourcekey="lblFlowEndTitleResource1" Width="30px"></asp:Label>
                                 <asp:Image ID="imgIsFlowEnd"
                                            runat="server" meta:resourcekey="imgIsFlowEndResource1" Width="26px" />
                                 <asp:Image
                                                ID="imgIsJump" runat="server" ImageUrl="~/Common/Images/Icon/icon_m49.gif"
                                                meta:resourcekey="imgIsJumpResource1" Width="14px" />
                                 <asp:Label ID="lblLastSiteAgent"
                                                    runat="server" Text="上一站點代理人" meta:resourcekey="lblLastSiteAgentResource1"></asp:Label>
