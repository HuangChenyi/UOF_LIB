...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <table width="100%" class="PopTable" cellspacing="1">
        ...
        <tr>
            <td class="popTableLeftTD">
                <div align="center">
                    <asp:CustomValidator ID="alretCustomValidator" runat="server" Display="Dynamic" 
                        ErrorMessage="知會人員至少需有一位，請至少選擇一位特殊人員或一般知會<br/>" 
                        meta:resourcekey="alretCustomValidatorResource1"></asp:CustomValidator>
                    <asp:Label ID="lblSpecialAlrets" runat="server" Text="特殊知會" 
                        meta:resourcekey="lblSpecialAlretsResource1"></asp:Label>
                </div>
            </td>
        </tr>
        <tr>
                    ...
                    <tr>
                        <td style="background-color: White; height: 27px" valign="top">
                            <asp:CheckBoxList ID="cblSpecialAlrets" runat="server" RepeatColumns="2" Width="100%"
                                ...
                                <asp:ListItem Value="IS_APPLYER_ALERT" meta:resourcekey="ListItemResource1" Text="申請者"></asp:ListItem>
                                <asp:ListItem Value="IS_LAST_AGENT_ALERT" meta:resourcekey="ListItemResource3" Text="上一站點代理人"></asp:ListItem>
                                <asp:ListItem Value="IS_APPLYER_SUPERIOR_ALERT" meta:resourcekey="ListItemResource4"
                                    Text="申請者直屬主管"></asp:ListItem>
                                <asp:ListItem Value="IS_LAST_SUPERIOR_ALERT" meta:resourcekey="ListItemResource5"
    ...
    <asp:Panel ID="Panel3" runat="server" Visible="False" meta:resourcekey="Panel3Resource1">
        ...
        <asp:RadioButton ID="rdDisAllowJumpSign" runat="server" GroupName="isJumpSign" Text="不允許"
            meta:resourcekey="rdDisAllowJumpSignResource1" Checked="True" /></asp:Panel>
    <asp:Panel ID="Panel1" runat="server" Visible="False" meta:resourcekey="Panel1Resource1">
        ...
        <asp:RadioButton ID="rdDisallowAdditionalSign" runat="server" Checked="True" GroupName="isAdditionalSign"
            Text="不允許" meta:resourcekey="rdDisallowAdditionalSignResource1" /></asp:Panel>
</asp:Content>
