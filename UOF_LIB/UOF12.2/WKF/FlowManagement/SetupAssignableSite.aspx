...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <script type="text/javascript" id="telerikClientEvents1">
        ...
        function radToolBarByBeforeSign_Clicking(sender, args) {
            ...
            if (value == "SetNodify") {
                ...
                $uof.dialog.open2("~/WKF/FormManagement/ManageSiteNotifyCondition.aspx", args.get_item(), "", 1000, 700, openDialogResult, {"SITE_ID":siteId,"formVersionId":formVersionId,"notifyType":"0"});
            }
        }
        ...
        function radToolBarByAfterSign_Clicking(sender, args) {
            ...
            if (value == "SetNodify") {
                ...
                var notifyType = 1;
                args.set_cancel(true);
                $uof.dialog.open2("~/WKF/FormManagement/ManageSiteNotifyCondition.aspx", args.get_item(), "", 1000, 700, openDialogResult, { "SITE_ID": siteId, "formVersionId": formVersionId, "notifyType": "1" });
    ...
    <table width="100%" class="PopTable" cellspacing="1">
        ...
        <tr>
            ...
            <td class="PopTableRightTD" style="width: 30%; height: 27px">
            ...
            <td class="PopTableRightTD" style="height: 27px">
                <asp:RadioButton ID="rbSignType0" runat="server" Checked="True" GroupName="singType"
                    Text="一般" meta:resourcekey="rbSignType0Resource1" />
