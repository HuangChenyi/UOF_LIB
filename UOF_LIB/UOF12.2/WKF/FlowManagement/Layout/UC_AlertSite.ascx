...
<table border="0" cellpadding="0" cellspacing="0" width="143">
        ...
        <td colspan="3" height="21" style="background-image:url(<%=themePath %>/images/wkf/app_top.gif); background-repeat:no-repeat; background-position:bottom;">
            ...
            <table id="TBModify" runat="server" >
                <tr>
                    ...
                    <td>
                        <asp:ImageButton ID="imgBtnInsert" runat="server"  meta:resourcekey="imgBtnInsertResource1"/></td>
                    <td>
                        <asp:ImageButton ID="imgBtnDel" runat="server"  OnClick="imgBtnDel_Click" meta:resourcekey="imgBtnDelResource1" /></td>
                    <td>
                        <asp:ImageButton ID="imgBtnUp" runat="server" OnClick="imgBtnUp_Click" meta:resourcekey="imgBtnUpResource1" /></td>
                    <td>
                        <asp:ImageButton ID="imgBtnDown" runat="server"  OnClick="imgBtnDown_Click" meta:resourcekey="imgBtnDownResource1"/></td>
                    <td>
    ...
    <tr>
        <td class="SiteLeftTD" valign="top" width="10" height="40">&nbsp;
        </td>
        <td style="background-image:url(<%=themePath %>/images/wkf/site_con.gif)"  height="40" valign="top"
            width="125">
                        <asp:Label ID="Label1" runat="server" Text="知會站點" 
                meta:resourcekey="Label1Resource1"></asp:Label>
                        <div class="SignerTD" style="width:100%; text-align:left">
               <asp:Table ID="tbAlert" runat="server" BorderWidth="0px" CellPadding="0" CellSpacing="0" meta:resourcekey="tbAlertResource1" >
                </asp:Table>
                </div>
        </td>
