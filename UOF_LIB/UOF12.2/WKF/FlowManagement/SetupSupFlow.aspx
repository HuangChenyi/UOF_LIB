...
<script id="SetupSupFlowjs" type="text/javascript">
    ...
    function BtnSaveSubFlowInfo_Click(sender, args)
    {
        $('#<%=HiddenField1.ClientID%>').val($('#<%=tbxFlowName.ClientID%>').val());         
    }
    </script>    
        <table class="PopTable" cellspacing="1" border="0" cellpadding="1" width="100%">
            ...
            <tr>
                ...
                <td class="PopTableRightTD" style="vertical-align:top ; text-align:left; ">
                    ...
                    <uc3:UC_BtnChoiceOnce ID="UC_BtnChoiceOnce_StartGroup" runat="server" ButtonText="部門選擇" />
                    &nbsp; &nbsp;&nbsp;
                ...
                <td align="center" class="PopTableLeftTD" rowspan="1" valign="bottom">
                    <telerik:RadButton ID="BtnSaveSubFlowInfo" runat="server" Text="儲存資訊"
                        meta:resourcekey="BtnSaveSubFlowInfoResource1" OnClientClicking="BtnSaveSubFlowInfo_Click" OnClick="BtnSaveSubFlowInfo_Click1"></telerik:RadButton>
                </td>
            </tr>
            <tr>
