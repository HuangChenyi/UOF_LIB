<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_FlowManagement_SetupSubFlowNotify" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" Codebehind="SetupSubFlowNotify.aspx.cs" %>
     ...
     <script type="text/javascript">
         ...
         function RadToolBar1_ButtonClicking(sender, args) {
             ...
             if (value == "SetStartFormCondition") {
                 if ('<%= Request["IsModify"] %>' == 'False') {
                     args.set_cancel(true);
                     return;
                 }
                 //新增判斷式
                 args.set_cancel(true);
                 $uof.dialog.open2("~/WKF/FlowManagement/ManageSubFlowNotifyCondition.aspx", args.get_item(), "", 940, 600, openDialogResult,
                     { "Notify_Type": "0", "FormCondition": "Y", "formVersionId": "<%=formVersionId%>", "siteId": "<%=siteId%>" });
             }
             ...
             if (value == "SetEndFormCondition") {
                 ...
                 args.set_cancel(true);
                 $uof.dialog.open2("~/WKF/FlowManagement/ManageSubFlowNotifyCondition.aspx", args.get_item(), "", 940, 600, openDialogResult,
                     { "Notify_Type": "1", "FormCondition": "Y", "formVersionId": "<%=formVersionId%>", "siteId": "<%=siteId%>" });
             }
...
<asp:Panel ID="Panel1" runat="server" meta:resourcekey="Panel1Resource1">
     ...
     <tr>
        ...
        <tr>
            <td colspan="2">
                <telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%" OnClientButtonClicking="RadToolBar1_ButtonClicking" meta:resourcekey="UltraWebToolbar1Resource1" OnButtonClick="RadToolBar1_ButtonClick" SingleClick="None" >
                    <Items>
                        ...
                        Text="設定" meta:resourcekey="RadToolBarButtonResource1" >
        ...
        <tr>
            <td valign="top" style="width:100%" colspan="2">
                <Fast:Grid id="StartFormGrid" runat="server" 
                    ...
                    DefaultSortDirection="Ascending" EmptyDataText="沒有資料" KeepSelectedRows="False" 
                    meta:resourcekey="StartFormGridResource1" CustomDropDownListPage="False" SelectedRowColor="" UnSelectedRowColor="">
...
<ExportExcelSettings AllowExportToExcel="False"></ExportExcelSettings>
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="起始通知人員" 
                            meta:resourcekey="TemplateFieldResource1">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox1" runat="server" Text='<%# Bind("COND_ID") %>' 
     ...
     <tr>
        ...
        <tr>
            <td valign="top" style="width:100%" colspan="2">
                <telerik:RadToolBar ID="RadToolBar2" runat="server" Width="100%" OnClientButtonClicking="RadToolBar2_ButtonClicking" OnButtonClick="RadToolBar2_ButtonClick" meta:resourcekey="RadToolBar2Resource1" SingleClick="None">
                    <Items>
                        <telerik:RadToolBarButton runat="server" DisabledImageUrl="~/Common/Images/Icon/icon_m06_g.gif" 
                        HoveredImageUrl="~/Common/Images/Icon/icon_m06.gif" 
                        ImageUrl="~/Common/Images/Icon/icon_m06.gif" 
                        ...
                        CheckedImageUrl="~/Common/Images/Icon/icon_m06.gif" 
                        Text="設定" meta:resourcekey="RadToolBarButtonResource3" >
                        </telerik:RadToolBarButton>
                        <telerik:RadToolBarButton runat="server" IsSeparator="True" Text="Button 1" ImageUrl="~/App_Themes/DefaultTheme/images/toolbarSp.jpg" meta:resourcekey="RadToolBarButtonResource4">
                        </telerik:RadToolBarButton>
                    </Items>
        ...
        <tr>
            <td valign="top" style="width:100%" colspan="2">
                <Fast:Grid id="EndFormGrid" runat="server"  
                    ...
                    EmptyDataText="沒有資料" 
                    KeepSelectedRows="False" meta:resourcekey="EndFormGridResource1" CustomDropDownListPage="False" SelectedRowColor="" UnSelectedRowColor="">
                    <EnhancePagerSettings ShowHeaderPager="True" />
...
<ExportExcelSettings AllowExportToExcel="False"></ExportExcelSettings>
                    <Columns>
                        ...
                        <asp:TemplateField HeaderText="結束通知人員" 
                            meta:resourcekey="TemplateFieldResource2">
                            <EditItemTemplate>
                                <asp:TextBox ID="TextBox2" runat="server" Text='<%# Bind("COND_ID") %>' 
