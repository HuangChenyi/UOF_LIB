    ...
    <script type="text/javascript" id="telerikClientEvents1">
        ...
        function RadToolBar1_ButtonClicking(sender, args) {
            ...
            if (value == "Insert") {
                ...
                $uof.dialog.open2("~/WKF/Admin/MaintainSignComment.aspx", args.get_item(), "罐頭意見維護", 500, 400, function checkReturn(returnValue) { if (typeof (returnValue) == "undefined") return false; else return true; });
              }
        ...
        <Items>
            ...
            <Fast:Grid ID="Grid1" runat="server" AutoGenerateCheckBoxColumn="True" 
                ...
                <Columns>
                    ...
                    <asp:BoundField DataField="COMMENT_CONTENT" HeaderText="內容" 
