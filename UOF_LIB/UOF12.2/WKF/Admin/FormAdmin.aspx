   ...
   <tr>
      <td align="center" style="height: 76px">
          <telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%" meta:resourcekey="UltraWebToolbar1Resource1" OnButtonClick="RadToolBar1_ButtonClick" OnClientButtonClicking="RadToolBar1_ButtonClicking">
              <Items>
                  <telerik:RadToolBarButton runat="server" Text="刪除" meta:resourcekey="TBarButtonResource1"
             ...
             <tr>
                <td style="width:800px" align="center">
                    <table  class="PopTable" cellspacing="1" style="text-align :left ">
                        <tr>
                            <td colspan="6" class="PopTableHeader"  style="height: 25px; text-align:center">
                            <center>
                        ...
                        <tr>
                            ...
                            <td class="PopTableRightTD" style="height: 25px">
                                <asp:DropDownList ID="ddlFormStatus" runat="server" meta:resourcekey="ddlFormStatusResource1">
                            ...
                            <td class="PopTableLeftTD" style="height: 25px" nowrap="nowrap">
                              <asp:Label ID="lblDate" runat="server" Text="*申請日期" meta:resourcekey="lblDateResource1"></asp:Label></td>
                            <td class="PopTableRightTD" style="height: 25px">
                             <table>
                                <tr>
                                   <td>
                                       ...
                                       <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" Display="Dynamic" ForeColor="Red"
                                           ErrorMessage="請輸入申請日期(起)" ControlToValidate="rdpStartDate" meta:resourcekey="RequiredFieldValidator1Resource1"></asp:RequiredFieldValidator></td>
                                   ...
                                   <td>
                                       ...
                                       <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" Display="Dynamic" ForeColor="Red"
                                           ErrorMessage="請輸入申請日期(迄)" ControlToValidate="rdpEndDate" meta:resourcekey="RequiredFieldValidator2Resource1"></asp:RequiredFieldValidator></td>
                                </tr>
                             </table>
                                <asp:UpdatePanel id="UpdatePanel2" runat="server" RenderMode="Inline" UpdateMode="Conditional">
                                    <contenttemplate>
<asp:CustomValidator runat="server" ErrorMessage="結束時間需晚於開始時間" ID="CustomValidator1" Display="Dynamic" ForeColor="Red" meta:resourceKey="CustomValidator1Resource1" OnServerValidate="CustomValidator1_ServerValidate"></asp:CustomValidator>
...
<asp:AsyncPostBackTrigger ControlID="wibQuery" EventName="Click"></asp:AsyncPostBackTrigger>
                        ...
                        <tr>
                            ...
                            <td colspan="3" class="PopTableRightTD" style="height: 25px">
                        ...
                        <tr>
                            <td colspan="6" style="text-align: center; height: 25px;" class="PopTableLeftTD">
                                 <div class="wrap" >       
