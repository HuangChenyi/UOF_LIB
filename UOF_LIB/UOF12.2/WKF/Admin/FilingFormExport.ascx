...
<table style="width: 100%; height: 100%" class="tbbg01">
                                ...
                                <table cellspacing="1" class="PopTable" style="text-align: center">
                                  <colgroup class="PopTableLeftTD" width="80px">
                                    ...
                                    <tr>
                                        ...
                                        <center>
                                            <asp:Label ID="lblBasicQuery" runat="server" meta:resourcekey="lblBasicQueryResource1"
                                                Text="基本查詢"></asp:Label>&nbsp;</center>
                                        </td>
                                    </tr>
                                  
                                    <tr>
                                        <td align="right" style="height: 25px;"  nowrap="nowrap">
                                            <asp:Label ID="lblTaskResult" runat="server" meta:resourcekey="lblTaskResultResource1"
                                                Text="*審核結果"></asp:Label></td>
                                        ...
                                        <td align="right" style="height: 25px;"nowrap="nowrap">
                                            <asp:Label ID="Label1" runat="server" meta:resourcekey="Label1Resource1" Text="*"></asp:Label><asp:DropDownList
                                                ID="ddlBegintimeOrEndtime" runat="server" meta:resourcekey="ddlBegintimeOrEndtimeResource1">
                                        ...
                                        <td align="left" style="height: 25px">
                                            ...
                                            <asp:CompareValidator ID="CompareValidator1" runat="server" ControlToCompare="rdpStartDate"
                                                ControlToValidate="rdpEndDate" Display="Dynamic" ErrorMessage="結束時間需晚於開始時間" meta:resourcekey="CompareValidator1Resource1"
                                                Operator="GreaterThanEqual" Type="Date"></asp:CompareValidator></td>
                                    </tr>
                                    <tr>
                                        <td align="right" style="height: 25px"  nowrap="nowrap">
                                            <asp:Label ID="lblApplicant" runat="server" meta:resourcekey="lblApplicantResource1"
                                        ...
                                        <td align="left" colspan="3" style="height: 25px">
                                            ...
                                            <asp:Label ID="lblApplicantRemark" runat="server" Text="使用申請者查詢時，無法查到過期或停用之申請者的表單資料" CssClass="SizeMemo" meta:resourcekey="lblApplicantRemarkResource1"></asp:Label></td>
                                    </tr>
                                    <tr>
                                        <td align="right" style="height: 25px"  nowrap="nowrap">
                                            ...
                                            <asp:UpdatePanel ID="UpdatePanel4" runat="server">
                                                <ContentTemplate>
                                                  <div style=" width:150px">
                                                    <asp:DropDownList ID="ddlFormName" 
    runat="server" AutoPostBack="True" meta:resourcekey="ddlFormNameResource1"
    ...
    OnSelectedIndexChanged="ddlFormName_SelectedIndexChanged" Width="150px">
                                        ...
                                        <td align="right" style="height: 25px"  nowrap="nowrap">
                                            <asp:Label ID="lblDocNumbers" runat="server" meta:resourcekey="lblDocNumbersResource1"
                                                Text="表單編號起訖"></asp:Label></td>
                                        <td align="left" style="height: 25px">
                                            <table>
                                                <tr>
                                                    <td>
                                                        <asp:TextBox ID="tbNumberStart" runat="server" meta:resourcekey="tbNumberStartResource1"
                                            ...
                                            <asp:CustomValidator ID="CustomValidator3" runat="server" Display="Dynamic" ErrorMessage="請輸入表單編號(迄)"
                                                meta:resourcekey="CustomValidator3Resource1" OnServerValidate="CustomValidator3_ServerValidate"></asp:CustomValidator></td>
                                    </tr>
                                </table>
                                ...
                                <table style="text-align:center">
                                    <tr>
                                        <td  colspan="4" style="height: 25px;text-align:center">
                                            &nbsp;
                                            <telerik:RadButton ID="wibQuery" runat="server" Text="RadButton" meta:resourcekey="wibQueryResource1" OnClick="wibQuery_Click1"></telerik:RadButton>
                                            <telerik:RadButton ID="wibShowSpecial" runat="server" Text="RadButton" meta:resourcekey="wibShowSpecialResource1" OnClick="wibShowSpecial_Click1"></telerik:RadButton>
                                            &nbsp;
                                        </td>
                                    </tr>
                                </table>
                        ...
                        <table cellspacing="1" class="PopTable" width="100%">
                            <tr>
                                <td align="center" class="PopTableHeader" style="width: 1332px">
                                    <center>
                                <asp:Label ID="lblFormListTitle" runat="server" meta:resourcekey="lblFormListTitleResource1"
                                    Text="表單列表"></asp:Label>
                                    </center>
                                </td>
                            </tr>
                                    ...
                                    <Fast:Grid ID="DGFormList" runat="server" AllowPaging="True" AllowSorting="True"
                                        ...
                                        <Columns>
                                            ...
                                            <asp:TemplateField HeaderText="表單名稱" meta:resourcekey="TemplateFieldResource1">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblFormname" meta:resourceKey="lblFormnameResource2" __designer:wfdid="w55"></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                            <asp:TemplateField HeaderText="申請人" meta:resourcekey="TemplateFieldResource2">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblUser" meta:resourceKey="lblUserResource1" __designer:wfdid="w13"></asp:Label>
                                                </ItemTemplate>
                                                <ItemStyle HorizontalAlign="Left" />
                                            </asp:TemplateField>
                                             <asp:TemplateField HeaderText="審核結果" meta:resourcekey="TemplateFieldResource3">
                                                <ItemTemplate>
                                                    <asp:Label runat="server" ID="lblResult" meta:resourceKey="lblResultResource1" __designer:wfdid="w14"></asp:Label>
                                                </ItemTemplate>
...
<asp:Label ID="lblQuery" runat="server" meta:resourcekey="lblQueryResource1" Text="查詢"
    Visible="False"></asp:Label>
<asp:Label ID="lblSpecQuery" runat="server" meta:resourcekey="lblSpecQueryResource1"
    Text="進階查詢" Visible="False"></asp:Label>
<asp:Label ID="lblExportAnalysis" runat="server" meta:resourcekey="lblExportAnalysisResource1"
    Text="表單統計" Visible="False"></asp:Label>
<asp:Label ID="lblExportForm" runat="server" meta:resourcekey="lblExportFormResource1"
    Text="表單單據" Visible="False"></asp:Label>
<asp:Label ID="lblPass" runat="server" meta:resourcekey="lblPassResource1" Text="通過"
    Visible="False"></asp:Label>
...
<asp:Label ID="lblAllResult" runat="server" meta:resourcekey="lblAllResultResource1"
    Text="所有結果" Visible="False"></asp:Label>
<asp:Label ID="lblBeginTime" runat="server" meta:resourcekey="lblBeginTimeResource1"
    Text="申請時間" Visible="False"></asp:Label>
<asp:Label ID="lblEndTime" runat="server" meta:resourcekey="lblEndTimeResource1"
    Text="結案時間" Visible="False"></asp:Label>
...
<asp:Label ID="lblCondition" runat="server" meta:resourcekey="lblConditionResource1"
    Text="欄位條件" Visible="False"></asp:Label>
<asp:Label ID="lblQueryCondition" runat="server" meta:resourcekey="lblQueryConditionResource1"
    Text="查詢條件" Visible="False"></asp:Label>
