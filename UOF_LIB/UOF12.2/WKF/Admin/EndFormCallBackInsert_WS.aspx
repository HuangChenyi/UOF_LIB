<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_Admin_EndFormCallBackInsert_WS" Title="新增網址" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="EndFormCallBackInsert_WS.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
    ...
    <asp:UpdatePanel ID="UpdatePanel1" runat="server">
        <ContentTemplate>
                ...
                <tr>
                    ...
                    <center>
                        <asp:Label ID="Label1" runat="server" Text="新增網址" meta:resourcekey="Label1Resource1"></asp:Label></center></td>
                </tr>
                <tr>
                    ...
                    <td class = "PopTableRightTD">
                        <asp:TextBox ID="txtWsName" runat="server" Width="450px" meta:resourcekey="txtWsNameResource1" MaxLength="200"></asp:TextBox></td>
                </tr>
                            <tr>
                    ...
                    <td class = "PopTableRightTD" style="height: 26px">
                        <asp:TextBox ID="txtUrl" runat="server" Width="450px" meta:resourcekey="txtUrlResource1" MaxLength="200"></asp:TextBox></td>
                </tr>
                <tr>
                    <td class = "PopTableLeftTD" style="height: 26px" nowrap="noWrap">
                        <asp:Label ID="Label3" runat="server" Text="呼叫的方法" meta:resourcekey="Label3Resource1"></asp:Label></td>
                    <td class = "PopTableRightTD" style="height: 26px">
                        <asp:TextBox ID="txtWsMethod" runat="server" Width="450px" meta:resourcekey="txtWsMethodResource1" MaxLength="100"></asp:TextBox></td>
            </table>
            <table width = 100%>
                <tr>
                    <td>

                        <asp:CheckBox ID="cbCheck" runat="server" Text="是否需要Windows驗證"  onclick="cbCheck_CheckedChanged();" meta:resourcekey="cbCheckResource1" />
                   </td>
            ...
            <table width = 100% class ="Poptable" cellspacing="1">   
                <tr>
                    ...
                    <td class = "PopTableRightTD">
                        <asp:TextBox ID="txtWsUid" runat="server" Width="450px" meta:resourcekey="txtWsUidResource1" MaxLength="50"></asp:TextBox>
                    </td>
                ...
                <tr>
                    ...
                    <td class = "PopTableRightTD" style="height: 21px">
                        <asp:TextBox ID="txtPwd" runat="server" Width="450px" TextMode="Password" meta:resourcekey="txtPwdResource1" MaxLength="20"></asp:TextBox>
                    </td>
    ...
    <asp:Label ID="lblpwd" runat="server" Visible="False" meta:resourcekey="lblpwdResource1"></asp:Label>
