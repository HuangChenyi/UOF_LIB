...
<table class="PopTable" style=" width:100%;  border:1px; background-color:#999999;"  cellpadding="0" cellspacing="1" >
    ...
    <tr>
        <td width="80px" class = "PopTableLeftTD" nowrap="noWrap">
            <asp:Label ID="lblTriggerName" runat="server" Text="呼叫外部組件名稱" 
    ...
    <tr>
        <td width="80px" class = "PopTableLeftTD" nowrap="noWrap"><asp:Label ID="lblFILE" 
                runat="server" Text="類別名稱" meta:resourcekey="lblFILEResource1"></asp:Label></td>
        <td bgcolor="white" width="350px">
    ...
    <tr>
        <td width="80px" class = "PopTableLeftTD" nowrap="noWrap"><asp:Label ID="lblType" 
                runat="server" Text="組件路徑" meta:resourcekey="lblTypeResource1"></asp:Label></td>
        <td bgcolor="white" width="350px">
            <asp:TextBox ID="txtType" runat="server" Width="350px" meta:resourcekey="txtTypeResource1"></asp:TextBox>
            <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="txtType" Display="Dynamic" ErrorMessage="不允許空白" meta:resourcekey="RequiredFieldValidator4Resource1"></asp:RequiredFieldValidator>
        </td>
</td>
    </tr>
    <tr>
        <td width="80px" class = "PopTableLeftTD" nowrap="noWrap">
            <asp:Label ID="lblModuleName" runat="server" Text="備註" 
                meta:resourcekey="lblModuleNameResource1"></asp:Label></td>
        <td bgcolor="white" width="350px"><asp:TextBox ID="txtModuleName" runat="server" 
                Width="350px" meta:resourcekey="txtModuleNameResource1"></asp:TextBox></td>
    </tr>    
</table>
    ...
    <asp:Label ID="lblSTART_FORM" runat="server" Text="起單" Visible="False" 
        meta:resourcekey="lblSTART_FORMResource1"></asp:Label>
    <asp:Label ID="lblEND_FORM" runat="server" Text="結案" Visible="False" 
        meta:resourcekey="lblEND_FORMResource1"></asp:Label>
    <asp:Label ID="lblCHANGES_FORM" runat="server" Text="狀態變更" Visible="False" 
        meta:resourcekey="lblCHANGES_FORMResource1"></asp:Label>
