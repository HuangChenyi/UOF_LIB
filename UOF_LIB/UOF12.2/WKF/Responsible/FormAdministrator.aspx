...
<script type="text/javascript">
    ...
    function OpenWin(m)
    {
        ...
        var taskId = $("#<%=Hidden1.ClientID%>").val();
                                ...
                                <td width="100%" align="center">
                                    <div onclick="Window_OnClick()">
                                                ...
                                                <td>
                                                    ...
                                                    <asp:Label ID="Label7" 
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td colspan="3" width="75%" class="PopTableRightTD">
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <telerik:RadDateTimePicker ID="ApplicantBeginDate" runat="server" Width="170px"></telerik:RadDateTimePicker>

                                                                        </td>

                                                                        <td>&nbsp;~&nbsp;</td>
                                                                        <td>
                                                                            <telerik:RadDateTimePicker ID="ApplicantEndDate" runat="server" Width="170px"></telerik:RadDateTimePicker>
                                                                        </td>
                                                                        <td>
                                                        ...
                                                        <tr id="endTimeTD" style="display: none">
                                                            <td nowrap="nowrap" align="right" width="25%" class="PopTableLeftTD">
                                                                <asp:Label ID="Label5" runat="server" Text="結案時間："
                                                                    meta:resourcekey="Label5Resource1"></asp:Label></td>
                                                            <td colspan="3" width="75%" class="PopTableRightTD">
                                                                <table>
                                                                    <tr>
                                                                        <td>
                                                                            <telerik:RadDateTimePicker ID="EndFormBeginDate" runat="server" Width="170px"></telerik:RadDateTimePicker>
                                                                        </td>
                                                                        <td>&nbsp;~&nbsp;</td>
                                                                        <td>
                                                                            <telerik:RadDateTimePicker ID="EndFormEndDate" runat="server" Width="170px"></telerik:RadDateTimePicker>
                                                                        </td>
                                                                        <td>
                                                        ...
                                                        <tr>
                                                            <td nowrap="nowrap" align="right" width="25%" class="PopTableLeftTD">
                                                                <asp:Label ID="lbl_SignJobTitle" runat="server" Text="簽核者職級："
                                                                    meta:resourcekey="lbl_SignJobTitleResource1"></asp:Label></td>
                                        ...
                                        <input id="hideGroupid" runat="server" type="hidden">
                                            <input id="Hidden1" runat="server" type="hidden"></input>
                                            <input id="Hidden2" runat="server" type="hidden"></input>
                                        </input>
                                        </input>
                                        </input>
