<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_Responsible_SetFormField" Title="設定顯示欄位" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" Codebehind="SetFormField.aspx.cs" %>
