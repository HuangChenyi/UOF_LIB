<%@ Page Title="" Language="C#" MasterPageFile="~/Master/TwoColumn.master" AutoEventWireup="true" Inherits="WKF_Responsible_SetFormFieldDisplay" culture="auto" meta:resourcekey="PageResource1" uiculture="auto" Codebehind="SetFormFieldDisplay.aspx.cs" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ToolbarContentPlaceHolder" Runat="Server">
    <telerik:RadTabStrip ID="RadTabStrip1" runat="server" SelectedIndex="1" Width="100%" MultiPageID="RadMultiPage1" OnTabClick="RadTabStrip1_TabClick" meta:resourcekey="RadTabStrip1Resource1">
        <Tabs>
            <telerik:RadTab runat="server" Value="FormAdmin" Text="表單負責人管理" meta:resourcekey="RadTabResource1">
            </telerik:RadTab>
    ...
    <table cellpadding="0" cellspacing="0" class="tbbg01" style="border: 0; width: 100%; height: 100%; text-align: left;">
                            <tr>
                                <td valign="top" width="100%" style="text-align: left;">
                                    <asp:Label ID="lblMassage" runat="server" Text="設定好的欄位，會顯示在表單負責人管理的查詢結果中。"
                                        CssClass="SizeMemo" meta:resourcekey="lblMassageResource1"></asp:Label>
                                    <asp:UpdatePanel ID="UpdatePanelGrid"
                                        runat="server" UpdateMode="Conditional" RenderMode="Inline">
                                        <ContentTemplate>
                                                    ...
                                                    <tbody style="vertical-align: top">
                                                        <tr>
                                                            <td style="HEIGHT: 42px; text-align: left;">
                                                                <table cellspacing="1"
                                                                    class="PopTable" width="100%" style="text-align: left">

                                                                    <colgroup class="PopTableLeftTD"></colgroup>
                                                                    <colgroup
                                                                        class="PopTableRightTD">
                                                                    </colgroup>
                                                                    <colgroup class="PopTableLeftTD"></colgroup>
                                                                    <colgroup
                                                                        class="PopTableRightTD">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                <asp:Label ID="lblTitleFormType" runat="server"
                                                                                    meta:resourcekey="lblTitleFormTypeResource1" Text="表單類別"></asp:Label></td>
                                                                            <td>
                                                                                <asp:Label ID="lblFormTypeByForm" runat="server"
                                                                                    meta:resourcekey="lblFormTypeByFormResource1"></asp:Label></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                                <div style="text-align: left">
                                                                    <Fast:Grid ID="FormGrid" runat="server" AllowSorting="True"
                                                                        ...
                                                                        EnhancePager="True" PageSize="15"  EmptyDataText="No data found" KeepSelectedRows="False" meta:resourcekey="FormGridResource1"  >
                                            ...
                                            <asp:Panel ID="PanelDesignFormVersion" runat="server" meta:resourcekey="PanelDesignFormVersionResource1" Visible="False" Width="100%">
                                                <table cellspacing="0" cellpadding="0" width="100%" border="0">
                                                    <tbody>
                                                        <tr>
                                                            <td style="HEIGHT: 65px" align="left">
                                                                <table class="PopTable" cellspacing="1" width="99%">
                                                                    ...
                                                                    <tbody>
                                                                        <tr>
                                                                            <td>
                                                                                <asp:Label ID="Label11" runat="server" meta:resourcekey="Label1Resource2" Text="表單類別"></asp:Label></td>
                                                                            <td>
                                                                                <asp:Label ID="lblFormVersion_formType" runat="server" meta:resourcekey="lblFormVersion_formTypeResource1"></asp:Label></td>
                                                                        </tr>
                                                                        <tr>
                                                                            <td style="HEIGHT: 11px">
                                                                                <asp:Label ID="lblFormName" runat="server" meta:resourcekey="lblFormNameResource1" Text="表單名稱"></asp:Label></td>
                                                                            <td style="HEIGHT: 11px" class="PopTableRightTD">
                                                                                <asp:Label ID="lblFormVersion_formName" runat="server" meta:resourcekey="lblFormVersion_formNameResource1"></asp:Label></td>
                                                                        </tr>
                                                                    </tbody>
                                                                </table>
                                                            </td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td style="text-align: left">
                                                                <Fast:Grid ID="FormVersionGrid" runat="server"
                                                                    ...
                                                                    EnhancePager="True" PageSize="15"  EmptyDataText="No data found" KeepSelectedRows="False" meta:resourcekey="FormVersionGridResource1"  >
                                                                    <EnhancePagerSettings ShowHeaderPager="True" FirstAltImageUrl="" FirstImageUrl="" LastAltImage="" LastImageUrl="" NextIAltImageUrl="" NextImageUrl="" PageInfoCssClass="" PageNumberCssClass="" PageNumberCurrentCssClass="" PageRedirectCssClass="" PreviousAltImageUrl="" PreviousImageUrl="" />
                                                                    <ExportExcelSettings AllowExportToExcel="False" />
                                                                    <Columns>
                                            ...
                                            <Fast:Grid ID="Grid1" runat="server"
                                                ...
                                                EnhancePager="True" PageSize="15"  EmptyDataText="No data found" KeepSelectedRows="False" meta:resourcekey="Grid1Resource1"  >
                                                <EnhancePagerSettings ShowHeaderPager="True" FirstAltImageUrl="" FirstImageUrl="" LastAltImage="" LastImageUrl="" NextIAltImageUrl="" NextImageUrl="" PageInfoCssClass="" PageNumberCssClass="" PageNumberCurrentCssClass="" PageRedirectCssClass="" PreviousAltImageUrl="" PreviousImageUrl="" />
                                                <ExportExcelSettings AllowExportToExcel="False" />
                                                <Columns>
