...
<asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
    <ContentTemplate>
        <table>
            <tr>
                <td>
                    <asp:Label ID="lblNotSupport" runat="server" Text="行動裝置暫不支援編輯此欄位" Visible="False" CssClass="SizeMemo" meta:resourcekey="lblNotSupportResource1"></asp:Label><br />
                    <telerik:RadButton ID="btnChooseForm" runat="server" Text="選擇表單" OnClick="btnChooseForm_Click" CausesValidation="False" Visible="False" meta:resourcekey="btnChooseFormResource1"></telerik:RadButton>
