    ...
    <table width="100%" class="PopTable" cellspacing="1">
        ...
        <tr>
           ...
           <asp:Label ID="lblItemListDesc" runat="server" Text="(點選即為預設值)" meta:resourcekey="lblItemListDescResource1"></asp:Label>
                ...
                <asp:CustomValidator ID="CustomValidatorRb" runat="server" ErrorMessage="欄位選項不得為空" Display="Dynamic" meta:resourcekey="CustomValidatorRbResource1"></asp:CustomValidator></td>
        </tr>
        <tr>
            <td>
