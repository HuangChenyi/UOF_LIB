<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NumberTextUC.ascx.cs" Inherits="WKF_FormManagement_VersionFieldUserControl_NumberTextUC" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table style="width: 97%">
            ...
            <tr>
                <td>
                    <telerik:RadNumericTextBox ID="RadNumericTextBox1" runat="server" Width="100%" MinValue="100">
