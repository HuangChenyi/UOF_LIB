...
<asp:Label ID="lblDefault" runat="server" Text="還原" Visible=False 
    meta:resourcekey="lblDefaultResource1"></asp:Label>
<asp:Label ID="lblView" runat="server" Text="預覽" Visible=False 
    meta:resourcekey="lblViewResource1"></asp:Label>
<asp:Label ID="lblEnable" runat="server" Text="啟用" Visible=False 
    meta:resourcekey="lblEnableResource1"></asp:Label>
<asp:Label ID="lblDisable" runat="server" Text="停用" Visible=False 
    meta:resourcekey="lblDisableResource1"></asp:Label>
