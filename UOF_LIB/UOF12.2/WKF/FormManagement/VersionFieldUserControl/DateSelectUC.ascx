...
<table border="0" cellpadding="0" cellspacing="0">
    <tr>
        <td nowrap>
            <table border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td nowrap>
                        <telerik:RadDatePicker ID="RadDatePicker1" runat="server" MaxDate="9999-12-31" MinDate="1911-01-01" SkinID="AllowEmpty">
        ...
        <td>
            ...
            <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="RadDatePicker1" Display="Dynamic" ErrorMessage="不允許空白" Visible="False" meta:resourcekey="RequiredFieldValidator1Resource1"></asp:RequiredFieldValidator>
