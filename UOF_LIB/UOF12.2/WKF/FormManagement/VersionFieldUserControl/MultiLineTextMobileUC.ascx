<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="MultiLineTextUC.ascx.cs" Inherits="WKF_FormManagement_VersionFieldUserControl_MultiLineTextUC" %>
...
<asp:UpdatePanel ID="UpdatePanel1" runat="server">
    <ContentTemplate>
        <table border="0" cellpadding="0" cellspacing="0" style="width: 97%">
            ...
            <tr>
                <td>
                    <asp:TextBox ID="tbxMultiLineText" runat="server" TextMode="MultiLine" Width="100%" meta:resourcekey="tbxMultiLineTextResource1"></asp:TextBox>
                    <asp:Label ID="lblMultiLineText" runat="server" Visible="False" meta:resourcekey="lblMultiLineTextResource1"></asp:Label>
                </td>
            </tr>
            <tr>
                <td>
                    ...
                    <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="tbxMultiLineText" Display="Dynamic" ErrorMessage="不允許空白" Visible="False" EnableTheming="true" meta:resourcekey="RequiredFieldValidator1Resource1" SetFocusOnError="True"></asp:RequiredFieldValidator>
