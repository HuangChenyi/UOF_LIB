<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_FormManagement_SetupField_MultiLineText" Title="新增欄位" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="SetupField_MultiLineText.aspx.cs" %>
    ...
    <table width="100%" class="PopTable" cellspacing="1">
        ...
        <tr>
            <td align="center" class="PopTableHeader" colspan="4">
                 <center>
                <asp:Label ID="lblMultiLine" runat="server" Text="多行文字欄位" meta:resourcekey="lblMultiLineResource1"></asp:Label>
               </center>
            </td>
        </tr>
        <tr>
            ...
            <td>
                <asp:TextBox ID="txtFieldName" runat="server" Width="180px" meta:resourcekey="txtFieldNameResource1"></asp:TextBox><br />
        ...
        <tr>
            ...
            <td>
                <uc3:UC_FiledDropList ID="UC_FiledDropList1" runat="server"></uc3:UC_FiledDropList>
        ...
        <tr>
            <td><font color="red">*</font><asp:Label ID="lblFieldLength" runat="server" Text="欄位長度"
            ...
            <td>
                <telerik:RadNumericTextBox ID="RadNumericTextBoxLength" runat="server" MaxLength="3"
                    MaxValue="999" MinValue="1" Width="40px">
<NumberFormat ZeroPattern="n" DecimalDigits="0"></NumberFormat>
                </telerik:RadNumericTextBox>
                <asp:Label ID="lblFieldLengthDesc" runat="server" Text="(顯示行數、至少1行)" meta:resourcekey="lblFieldLengthDescResource1"></asp:Label><br />
            ...
            <td>
                <asp:Label ID="lblFieldModify" runat="server" Text="允許修改預設值" Visible="False" meta:resourcekey="lblFieldModifyResource1"></asp:Label></td>
            <td>
        ...
        <tr>
            <td>&nbsp;<asp:Label ID="lblFieldDefault" runat="server" Text="預設值" meta:resourcekey="lblFieldDefaultResource1"></asp:Label></td>
            <td colspan="3">
            ...
            <td colspan="3">
                ...
                <asp:Panel ID="pnlexternalData" runat="server" Width="100%" meta:resourcekey="pnlexternalDataResource1">
                    <table border="0" cellpadding="1" cellspacing="1" style="width: 100%">
                       ...
                       <tr>
                           <td colspan="6">
                               <asp:CheckBox ID="chkgetBeforeTime" runat="server" Text="是否表單填寫前先取得資料 (如不勾選，使用者需點選取得資料才可取得)" meta:resourcekey="chkgetBeforeTimeResource2" />
                           </td> 
                        </tr>   
                       <tr>
                           <td colspan="6">
