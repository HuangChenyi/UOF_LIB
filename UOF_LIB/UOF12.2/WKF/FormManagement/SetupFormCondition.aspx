     ...
     <script type="text/javascript" id="telerikClientEvents1">
         ...
         function RadToolBar1_ButtonClicking(sender, args) {
             ...
             if (value == "AddConditionBase") {//新增判斷式
                 ...
                 $uof.dialog.open2("~/WKF/FormManagement/ManageFormConditionBase.aspx", args.get_item(), "", 700, 300, openDialogResult,
                     {
                         "FormCondition": "Y",
                 ...
                 args.set_cancel(true);
                 $uof.dialog.open2("~/WKF/FormManagement/ManageFormCondition.aspx", args.get_item(), "", 760, 400, openDialogResult, {"formVersionId":"<%=formVersionId%>"});
             }
                    ...
                    <tr>
                        ...
                        <td>
                            <telerik:RadButton ID="ibtnSetupRelease" runat="server" Text="5.設定發佈資訊>>" CausesValidation="False"
                                meta:resourcekey="ibtnSetupReleaseResource1" OnClick="ibtnSetup_Click">
                            </telerik:RadButton>
                        </td>
                        <td>
                            ...
                            <telerik:RadButton ID="ibtnSetupDes" runat="server" Text="7.設定使用說明>>" CausesValidation="False"
                                OnClick="ibtnSetup_Click" meta:resourcekey="ibtnSetupDesResource1">
                            </telerik:RadButton>
                        </td>   
                    </tr>
                </table>
