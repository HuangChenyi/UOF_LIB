...
<asp:DropDownList ID="ddlFieldType" runat="server" AutoPostBack="True" meta:resourcekey="ddlFieldTypeResource1"
   ...
   <asp:ListItem meta:resourceKey="ListItemResource4" Value="fileButton" Text="檔案選取欄位"></asp:ListItem>
    ...
    <asp:ListItem  Value="htmlEditor" Text="文字編輯欄位" meta:resourcekey="ListItemResource21"></asp:ListItem>
    ...
    <asp:ListItem Value="aggregateText" meta:resourcekey="ListItemResource12" Text="加總平均欄位"></asp:ListItem>
    ...
    <asp:ListItem Value="allMember" Text="所有會員" meta:resourceKey="ListItemResource34"></asp:ListItem>
