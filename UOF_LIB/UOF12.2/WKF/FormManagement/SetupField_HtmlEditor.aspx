 ...
 <table width="100%" class="PopTable" cellspacing="1">
        ...
        <tr>
            ...
            <td>
                ...
                <telerik:RadNumericTextBox ID="RadNumericTextBox1" runat="server" MaxLength="3"  DataType="System.Int32" NumberFormat-DecimalDigits="0" 
                    MaxValue="999" MinValue="0" Width="40px" meta:resourcekey="RadNumericTextBox1Resource1" ></telerik:RadNumericTextBox>
            </td>
        </tr>
        <tr>
            <td>
        ...
        <td colspan="3">
            <telerik:RadNumericTextBox ID="WebNumericViewLength" runat="server" MaxLength="4" NumberFormat-DecimalDigits="0" 
                MinValue="0" Width="40px" DataType="System.Int32" Value="0" meta:resourcekey="WebNumericViewLengthResource1"></telerik:RadNumericTextBox>
