    ...
    <table class="PopTable" cellpadding="0" cellspacing="1" style="width:100%;text-align:left;" >
        <tr>
            <td class="PopTableLeftTD" style=" white-space:nowrap;">
                <asp:Label ID="Label1" runat="server" Text="表單類別" 
                    meta:resourcekey="Label1Resource1"></asp:Label>
            </td>
            <td class="PopTableRightTD" >
                <asp:Label ID="lblCategoruName" runat="server" 
                    meta:resourcekey="lblCategoruNameResource1"></asp:Label>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            <td colspan="2" class="PopTableRightTD" style="text-align:left" >
                <uc1:UC_FileCenter runat="server" ID="UC_FileCenter1" AllowedMultipleFileSelection="false" ModuleName="WKF" ProxyEnabled="true"/>
            </td>

        </tr>
        <tr>
            <td colspan="2" class="PopTableRightTD" style=" padding-top:1px; padding-bottom :1px; text-align:left;">
                                 <Fast:Grid ID="Grid1" runat="server" AllowSorting="False" AutoGenerateCheckBoxColumn="False"
                          ...
                          Width="100%" PageSize="15"  
                                     ...
                                     KeepSelectedRows="False" meta:resourcekey="Grid1Resource1"></Fast:Grid>
            </td>
        </tr>
    </table>
