...
<table width="100%" class="PopTable" cellspacing="1">
   ...
   <tr>
        <td class="PopTableLeftTD">
            <font color="red">*</font><asp:Label ID="lblTotalWidth" runat="server" Text="欄位寬度" meta:resourcekey="lblTotalWidthResource1"></asp:Label></td> 
...
<NumberFormat ZeroPattern="n" AllowRounding="False"></NumberFormat>
    ...
    <tr>
     ...
     <tr>
       <td class="PopTableLeftTD">
           <font color="red">*</font><asp:Label ID="lblDataGridSet" runat="server" Text="明細欄位" meta:resourcekey="lblDataGridSetResource1"></asp:Label></td>
       <td colspan="3" class="PopTableRightTD">
           <telerik:RadButton ID="WebImageButton1" runat="server"  Text="明細欄位設定" 
               CausesValidation="False" Enabled="False" 
               meta:resourcekey="WebImageButton1Resource1" onclick="WebImageButton1_Click1"></telerik:RadButton>
           </td>
    </tr>
    <tr>
            <td class="PopTableLeftTD">
