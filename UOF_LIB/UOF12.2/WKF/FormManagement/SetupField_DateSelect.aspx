                               ...
                               <asp:Panel ID="pnlRestrictInterval" runat="server" Visible="false">
                                   <tr>
                                       <td style="padding-left:13px">
                                           <asp:Label ID="Label6" runat="server" Text="早於送出日期幾天內："></asp:Label>
                                           ...
                                           <asp:Label ID="Label4" runat="server" Text="天"></asp:Label><br />
                                           <asp:Label ID="Label3" runat="server" Text="晚於送出日期幾天內："></asp:Label>
                                           ...
                                           <asp:Label ID="Label5" runat="server" Text="天"></asp:Label>
                                       </td>
                                   </tr>
                               </asp:Panel>
                           </table>
