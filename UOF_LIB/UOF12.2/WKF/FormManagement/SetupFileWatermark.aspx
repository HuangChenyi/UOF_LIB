        ...
        <table style="width: 100%; text-align: left; margin: 0 auto" class="tab">
            ...
            <tr>
                <td style="background-color: #ffffff; width: 50%" valign="top">
                    <div id="divTxtDL">
                        <br />
                        <asp:CheckBox ID="chkDlUser" runat="server" Text="觀看者的姓名及部門" meta:resourcekey="chkDlUserResource1"/>&nbsp;
                    </div>
                </td>
            ...
            <tr>
                <td style="background-color: #cccccc" colspan="3">
                    <asp:CheckBox ID="chkSysPath" runat="server" Text="顯示表單名稱" meta:resourcekey="chkSysPathResource1" />
                </td>
            </tr>
            <tr>
                <td style="background-color: #cccccc" colspan="3">
