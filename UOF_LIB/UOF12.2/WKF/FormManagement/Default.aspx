       ...
       <script type="text/javascript" id="telerikClientEvents1">
           function RadToolBar1_ButtonClicking(sender, args) {
               ...
               if (value == "ManageFormType") {//類別管理
                   ...
                   args.set_cancel(true);
                   $uof.dialog.open2("~/WKF/FormManagement/AddForm.aspx", args.get_item(), "", 800, 740, openDialogResult, { "formCategoryId": categoryId });
                   ...
                   //維護表單
                   args.set_cancel(true);
                   $uof.dialog.open2("~/WKF/FormManagement/ModifyForm.aspx",args.get_item(),"",800,740,openDialogResult,{"formId":GetSelectedTag()});
               }
                   ...
                   args.set_cancel(true);
                   $uof.dialog.open2("~/WKF/FormManagement/AddFormVersion.aspx", args.get_item(), "", 500, 350, openDialogResult, { "formId": GetSelectedTag() });
               }
                   ...
                   args.set_cancel(true);
                   $uof.dialog.open2("~/WKF/FormManagement/ImportForm.aspx", args.get_item(),"", 400, 350, openDialogResult, { "formId": formId, "categroyId": categroyId });
               }
    ...
    Sys.Application.add_load(function () {
        ...
        if (txtSearch.val() != "")
         ...
         function treeFormList_NodeClicking(sebder, args) {
             ...
             //var ManageFormType      = tb.Items.fromKey("ManageFormType");
             //var AddForm             = tb.Items.fromKey("AddForm");
             //var DeleteForm          = tb.Items.fromKey("DeleteForm");
             //var AddVersion          = tb.Items.fromKey("AddVersion");
             //var MaintainForm        = tb.Items.fromKey("MaintainForm");
             //var DeleteVersion       = tb.Items.fromKey("DeleteVersion");    	
                    ...
                    <ContentTemplate>
                                            ...
                                            <Fast:Grid ID="FormGrid" runat="server" __designer:wfdid="w94" Width="100%" OnRowCommand="FormGrid_RowCommand"
                                                ...
                                                <Columns>
                                                    ...
                                                    <asp:TemplateField HeaderText="表單名稱" meta:resourcekey="TemplateFieldResource2">
                                                        <ItemTemplate>
                                                            <asp:LinkButton runat="server" ID="LinkBtnFromName" Text='<%# Bind("FORM_NAME") %>'
                        ...
                        <Fast:Grid ID="Grid1" runat="server" __designer:wfdid="w1" Width="100%" OnRowCommand="FormGrid_RowCommand"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="表單名稱" meta:resourcekey="TemplateFieldResource2">
                                    <ItemTemplate>
                                        <asp:LinkButton runat="server" ID="LinkButton1" Text='<%# Bind("FORM_NAME") %>'
                                            meta:resourceKey="LinkBtnFromNameResource1"></asp:LinkButton>
                                    </ItemTemplate>
                                    <ItemStyle HorizontalAlign="Left" />
                                </asp:TemplateField>
