...
<script type="text/javascript">
    ...
    function RadToolBar1_ButtonClicking(sender, args) {
        ...
        if (value == "AddField") {//新增欄位
            ...
            { "formVersionId": "<%=formVersionId%>", "IsVersionNum": "<%=IsVersionNum%>", "IsReleased": "<%=IsReleased%>" });
        }
    ...
    <table width="100%">
        <tr>
            <td>
                ...
                <tr>
                    <td>
                        <telerik:RadButton ID="ibtnDesignField" runat="server" Text="1.設計版面>>" CausesValidation="False"
                           meta:resourcekey="ibtnDesignFieldResource1" style="position: relative;" ></telerik:RadButton>
                    </td>
                    <td>
                        <telerik:RadButton ID="ibtnSetupCondition" runat="server" Text="2.設定條件>>" CausesValidation="False"
                            meta:resourcekey="ibtnSetupConditionResource1" OnClick="ibtnSetup_Click" style="position: relative;"></telerik:RadButton>
                    </td>
                    <td>
                        <telerik:RadButton ID="ibtnSetupNotify" runat="server" Text="3.設定起結案通知條件>>" CausesValidation="False"
                            meta:resourcekey="ibtnSetupNotifyResource1" OnClick="ibtnSetup_Click" style="position: relative;"></telerik:RadButton>
                    </td>
                    <td>
                        <telerik:RadButton ID="ibtnDesignFlow" runat="server" Text="4.設定流程>>" CausesValidation="False"
                            meta:resourcekey="ibtnDesignFlowResource1" OnClick="ibtnSetup_Click" style="position: relative;"></telerik:RadButton>
                    </td>
                    <td>
                        <telerik:RadButton ID="ibtnSetupRelease" runat="server" Text="5.設定發佈資訊>>" CausesValidation="False"
                            meta:resourcekey="ibtnSetupReleaseResource1" OnClick="ibtnSetup_Click" style="position: relative;"></telerik:RadButton>
                    </td>
                    <td>
                        <telerik:RadButton ID="ibtnSetupMail" runat="server" Text="6.設定郵件樣板>>" CausesValidation="False"
                            meta:resourcekey="ibtnSetupMailResource1" OnClick="ibtnSetup_Click" style="position: relative;"></telerik:RadButton>
                    </td>
                    <td>
                        <telerik:RadButton ID="ibtnSetupDes" runat="server" Text="7.設定使用說明>>" CausesValidation="False"
                            meta:resourcekey="ibtnSetupDesResource1" OnClick="ibtnSetup_Click" style="position: relative;">
                        </telerik:RadButton>
                    </td>
                </tr>
            </table>
...
&nbsp;</td>
    ...
    <asp:Panel ID="Panel1" runat="server"   Width="100%" CssClass="PanelHeight"
