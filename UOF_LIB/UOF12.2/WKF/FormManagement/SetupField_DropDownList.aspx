...
<script type="text/javascript">
    ...
    function chkexternalDataCheck_CheckedChanged() {
        ...
        if ($("#<%=this.chkexternalDataCheck.ClientID%>").prop("checked")) {
            ...
            $("#<%=this.chk_useDefault.ClientID%>").attr("disabled", true);
            $("#<%=this.chk_useDefault.ClientID%>").prop("checked", false);
        }
        else {
            $("#<%=this.pnlexternalData.ClientID%>").hide();
            $("#<%=this.chk_useDefault.ClientID%>").attr("disabled", false);
        }
    }
    ...
    <table width="100%" class="PopTable" cellspacing="1">
        ...
        <tr>
            <td><font color="red">*</font> <asp:Label ID="lblFieldId" runat="server" Text="欄位代號" meta:resourcekey="lblFieldIdResource1"></asp:Label></td>
            <td>
        ...
        <tr>
            ...
            <td>
                <telerik:RadButton ID="WebImageButton1" runat="server" OnClick="WebImageButton1_Click1"
                    Text="設定" CausesValidation="False" meta:resourcekey="WebImageButton1Resource1"></telerik:RadButton>
                <br />
        ...
        <tr>
            <td>
                <asp:Label ID="Label1" runat="server" Text="預設值設定" meta:resourcekey="lblFieldRemarkResource1"></asp:Label></td>
            <td colspan="3">
                <asp:CheckBox ID="chk_useDefault" runat="server" Text="是否使用預設值設定" 
                    meta:resourcekey="chk_useDefaultResource1" />
&nbsp;<asp:Label ID="lblItemListDesc" runat="server" Text="(如果打勾選取即為預設值)" 
                    meta:resourcekey="lblItemListDescResource1"></asp:Label>
            </td>
        </tr>
        <tr>
            <td>
