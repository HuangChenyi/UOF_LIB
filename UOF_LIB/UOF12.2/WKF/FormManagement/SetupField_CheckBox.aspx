<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_FormManagement_SetupField_CheckBox" Title="新增欄位" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="SetupField_CheckBox.aspx.cs" %>
...
<table width="100%" class="PopTable" cellspacing="1">
    ...
    <tr>
       <td align="center" class="PopTableHeader" colspan="4">
        <center>
           <asp:Label ID="lblCheckBox" runat="server" Text="核選方塊" meta:resourcekey="lblCheckBoxResource1"></asp:Label>
           </center>
           </td>
    </tr>
    <tr>
    ...
    <tr>
        <td><span style="color: #ff0000">*</span><asp:Label ID="lblFieldLength" runat="server" Text="單行顯示欄位個數" meta:resourcekey="lblFieldLengthResource1"></asp:Label></td>
        <td>
            <telerik:RadNumericTextBox ID="RadNumericTextBoxLength" runat="server" MaxLength="3" MaxValue="999"
               MinValue="0" Width="40px" ClientEvents-OnBlur="OnBlur" >
<NumberFormat ZeroPattern="n" AllowRounding="False"></NumberFormat>
    ...
    <tr>
        ...
        <td colspan="3">
            <telerik:RadButton ID="WebImageButton1" runat="server" OnClick="WebImageButton1_Click" CausesValidation="False" meta:resourcekey="WebImageButton1Resource1"></telerik:RadButton>
            <asp:Label ID="lblItemListDesc" runat="server" Text="(勾選即為預設值)" meta:resourcekey="lblItemListDescResource1"></asp:Label>
            &nbsp;
            <asp:UpdatePanel ID="UpdatePanelCBL" runat="server" UpdateMode="Conditional">
                <ContentTemplate>
                    <asp:CheckBoxList ID="CheckBoxList1" runat="server" RepeatColumns="6" RepeatDirection="Horizontal" meta:resourcekey="CheckBoxList1Resource1">
                    </asp:CheckBoxList>
                </ContentTemplate>
            </asp:UpdatePanel>
            <br />
            <asp:CheckBox ID="cbAllowOthers" runat="server" Text="啟用其他選項"  meta:resourcekey="cbAllowOthersResource1"/>
            <asp:CustomValidator ID="CustomValidatorCbx" runat="server" ErrorMessage="欄位選項不得為空" Display="Dynamic" meta:resourcekey="CustomValidatorCbxResource1"></asp:CustomValidator>&nbsp;
        </td>
    </tr>
        <tr>
            <td>
...
<EnabledStyle Resize="None"></EnabledStyle>
    ...
    <asp:Label ID="lblSetup" runat="server" Text="設定" Visible="False" meta:resourcekey="lblSetupResource1"></asp:Label>
