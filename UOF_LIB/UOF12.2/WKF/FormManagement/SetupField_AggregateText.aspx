...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <table cellspacing="1" class="PopTable" width="100%">
        ...
        <tr>
            <td><font color="red"><span style="color: red">*</span></font><asp:Label ID="lblFieldId"
            ...
            <td><font color="red">*</font><asp:Label ID="lblFieldName" runat="server" meta:resourcekey="lblFieldNameResource1"
...
<NumberFormat ZeroPattern="n" AllowRounding="False"></NumberFormat>
        ...
        <tr>
            ...
            <td colspan="3">&nbsp;<asp:RadioButton ID="rbSum" runat="server" Checked="True" GroupName="Forumal"
                ...
                <telerik:RadButton ID="WebImageButton1" runat="server" CausesValidation="False"
                    meta:resourcekey="WebImageButton1Resource1" OnClick="WebImageButton1_Click1" Text="加總欄位"></telerik:RadButton>
            </td>
        </tr>
        <tr>
            <td>
    ...
    <div align=right>
        <br />
        <asp:Label ID="Label1" runat="server" Text="註：此欄位只適用於明細子欄位資料之統計" meta:resourcekey="Label1Resource1"></asp:Label>&nbsp;</div>
