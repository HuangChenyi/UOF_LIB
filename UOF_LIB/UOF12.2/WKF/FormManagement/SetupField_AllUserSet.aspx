<%@ Page Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_FormManagement_SetupField_AllUserSet" Title="欄位格式---申請者" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="SetupField_AllUserSet.aspx.cs" %>
    ...
    <table width="100%" class="PopTable" cellspacing="1">
        ...
        <tr>
            <td align="center" class="PopTableHeader" colspan="4">
             <center>
                <asp:Label ID="lblSpecialField" runat="server" Text="特定欄位值" meta:resourcekey="lblSpecialFieldResource1"></asp:Label>
                </center>
                </td>
        </tr>
        <tr>
