...
function CopyToClipBoard() {
            ...
            <td>
                <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td style="height: 27px" valign="top">&nbsp;<uc1:VersionFieldCollectionUsingUC ID="VersionFieldCollectionUsingUC1"
                            runat="server" />
                               <asp:LinkButton ID="lbtnClear" runat="server" 
                                Font-Underline=true onclick="lbtnClear_Click" Text="清空資料" meta:resourcekey="lbtnClearResource1"></asp:LinkButton>
                        </td>
                    </tr>
                    <tr>
                        <td style="height: 27px"> </td>
    ...
    <asp:Label ID="lblClear" runat="server" Text="確定後繼續" Visible=false meta:resourcekey="lblClearResource1"></asp:Label>
                <asp:Label ID="lblLockedMsg" runat="server" Visible=False 
        Text="表單目前有他人正在處理，請稍後再進行簽核！" meta:resourcekey="lblLockedMsgResource1" ></asp:Label>
</asp:Content>
