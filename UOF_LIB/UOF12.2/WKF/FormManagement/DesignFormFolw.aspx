    ...
    <script type="text/javascript" id="telerikClientEvents1">
        ...
        function RadToolBar1_ButtonClicking(sender, args) {
            ...
            if (value == "AddMasterFlow") {  //新增主流程
                ...
                args.set_cancel(true);
                $uof.dialog.open2("~/WKF/FlowManagement/SetupMasterFlow.aspx", args.get_item(), "", 800, 760, openDialogResult, { "formVersionId": "<%=formVersionId%>", "masterFlowId": "<%=flowId%>" });
            }
                    ...
                    <tr>
                        <td>
                            <telerik:RadButton ID="ibtnDesignField" runat="server" Text="1.設計欄位>>" CausesValidation="False"
                                meta:resourcekey="ibtnDesignFieldResource1" OnClick="ibtnSetup_Click"></telerik:RadButton>
                        </td>
                        <td>
                        ...
                        <td>
                            <telerik:RadButton ID="ibtnSetupDes" runat="server" Text="7.設定使用說明" OnClick="ibtnSetup_Click" CausesValidation="False" meta:resourcekey="ibtnSetupDesResource1">
                            </telerik:RadButton>
                        </td>      
                    </tr>
                </table>
