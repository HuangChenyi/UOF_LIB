<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DialogMasterPage.master" AutoEventWireup="true" Inherits="WKF_FormManagement_SetupField_UserAgent" meta:resourcekey="PageResource1" Codebehind="SetupField_UserAgent.aspx.cs" %>
    ...
    <table width="100%" class="PopTable" cellspacing="1">
        ...
        <tr>
            <td align="center" class="PopTableHeader" colspan="4">
                <center>
                <asp:Label ID="lblDropDownList" runat="server" Text="申請者代理人" meta:resourcekey="lblDropDownListResource1"></asp:Label>
                </center>
                </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>
                ...
                <telerik:RadNumericTextBox ID="RadNumericTextBoxSeq" runat="server" MaxLength="3" MaxValue="999"
                    MinValue="0" Width="40px" meta:resourcekey="RadNumericTextBoxSeqResource1"></telerik:RadNumericTextBox>
            </td>
        </tr>
        <tr>
            <td>
