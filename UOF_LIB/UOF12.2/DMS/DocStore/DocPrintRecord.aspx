    ...
    <script type="text/javascript">
        function RadToolBar1_ButtonClicking(sender, args) {
            ...
            if (key == "New") {
                ...
                var manualVersion = $("#<%= hfmanualversionJS.ClientID %>").val();
                var fileId = '<%= fileid%>';
                var mode = "New";
                $uof.dialog.open2("~/DMS/DocStore/DocPrintControl.aspx", args.get_item(), "", 500, 400, function (returnValue) {
                    return true;
                }, { "docid": docId, "manualversion": manualVersion, "fileid": fileId, "status": "<%= status%>", "folderid": "<%= Request["folderid"]%>", "mode": mode });
            }
            else if (key == "Delete") {
                    ...
                    <Items>
                        ...
                        <Fast:Grid ID="Grid1" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateCheckBoxColumn="True"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField HeaderText="回收份數" DataField="TOTAL_OF_RECALL" SortExpression="TOTAL_OF_RECALL" meta:resourcekey="BoundFieldResource6">
