                        ...
                        <td >
                            <table style="width: 100%;">
                                <tr>
                                    ...
                                    <td style="min-width:20px; max-width:350px; vertical-align: bottom; text-align:left;" nowrap>
                        ...
                        <td style="height: 12px; text-align:left; vertical-align:middle;" nowrap>
                            <asp:Panel ID="panDefault" runat="server" meta:resourcekey="panDefaultResource1">
                                <table>
                                        ...
                                        <td>
                                            <table ID="folderSearch" runat="server" style="width:100%; ">
                                                <tr>
                                                    <td>
                                                        <span >
                                                        <asp:Label ID="lblSearchFolderDoc" runat="server" Text="搜尋目錄下文件(名稱、編號):" meta:resourcekey="lblSearchFolderDocResource1"></asp:Label>
                                    ...
                                    <tr>
                                        <td>
                                            <asp:CheckBox ID="chkShowAll" runat="server" Text="所有文件(含無讀取權及作廢、失效、下架)" 
                                                Font-Bold="False" Height="24px" AutoPostBack="True" OnCheckedChanged="chkShowAll_CheckedChanged" CssClass="white" meta:resourcekey="chkShowAllResource1" />
                                            &nbsp;&nbsp;
        ...
        <tr>
            ...
            <td align="left" style="width: 100%">
                                ...
                                <table style="width:100%;">
                                    <tr>
                                        ...
                                        <td>&nbsp;
                                            ...
                                            <asp:Label ID="lblDownloadNum" Text='<%# Bind("DL_NUM") %>' ToolTip= "下載次數" runat="server" ForeColor="Black" meta:resourcekey="lblDownloadNumResource1"></asp:Label>
                ...
                <Fast:Grid ID="gridCommon" runat="server" AllowPaging="True" AllowSorting="True" AutoGenerateCheckBoxColumn="True"
                    ...
                    Width="100%" EnhancePager="True" PageSize="15" OnSorting="gridCommon_Sorting"  DefaultSortDirection="Ascending" EmptyDataText="沒有資料" KeepSelectedRows="False" meta:resourcekey="gridCommonResource1"  >
                                    ...
                                    <table style="width:100%;" >
                                        <tr>
                                            ...
                                            <td>
                                                ...
                                                <asp:Label ID="lblDownloadNum" ToolTip= "下載次數" runat="server" ForeColor="Black" meta:resourcekey="lblDownloadNumResource3"></asp:Label>
                        ...
                        <asp:TemplateField ShowHeader="False" meta:resourcekey="TemplateFieldResource13">
                            <ItemTemplate>
                                <table style="TABLE-LAYOUT: fixed; WIDTH: 795px;" class="NormalPopTable" cellspacing="0" bordercolordark="#ffffff" bgcolor="#cccccc" bordercolorlight="#666666" border="1">
                                    <tbody>
                                        <tr>
                                            <td style="WIDTH: 170px; BACKGROUND-COLOR: white; WORD-WRAP: break-word" height="156" rowspan="5">
                                                <br />
                                        ...
                                        <tr>
                                            ...
                                            <td style="width: 180px" class="PopTableRightTD">&nbsp;<asp:Label ID="lblClassName" runat="server" Text='<%# Bind("CLASS_NAME") %>' meta:resourcekey="lblClassNameResource2"></asp:Label>

                                            </td>
                                             <td style="width: 120px" class="PopTableLeftTD" align="right">
                                                <asp:Label ID="Label19" runat="server" meta:resourcekey="Label19Resource1" Text="下載次數" Font-Bold="True" ForeColor="Black"></asp:Label>
                                            </td>
                                            <td style="width: 180px" class="PopTableRightTD">&nbsp;<asp:Label ID="lblDownloadNum" runat="server" Text='<%# Bind("DL_NUM") %>'></asp:Label>
...
<span style="display: none">
    ...
    <input id="hideDatasource" runat="server" type="hidden" style="width: 31px" />
    ...
    function OpenWin(sender, item) {
        ...
        switch(item)
        {
            ...
            case 3:
                ...
                break;
            case 4:
                $uof.dialog.open2("~/DMS/DocStore/DocStatistics.aspx", '', '', 500, 680, function () { return false; }, { 'docid': docID });
                break;
            case 5:
