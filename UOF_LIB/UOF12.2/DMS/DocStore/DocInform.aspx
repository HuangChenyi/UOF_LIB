        ...
        function toolbarCopyLink_Click(sender, args) {
            ...
            switch (button.get_value()) {
                case "CopyDocLink":
                    ...
                    var strlink = $("#<%=hdAppPath.ClientID%>").val() + "/DMS※" + "<%=ShortId %>" + ".aspx"
                    var Type = 'folder';
                ...
                case "CopyVerLink":
                    ...
                    //2010/03/02 修正連結由@改為※ [Xing]   
                    //2013/08/14 David 改為開窗複製
                    var strlink = $("#<%=hdAppPath.ClientID%>").val() + "/DMS※" + "<%=ShortIdForVer %>" + ".aspx"
                    var Type = 'folder';
            ...
            try {
                ...
                switch (key) {
                    ...
                    case "DocDelete":
                        ...
                        if (window.confirm('<%=lblConfirmDelete.Text %>')) {
                            var deleteData = [docID];
                            var deleteResult = $uof.pageMethod.sync("DeleteDOC", deleteData);

                            if (deleteResult == "true")
                                $uof.dialog.close();
                            else {
                                ShowError("<%=lblDeleteError.Text %>", 360, 133);
                            }
                        }
                    ...
                    case "DocVoid":
                        ...
                        var VoidValue = $uof.pageMethod.sync("GetApproveValue", folderID).split(",");;

                        if (window.confirm("<%=lblConfirmVoid.Text %>")) {

                            //不審核
                            if (VoidValue[1] == 'false' || VoidValue[3] == 'true') {
                                var voidData = [docID];
                                var voidResult = $uof.pageMethod.sync("VoidDOC", voidData);

                                if (voidResult == "true")
                                    $(document).attr("location", $(document).attr("location"));
                                else
                                    ShowError("<%=lblVoidError.Text %>", 360, 133);
                            }

                            //作廢需審核
                            if (VoidValue[1] == 'true' && VoidValue[3] != 'true') {
                                //簡易審核
                                if (VoidValue[2] == 'DMS') {
                                    var voidData = [docID, VoidValue[0], VoidValue[2], $('#<%=lblActualVer.ClientID %>').text()];
                                    $uof.pageMethod.sync("ApproveVoidDoc", voidData);

                                    $(document).attr("location", $(document).attr("location"));
                                }
                                //文件審核
                                if (VoidValue[2] == 'WKF') {
                                    var voidData = [VoidValue[0], docID, "<%=SecretRank %>", '<%=FolderName %>', "<%=lblDocLink.Text%>", "<%=lblHistory.Text%>", "<%=lblRef.Text%>", "<%=lblInfo.Text%>", "<%=labNormal.Text%>", "<%=lblSecretm.Text%>", "<%=lblTopSecret.Text%>", "<%=lblXSecret.Text%>", "<%=lblXXSecret.Text%>", "<%=lblUrgencyNormal.Text%>", "<%=lblUrgencyHigh.Text%>", "<%=lblUrgencyExHigh.Text%>"];

                                    var result = $uof.pageMethod.sync("CreateFormScript", voidData);
                                    var obj = JSON.parse(result);
                                    var scriptFileId = $("#<%= hidScriptFileGroupID.ClientID%>");
                                    scriptFileId.val(obj.scriptFileGroup);

                                    var formId = 'DMSVoid';
                                    var formVersionId = VoidValue[0];
                                    $uof.dialog.open2("~/WKF/ExternalModule/ExternalFormScript.aspx", "", "", 0, 0,
                                        function (returnValue) {
                                            ...
                                            $(document).attr("location", $(document).attr("location")); return true;
                                        }
                                        , { "scriptId": obj.taskId, "formId": formId, "formVersionId": formVersionId });
                                }
                            }
                    ...
                    //版本歷程
                    case "DocHistory":
                        $uof.dialog.open2("~/DMS/DocStore/DocHistory.aspx", "", "", 1024, 768, function (returnValue) { return false; }, { "docid": docID });
                    break;
                    //意見評分表
                    case "DocGradeList":
                    ...
                    case "AdminChangeDoc":
                        ...
                        if (docType === "FILE") {
                            $uof.dialog.open2("~/DMS/DocStore/DocChange.aspx", "", "", 600, 400, function (returnValue) { return false; }, { "docid": docID });
                        }
            ...
            <td style="width: 28%; height: 556px; vertical-align: top;">
                ...
                <table>
                    <tr>
                        <td>
                            <p>
                                &nbsp;<telerik:RadPanelBar runat="server" ID="rbarMenu" Width="100%" meta:resourcekey="rbarMenuResource1"
                                    OnClientItemClicked="rbarMenuOnClientItemClicked">
                                    <Items>
                                        ...
                                        <telerik:RadPanelItem Text="目錄管理者功能" Enabled="False" Value="GrpManager" Expanded="True" meta:resourcekey="RadPanelItemResource14">
                                            <Items>
                                                ...
                                                <telerik:RadPanelItem Value="DocVoid" Text="作廢" meta:resourcekey="RadPanelItemResource10" />
            ...
            <td style="width: 72%; height: 556px; vertical-align: top;">
                ...
                <table class="PopTable" cellspacing="1">
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            <span style="word-break: break-all; width: 220px;">
                                &nbsp;<asp:Label ID="lblDocNum" runat="server" ForeColor="Black" meta:resourcekey="lblDocNumResource2"></asp:Label>
                            </span>
                        </td>
                    </tr>
                    <tr>
                    ...
                    <tr>
                        ...
                        <td colspan="3">
                            &nbsp;<asp:Label ID="lblIsCommonEdit" runat="server" ForeColor="Black" meta:resourcekey="lblIsCommonEditResource2"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap" >
                        ...
                        <td class="PopTableRightTD" colspan="3">
                            &nbsp;<asp:Label ID="lblSecret" runat="server" ForeColor="Black" meta:resourcekey="lblSecretResource2"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap" >
                        ...
                        <td class="PopTableRightTD" colspan="3">
                            &nbsp;<asp:Label ID="lblCreatetime" runat="server" ForeColor="Black" meta:resourcekey="lblCreatetimeResource2"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap" >
                        ...
                        <td class="PopTableRightTD" colspan="3">
                            &nbsp;<asp:Label ID="lblPublishDate" runat="server" ForeColor="Black" meta:resourcekey="lblPublishDateResource1"></asp:Label>
                        </td>
                    </tr>
                    <tr>
                        <td style="white-space:nowrap" >
