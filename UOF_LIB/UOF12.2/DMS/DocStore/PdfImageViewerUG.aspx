<%@ Page Title="" Language="C#" AutoEventWireup="true" CodeBehind="PdfImageViewerUG.aspx.cs" Inherits="Ede.Uof.Web.DMS.DocStore.PdfImageViewerUG" %>
        ...
        <telerik:RadScriptBlock runat="server">
            <script type="text/javascript">
                ...
                function rotation_click() {
                    var r = "0";
                    var value = $('#<%=hdnAngle.ClientID%>').val();
                    if (value === "0") r = "90";
                    if (value === "90") r = "180";
                    if (value === "180") r = "270";

                    // 使用 replace 用來忽略頁面內的操作
                    var p = $('#<%=hdnQueryString.ClientID%>').val();
