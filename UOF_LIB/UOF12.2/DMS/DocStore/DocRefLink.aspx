...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script type="text/jscript">
        ...
        Sys.Application.add_load(
            function ()
            {
                if ($('#<%= hidPostBack.ClientID%>').val() === "First") {
                    ...
                    if (pd) {
                        $("#<%= hidSelectRef.ClientID %>").val($("#<%=Request["refID"] %>", pd).val());
                    }
        ...
        function AddTreeNode(docID, docName, Sync, publishVersion) {
...
function DownloadFileWithHandler(sHandlerUrl, sUserProxyIndex) {
    ...
    <input id="hdAppPath" runat="server" enableviewstate="true" style="width: 14px" type="hidden" />
