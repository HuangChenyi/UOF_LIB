...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
                ...
                <table style="width: 100%">
                    ...
                    <tr>
                        <td style="overflow: auto; vertical-align: top; height: 350px">
                            <telerik:RadTreeView ID="myFolderTree" runat="server" OnClientNodeClicking="myFolderTree_NodeClicking"></telerik:RadTreeView>
                        </td>
                    </tr>
                </table>
    ...
    <input id="hdTreeID" type="hidden" runat="server" />
