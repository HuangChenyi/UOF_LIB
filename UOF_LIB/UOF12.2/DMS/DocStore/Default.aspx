    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script>
            Sys.Application.add_load(function () {
                ...
                var manualver = $("#<%=hfManualver.ClientID%>").val();
                var approvetype = "<%=Request["approvetype"]%>";
                ...
                if (approvetype == "wkf") {
                    ...
                    var linktype = "<%=Request["linktype"]%>";//表單連結類型
                    var taskid = "<%=Request["taskid"]%>";
                    var flow = "<%=Request["flow"]%>";
                    //判斷是文件連結或文件資訊
                    if (linktype == "doc") {
                        var docmode = "<%=Request["docmode"]%>";
            ...
            function nodeFolderRename(newFolderName) {
                ...
                if (node != null) {
                    ...
                    $('#<%=UC_DMSDoc1.FindControl("labFolderName").ClientID%>').text(newFolderName);
...
<asp:Content ID="Content2" ContentPlaceHolderID="LeftContentPlaceHolder" runat="Server">
    ...
    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" SelectedIndex="0" meta:resourcekey="RadMultiPage1Resource1">
        <telerik:RadPageView ID="RadPageView1" runat="server" meta:resourcekey="RadPageView1Resource1" Selected="True">
            <telerik:RadTreeView ID="treeFolder" runat="server" ShowLineImages="False" Skin="Metro"
        ...
        <telerik:RadPageView ID="RadPageView2" runat="server" meta:resourcekey="RadPageView2Resource1">
            <telerik:RadTreeView ID="treeClass" runat="server" ShowLineImages="False" Skin="Metro"
        ...
        <telerik:RadPageView ID="RadPageView3" runat="server" meta:resourcekey="RadPageView3Resource1">
            ...
            <telerik:RadTreeView ID="treeAuthor" runat="server" ShowLineImages="False" Skin="Metro"
                ...
                <tr>
                    <td style="width: 100%">
                        ...
                        <div style="margin-left: 4px;">
                            <table border="0" cellpadding="1" cellspacing="1" style="margin-left: 5px;">
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadDatePicker ID="dateStart" runat="server" Culture="zh-TW" meta:resourcekey="dateStartResource1">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <telerik:RadDatePicker ID="dateEnd" runat="server" Culture="zh-TW" meta:resourcekey="dateEndResource1">
                                            <Calendar EnableWeekends="True" UseColumnHeadersAsSelectors="False" UseRowHeadersAsSelectors="False">
                                            </Calendar>
                                            <DateInput DateFormat="yyyy/M/d" DisplayDateFormat="yyyy/M/d" LabelWidth="64px" Width="">
                                                <EmptyMessageStyle Resize="None" />
                        ...
                        <asp:Label ID="Label2" runat="server" Text="●類別:" meta:resourcekey="Label2Resource1"></asp:Label><div style="margin-left: 5px;">
                            <telerik:RadTreeView ID="classSearchTree" runat="server" CheckBoxes="True" CheckChildNodes="True" ShowLineImages="False" meta:resourcekey="classSearchTreeResource1" TriStateCheckBoxes="False"></telerik:RadTreeView>
                        </div>
                        <table border="0" cellpadding="1" cellspacing="1" style="margin-left: 5px;">
                            <tr>
                                <td>
