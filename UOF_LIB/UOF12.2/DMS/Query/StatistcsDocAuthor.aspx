                    ...
                    <td style="width: 40%" valign="top">
                        <Fast:Grid ID="gridChart" runat="server" AllowSorting="True" AutoGenerateCheckBoxColumn="False"
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="文章數" meta:resourcekey="TemplateFieldResource2" SortExpression="DOC_NUM">
                                    <EditItemTemplate>
                    ...
                    <td valign="top">
                        <Fast:Grid ID="gridAuthor" runat="server" AllowSorting="True" AutoGenerateCheckBoxColumn="False"
                            ...
                            <Columns>
                                ...
                                <asp:BoundField DataField="MODIFY_DATE" HeaderText="修改日期" meta:resourcekey="BoundFieldResource5" SortExpression="MODIFY_DATE">
