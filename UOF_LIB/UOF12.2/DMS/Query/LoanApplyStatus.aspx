...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <telerik:RadToolBar ID="RadToolbar1" runat="server" Width="100%" OnButtonClick="RadToolbar1_ButtonClicked" OnClientButtonClicking="RadToolbar1_Click" meta:resourcekey="barMainResource1">
        <Items>
            <telerik:RadToolBarButton runat="server" Enabled="true" CheckedImageUrl="~/Common/Images/Icon/icon_m03.gif" DisabledImageUrl="~/Common/Images/icon_m03.gif" HoveredImageUrl="~/Common/Images/Icon/icon_m03.gif" ImageUrl="~/Common/Images/Icon/icon_m03.gif" Text="刪除" Value="Delete" meta:resourcekey="TBarButtonResource1">
    ...
    <asp:UpdatePanel ID="UpdatePanel2" runat="server">
        <ContentTemplate>
            <Fast:Grid runat="server" ID="gridPersonLendApprove" AutoGenerateCheckBoxColumn="True" DataKeyNames="DOC_ID,LEND_USER" AllowSorting="True" AutoGenerateColumns="False" DataKeyOnClientWithCheckBox="True" EnhancePager="True" PageSize="15" OnRowDataBound="gridPersonLendApprove_RowDataBound" Width="100%" OnSorting="gridPersonLendApprove_Sorting" AllowPaging="True" OnPageIndexChanging="gridPersonLendApprove_PageIndexChanging">
