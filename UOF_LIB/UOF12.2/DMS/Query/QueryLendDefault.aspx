...
<asp:Content ID="Content2" ContentPlaceHolderID="LeftContentPlaceHolder" runat="Server">
    <telerik:RadTreeView ID="treeLendFolder" runat="server" ShowLineImages="False" Skin="Metro" OnClientNodeClicking="OntreeLendFolderClicking" OnNodeExpand="treeLendFolder_NodeExpand" OnNodeClick="treeLendFolder_NodeClick" meta:resourcekey="treeLendFolderResource1">
    </telerik:RadTreeView>
                                                            ...
                                                            <td>&nbsp;
                                                                <span style="width: 520px; word-break: break-all">
                                                                    <asp:LinkButton ID="labDLFile" runat="server" Text='<%# Bind("DOC_NAME") %>'
                                                                        ForeColor="Maroon" meta:resourcekey="labDLFileResource2" ></asp:LinkButton>
                                                                </span>                                                                
                                                            </td>
                                                            <td>&nbsp;
