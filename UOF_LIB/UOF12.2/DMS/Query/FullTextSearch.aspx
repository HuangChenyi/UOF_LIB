    ...
    <script type="text/ecmascript">
        ...
        function ChangeSubFilename() {
            ...
            if (chkSubname.prop("checked")) {
                txtSubFileName.attr("disabled", false);
                txtSubFileName.css("backgroundColor", "#FFFFFF");
            }
            else {
                txtSubFileName.attr("disabled", true)
                ...
                <asp:UpdatePanel ID="UpdatePanel1" runat="server" UpdateMode="Conditional">
                    <ContentTemplate>
                                    ...
                                    <telerik:RadMultiPage ID="rmpSearch" runat="server" SelectedIndex="0" meta:resourcekey="rmpSearchResource1">
                                        <telerik:RadPageView ID="RadPageView1" runat="server" meta:resourcekey="RadPageView1Resource1" Selected="True">
                                            ...
                                            <div id="divSearchClass" style="overflow: auto; width: 100%; height: 155px">
                                                <telerik:RadTreeView ID="classSearchTree" runat="server" Height="150px"
                                ...
                                <td valign="top" class="PopTableRightTD" >
                                    <table border="0">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadDatePicker ID="dateStart" runat="server" meta:resourcekey="dateStartResource2" Culture="zh-TW">
                                            ...
                                            <td>
                                                <telerik:RadDatePicker ID="dateEnd" runat="server" meta:resourcekey="dateEndResource2" Culture="zh-TW">
                                                </telerik:RadDatePicker>
                                            </td>
                                        </tr>
                                        <tr>
                        ...
                        <strong>
                            ...
                            <input id="hidSelectNode" type="hidden" runat="server" />
                        </input>
                        </input>
                        </input>
                    </ContentTemplate>
