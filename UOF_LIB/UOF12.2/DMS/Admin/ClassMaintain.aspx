...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        <script type="text/javascript">
            ...
            function RadFolderToolbar1_Click(sender, args) {
                ...
                if (button.get_value() == "AddNew") {
                    ...
                    var nodeTag = node.get_value();
                    args.set_cancel(true);
                    $uof.dialog.open2("~/DMS/Admin/ClassCultureMaintain.aspx", args.get_item(), "", 600, 300, OpenDocDialogResult, { "classid": nodeTag });
                }
        }
    ...
    <telerik:RadTreeView runat="server" ID="treeClass" AllowNodeEditing="True" EnableDragAndDrop="True" Height="100%" Width="100%"
