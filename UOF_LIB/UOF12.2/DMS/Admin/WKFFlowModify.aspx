...
<Fast:Grid runat="server" ID="gridChangeFolder" AutoGenerateCheckBoxColumn="False" AllowSorting="True" AutoGenerateColumns="False"  DataKeyOnClientWithCheckBox="False" EnhancePager="True" OnRowDataBound="gridChangeFolder_RowDataBound" OnSorting="gridChangeFolder_Sorting" PageSize="2"   Width="100%">
    <EnhancePagerSettings
        ShowHeaderPager="True" />
    <Columns>
        <asp:TemplateField HeaderText="名稱" SortExpression="FOLDER_ID" meta:resourcekey="TemplateFieldResource1">
            <edititemtemplate>
<asp:TextBox runat="server" Text='<%# Bind("FOLDER_ID") %>' ID="TextBox2"></asp:TextBox>

</edititemtemplate>
            <itemtemplate>
<asp:Image runat="server" ID="imgIcon" __designer:wfdid="w6"></asp:Image>
