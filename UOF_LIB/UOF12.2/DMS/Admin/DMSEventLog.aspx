...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
            ...
            <table border="1" cellpadding="0" cellspacing="0" class="PopTable" style="table-layout: fixed;">
                ...
                <tr>
                    ...
                    <td class="PopTableRightTD">
                        ...
                        <asp:CheckBox ID="chkRelease" runat="server" Text="產生UDoc" meta:resourcekey="chkReleaseResource1" Visible="false" />
                    </td>
                </tr>
                <tr>
                    <td class="PopTableLeftTD">
    ...
    <asp:Label ID="lblRelease" runat="server" Text="產生UDoc" Visible="False" meta:resourcekey="lblReleaseResource1"></asp:Label>
