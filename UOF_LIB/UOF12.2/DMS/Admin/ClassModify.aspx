    ...
    <asp:Panel ID="Panel1" runat="server">
        ...
        <asp:UpdatePanel ID="UpdatePanel2" runat="server" UpdateMode="Conditional">
            <ContentTemplate>
                ...
                <input id="hideClass" runat="server" type="hidden" />
                <input id="hideTag" runat="server" type="hidden" />
                <input id="hidSelectNodeID" runat="server" style="width: 18px" type="hidden" />
                <input id="hidEvent" runat="server" style="width: 17px" type="hidden" />
            </ContentTemplate>
        </asp:UpdatePanel>
