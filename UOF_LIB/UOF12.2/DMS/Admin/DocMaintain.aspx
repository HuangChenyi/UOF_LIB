    ...
    <telerik:RadCodeBlock ID="RadCodeBlock1" runat="server">
        <script>
            function RadFolderToolbar_Click(sender, args) {
                ...
                if (oButton.get_value() == "FolderManage") {
                    var hidNodeTag = $("#<%=hidNodeTag.ClientID %>");
                    var tree = $find("<%= folderTree.ClientID %>");
                    var node = tree.get_selectedNode();
                    var nodeTag = node.get_value();
                    hidNodeTag.value = nodeTag;
                    args.set_cancel(true);

                    $uof.dialog.open2("~/DMS/Admin/FolderMaintain.aspx", args.get_item(), "", 500, 500, OpenDocDialogResult, { "folderid": nodeTag });

                   
                }
                    // 搬移文件
                else if (oButton.get_value() == "MoveDoc") {
                    ...
                    var tree = $find("<%= folderTree.ClientID %>");
                    var node = tree.get_selectedNode();
                    var folder = node.get_value();
                    var DocIdList = $uof.pageMethod.sync("GetDocIDList", [checkedData]);
                    args.set_cancel(true);
                    $uof.dialog.open2("~/DMS/Admin/MoveDoc.aspx", args.get_item(), "", 500, 500, OpenDocDialogResult, { "folderid": folder, "key": DocIdList });
                }
                else if (oButton.get_value() == "DelDoc") {// 刪除文件
                    var checkedData = $uof.fastGrid.getChecked('<%=Grid1.ClientID%>');
                ...
                else if (oButton.get_value() == "VoidDoc") {//作廢文件
                    var checkedData = $uof.fastGrid.getChecked('<%=Grid1.ClientID%>');
                    ...
                    if (confirm('<%=lblConfirmVoid.Text %>') == false)
                        args.set_cancel(true);
                }
                else if (oButton.get_value() == "ChangeAuthor") // 變更作者
                {
                    var checkedData = $uof.fastGrid.getChecked('<%=Grid1.ClientID%>');
                    ...
                    args.set_cancel(true);
                    $uof.dialog.open2("~/DMS/Admin/ChangeAuthor.aspx", args.get_item(), "", 350, 250, OpenDocDialogResult, { "folderid": folder, "key": DocIdList });
...
function OpenDocDialogResult(returnValue) {
    ...
    <telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%" OnButtonClick="RadToolBar1_ButtonClick" OnClientButtonClicking="RadFolderToolbar_Click" meta:resourcekey="barMainResource1" Height="31px" SingleClick="None">
        <Items>
            <telerik:RadToolBarButton runat="server" Enabled="true" CheckedImageUrl="~/Common/Images/Icon/icon_m120.png" DisabledImageUrl="~/Common/Images/Icon/icon_m120_g.png" HoveredImageUrl="~/Common/Images/Icon/icon_m120.png" ImageUrl="~/Common/Images/Icon/icon_m120.png" Text="目錄維護" Value="FolderManage" meta:resourcekey="RadToolBarButtonResource1">
            </telerik:RadToolBarButton>
            <telerik:RadToolBarButton runat="server" IsSeparator="True" Value="sep4" meta:resourcekey="RadToolBarButtonResource2" />
            <telerik:RadToolBarButton runat="server" CheckedImageUrl="~/Common/Images/Icon/icon_m67_g.png" DisabledImageUrl="~/Common/Images/Icon/icon_m67_g.png" HoveredImageUrl="~/Common/Images/Icon/icon_m67_g.png" ImageUrl="~/Common/Images/Icon/icon_m67_g.png" Text="文件搬移" Value="MoveDoc" meta:resourcekey="RadToolBarButtonResource3">
            </telerik:RadToolBarButton>
            <telerik:RadToolBarButton runat="server" IsSeparator="True" Value="sep1" meta:resourcekey="RadToolBarButtonResource4" />
            <telerik:RadToolBarButton runat="server" CheckedImageUrl="~/Common/Images/Icon/icon_m03_g.png" DisabledImageUrl="~/Common/Images/Icon/icon_m03_g.png" HoveredImageUrl="~/Common/Images/Icon/icon_m03_g.png" ImageUrl="~/Common/Images/Icon/icon_m03_g.png" Text="文件銷毀" Value="DelDoc" meta:resourcekey="RadToolBarButtonResource5">
            </telerik:RadToolBarButton>
            <telerik:RadToolBarButton runat="server" IsSeparator="True" Value="sep2" meta:resourcekey="RadToolBarButtonResource6" />
            <telerik:RadToolBarButton runat="server" CheckedImageUrl="~/Common/Images/Icon/icon_m11.png" DisabledImageUrl="~/Common/Images/Icon/icon_m11.png" HoveredImageUrl="~/Common/Images/Icon/icon_m11.png" ImageUrl="~/Common/Images/Icon/icon_m11.png" Text="文件作廢" Value="VoidDoc" meta:resourcekey="RadToolBarButtonResource7">
            </telerik:RadToolBarButton>
            <telerik:RadToolBarButton runat="server" IsSeparator="True" Value="sep3" meta:resourcekey="RadToolBarButtonResource8" />
            <telerik:RadToolBarButton runat="server" CheckedImageUrl="~/Common/Images/Icon/icon_m60_g.png" DisabledImageUrl="~/Common/Images/Icon/icon_m60_g.png" HoveredImageUrl="~/Common/Images/Icon/icon_m60_g.png" ImageUrl="~/Common/Images/Icon/icon_m60_g.png" Text="變更讀作者" Value="ChangeAuthor" meta:resourcekey="RadToolBarButtonResource9">
            </telerik:RadToolBarButton>
            <telerik:RadToolBarButton runat="server" IsSeparator="True" Value="sep4" />
        </Items>
    </telerik:RadToolBar>
    <input id="hidNodeTag" runat="server" type="hidden" value="DMSRoot" style="width: 65px" />
...
<asp:Content ID="Content3" ContentPlaceHolderID="LeftContentPlaceHolder" runat="Server">
    ...
    <telerik:RadTabStrip ID="RadTabStrip1" MultiPageID="RadMultiPage1" runat="server" OnClientTabSelected="OnClientTabSelected" meta:resourcekey="RadTabStrip1Resource1" SelectedIndex="0">
        <Tabs>
            <telerik:RadTab runat="server" Selected="True" Value="AdminFolder" Text="目錄" PageViewID="RadPageView1" meta:resourcekey="TabResource1">
            </telerik:RadTab>
    ...
    <telerik:RadMultiPage ID="RadMultiPage1" runat="server" meta:resourcekey="RadMultiPage1Resource1">
        <telerik:RadPageView runat="server" ID="RadPageView1" meta:resourcekey="RadPageView1Resource1">
            <div runat="server" id="treeBG" style="background-repeat: repeat; width: 100%; height: 100%">
                <telerik:RadTreeView runat="server" ID="folderTree"
                ...
                <ContentTemplate>
                    <table border="0" cellspacing="1px" style="width: 100%; border-collapse: separate; margin-left: 5px;">
                                ...
                                <div style="margin-left: 4px;">
                                    <table border="0" cellpadding="1" cellspacing="1" style="margin-left: 5px;">
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadDatePicker ID="RadDatePicker1" runat="server" Culture="zh-TW" meta:resourcekey="RadDatePicker1Resource1">
                                ...
                                <div style="margin-left: 4px;">
                                    <table border="0" cellpadding="1" cellspacing="1" style="margin-left: 5px;">
                                        <tr>
                                            ...
                                            <td>
                                                <telerik:RadDatePicker ID="RadDatePicker2" runat="server" Culture="zh-TW" meta:resourcekey="RadDatePicker2Resource1">
                        ...
                        <tr>
                            <td colspan="2">
                                <div style="margin-left: 10px;">
                                    <telerik:RadTreeView ID="classSearchTree" runat="server" CheckBoxes="True" CheckChildNodes="True" ShowLineImages="False" TriStateCheckBoxes="False" meta:resourcekey="classSearchTreeResource1"></telerik:RadTreeView>
                                </div>
                            </td>
                        </tr>
                    </table>
...
<asp:Content ID="Content4" ContentPlaceHolderID="RightContentPlaceHolder" runat="Server">
    ...
    <input id="hideKey" runat="server" type="hidden" />
    ...
    <input id="hideSource" runat="server" type="hidden" />
