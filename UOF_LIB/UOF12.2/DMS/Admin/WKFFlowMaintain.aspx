...
<asp:Content ID="Content4" ContentPlaceHolderID="RightContentPlaceHolder" runat="Server">
    ...
    <Fast:Grid runat="server" ID="gridWKFData" AutoGenerateCheckBoxColumn="False" Width="100%"
        ...
        PageSize="15" AllowPaging="True" OnSorting="gridWKFData_Sorting"
        OnPageIndexChanging="gridWKFData_PageIndexChanging"  DefaultSortDirection="Ascending" EmptyDataText="No data found" KeepSelectedRows="False"  >
        ...
        <Columns>
            ...
            <asp:TemplateField HeaderText="原始建立目錄" SortExpression="FOLDER_ID" meta:resourcekey="TemplateFieldResource3">
                <EditItemTemplate>
                    <asp:TextBox runat="server" Text='<%# Bind("FOLDER_ID") %>' ID="TextBox2"></asp:TextBox>
                </EditItemTemplate>
                <ItemTemplate>
                    <asp:Image runat="server" ID="imgFolder"></asp:Image>
