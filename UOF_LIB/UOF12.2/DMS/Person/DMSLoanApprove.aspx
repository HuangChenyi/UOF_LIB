...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
        ...
        function RadToolbar1_Click(sender, args) {
            ...
            if (button.get_value() == "Reject") {
                ...
                if (checkedData.length > 0) {
                    ...
                    $uof.dialog.open2("~/DMS/DocStore/DocApproveComment.aspx", args.get_item(), "", 600, 400, OpenDocDialogResult, { "state": 'Reject', "data": checkedData });
                }
                else
    ...
    if (button.get_value() == "Accept") {
        ...
        if (checkedData.length > 0) {
            args.set_cancel(true);
            $uof.dialog.open2("~/DMS/DocStore/DocApproveComment.aspx", args.get_item(), "", 600, 400, OpenDocDialogResult, { "state": 'Accept', "data": checkedData });
        }
        else
            alert("<%=labNoSelect.Text %>")
    }
            ...
            <td valign="top">
                <asp:UpdatePanel ID="UpdatePanel1" runat="server">
                    <ContentTemplate>
                        ...
                        <Fast:Grid runat="server" ID="gridLendApprove" AutoGenerateCheckBoxColumn="True"
                            DataKeyNames="DOC_ID,LEND_USER" AllowSorting="True" AutoGenerateColumns="False"
                            DataKeyOnClientWithCheckBox="True" EnhancePager="True"
                            PageSize="15" Width="100%"
                            OnRowDataBound="gridLendApprove_RowDataBound" OnSorting="gridLendApprove_Sorting" AllowPaging="True" OnPageIndexChanging="gridLendApprove_PageIndexChanging" OnRowCommand="gridLendApprove_RowCommand">
                            ...
                            <Columns>
                                ...
                                <asp:TemplateField HeaderText="調閱理由" meta:resourcekey="TemplateFieldResource8">
                                    ...
                                    <ItemTemplate>
                                        <span style="word-break: break-all; width: 160px;">
