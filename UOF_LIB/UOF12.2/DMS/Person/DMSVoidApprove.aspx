<%@ Page Title="" Language="C#" MasterPageFile="~/Master/DefaultMasterPage.master" AutoEventWireup="true" Inherits="DMS_Person_DMSVoidApprove" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" Codebehind="DMSVoidApprove.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <script id="Infragistics" type="text/javascript">
        ...
        function tbMainFun_Click(oToolbar, oButton, oEvent) {
            ...
            function UltraWebToolbar1_Click(sender, args) {
                var toolBar = sender;
                ...
                if (button.get_value() == "Reject") {
                    if (checkedData.length > 0) {
                        ...
                        , { "type": 'void', "state": 'Reject', "data": checkedData });
                    }
                }
                if (button.get_value() == "Accept") {
                    if (checkedData.length > 0) {
                        ...
                        , { "type": 'void', "state": 'Accept', "data": checkedData });
                    }
                }
            }
    ...
    <telerik:RadToolBar ID="RadToolBar1" runat="server" Width="100%" OnButtonClick="UltraWebToolbar1_ButtonClicked" OnClientButtonClicking="UltraWebToolbar1_Click">
        <Items>
        ...
        <ContentTemplate>
            <Fast:Grid ID="Grid2" runat="server" AllowSorting="True" AutoGenerateCheckBoxColumn="True"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="文件標題" meta:resourcekey="TemplateFieldResource1" SortExpression="DOC_NAME">
                        <ItemTemplate>
                            <span style="word-break: break-all; width: 200px;">
                                <table>
                                    <tr>
                                        ...
                                        <td>
                                            <asp:LinkButton ID="lbtnDocName" runat="server"  Text='<%# Bind("DOC_NAME") %>' meta:resourcekey="lblDocNameResource1"></asp:LinkButton>
                                        </td>
                                        <td  style="width:100%;">
                    ...
                    <asp:TemplateField HeaderText="操作" meta:resourcekey="TemplateFieldResource5">
                        <ItemTemplate>
                            ...
                            <asp:LinkButton ID="lbtnFlow2" runat="server"
                                meta:resourcekey="lbtnFlow2Resource1">流程</asp:LinkButton>
                        </ItemTemplate>
                        <HeaderStyle Width="100px" Wrap="false" />
    ...
    <asp:Label ID="lblConfirmAccept" runat="server" Text="確定要允許作廢?" Visible="False" meta:resourcekey="lblConfirmAcceptResource1"></asp:Label>
    <asp:Label ID="lblConfirmReject" runat="server" Text="確定要拒絕作廢" Visible="False" meta:resourcekey="lblConfirmRejectResource1"></asp:Label>
    ...
    <asp:Label ID="lblNoPrivilege" runat="server" Text="勾選了無權審核的文件，目錄權限已被變更"
        Visible="False" meta:resourcekey="lblNoPrivilegeResource1"></asp:Label>
